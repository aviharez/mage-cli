...
import { optional } from "@mybcabisnis/mage-core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@mybcabisnis/mage-core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
...
function custom(dep: CustomDep): Record<string, CustomLoader> {
  return {
    // Merlin/GAIA is always autoloaded — no mage.jsonc entry required.
        ...
        database[ProviderV2.ID.make("merlin")] = {
          ...
          models: {
            default: {
              ...
              providerID: ProviderV2.ID.make("merlin"),
