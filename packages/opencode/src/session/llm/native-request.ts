import type { JsonSchema, LLMRequest, ProviderMetadata } from "@mybcabisnis/mage-llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@mybcabisnis/mage-llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
  ...
  OpenAICompatible,
  OpenRouter,
} from "@mybcabisnis/mage-llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @mybcabisnis/mage-llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
