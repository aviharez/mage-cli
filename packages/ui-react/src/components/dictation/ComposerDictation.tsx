...
export const ComposerDictation: React.FC<ComposerDictationProps> = ({
    ...
    // The dictation server (WebSocket + STT worker) lives in the Mage
    ...
    React.useEffect(() => {
        ...
        window.addEventListener('mage:dictation-toggle', onToggle);
        return () => window.removeEventListener('mage:dictation-toggle', onToggle);
