...
const THEME_MODE_OPTIONS: Array<{ value: ThemeMode; labelKey: string }> = [
    {
        value: 'system',
        labelKey: 'settings.mage.visual.option.themeMode.system',
    },
    {
        value: 'light',
        labelKey: 'settings.mage.visual.option.themeMode.light',
    },
    {
        value: 'dark',
        labelKey: 'settings.mage.visual.option.themeMode.dark',
    },
];
...
const DIFF_LAYOUT_OPTIONS: Option<'dynamic' | 'inline' | 'side-by-side'>[] = [
    {
        id: 'dynamic',
        labelKey: 'settings.mage.visual.option.diffLayout.dynamic.label',
        descriptionKey: 'settings.mage.visual.option.diffLayout.dynamic.description',
    },
    {
        id: 'inline',
        labelKey: 'settings.mage.visual.option.diffLayout.inline.label',
        descriptionKey: 'settings.mage.visual.option.diffLayout.inline.description',
    },
    {
        id: 'side-by-side',
        labelKey: 'settings.mage.visual.option.diffLayout.sideBySide.label',
        descriptionKey: 'settings.mage.visual.option.diffLayout.sideBySide.description',
    },
];
...
const MERMAID_RENDERING_OPTIONS: Option<'svg' | 'ascii'>[] = [
    {
        id: 'svg',
        labelKey: 'settings.mage.visual.option.mermaidRendering.svg.label',
        descriptionKey: 'settings.mage.visual.option.mermaidRendering.svg.description',
    },
    {
        id: 'ascii',
        labelKey: 'settings.mage.visual.option.mermaidRendering.ascii.label',
        descriptionKey: 'settings.mage.visual.option.mermaidRendering.ascii.description',
    },
];

const DEFAULT_PWA_INSTALL_NAME = 'Mage - AI Coding Assistant';
const PWA_ORIENTATION_OPTIONS: Option<'system' | 'portrait' | 'landscape'>[] = [
    {
        id: 'system',
        labelKey: 'settings.mage.visual.option.pwaOrientation.system.label',
        descriptionKey: 'settings.mage.visual.option.pwaOrientation.system.description',
    },
    {
        id: 'portrait',
        labelKey: 'settings.mage.visual.option.pwaOrientation.portrait.label',
        descriptionKey: 'settings.mage.visual.option.pwaOrientation.portrait.description',
    },
    {
        id: 'landscape',
        labelKey: 'settings.mage.visual.option.pwaOrientation.landscape.label',
        descriptionKey: 'settings.mage.visual.option.pwaOrientation.landscape.description',
    },
];
...
const MOBILE_KEYBOARD_MODE_OPTIONS: Option<MobileKeyboardMode>[] = [
    {
        id: 'native',
        labelKey: 'settings.mage.visual.option.mobileKeyboardMode.native.label',
        descriptionKey: 'settings.mage.visual.option.mobileKeyboardMode.native.description',
    },
    {
        id: 'resize-content',
        labelKey: 'settings.mage.visual.option.mobileKeyboardMode.resizeContent.label',
        descriptionKey: 'settings.mage.visual.option.mobileKeyboardMode.resizeContent.description',
    },
];
...
const MOBILE_LAYOUT_OPTIONS: Array<{ value: MobileLayoutPreference; labelKey: string }> = [
    {
        value: 'default',
        labelKey: 'settings.mage.visual.option.mobileLayout.default',
    },
    {
        value: 'new',
        labelKey: 'settings.mage.visual.option.mobileLayout.new',
    },
];

type PwaInstallNameWindow = Window & {
    __MAGE_SET_PWA_INSTALL_NAME__?: (value: string) => string;
    __MAGE_SET_PWA_ORIENTATION__?: (value: 'system' | 'portrait' | 'landscape') => 'system' | 'portrait' | 'landscape';
    __MAGE_UPDATE_PWA_MANIFEST__?: () => void;
};
...
const USER_MESSAGE_RENDERING_OPTIONS: Option<'markdown' | 'plain'>[] = [
    {
        id: 'markdown',
        labelKey: 'settings.mage.visual.option.userMessageRendering.markdown.label',
        descriptionKey: 'settings.mage.visual.option.userMessageRendering.markdown.description',
    },
    {
        id: 'plain',
        labelKey: 'settings.mage.visual.option.userMessageRendering.plain.label',
        descriptionKey: 'settings.mage.visual.option.userMessageRendering.plain.description',
    },
];
...
const CHAT_RENDER_MODE_OPTIONS: Option<'sorted' | 'live'>[] = [
    {
        id: 'sorted',
        labelKey: 'settings.mage.visual.option.chatRenderMode.sorted.label',
        descriptionKey: 'settings.mage.visual.option.chatRenderMode.sorted.description',
    },
    {
        id: 'live',
        labelKey: 'settings.mage.visual.option.chatRenderMode.live.label',
        descriptionKey: 'settings.mage.visual.option.chatRenderMode.live.description',
    },
];
...
const MESSAGE_STREAM_TRANSPORT_OPTIONS: Option<'auto' | 'ws' | 'sse'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.mage.visual.option.messageTransport.auto.label',
        descriptionKey: 'settings.mage.visual.option.messageTransport.auto.description',
    },
    {
        id: 'ws',
        labelKey: 'settings.mage.visual.option.messageTransport.ws.label',
        descriptionKey: 'settings.mage.visual.option.messageTransport.ws.description',
    },
    {
        id: 'sse',
        labelKey: 'settings.mage.visual.option.messageTransport.sse.label',
        descriptionKey: 'settings.mage.visual.option.messageTransport.sse.description',
    },
];
...
const ACTIVITY_RENDER_MODE_OPTIONS: Option<'collapsed' | 'summary'>[] = [
    {
        id: 'collapsed',
        labelKey: 'settings.mage.visual.option.activityRenderMode.collapsed.label',
        descriptionKey: 'settings.mage.visual.option.activityRenderMode.collapsed.description',
    },
    {
        id: 'summary',
        labelKey: 'settings.mage.visual.option.activityRenderMode.summary.label',
        descriptionKey: 'settings.mage.visual.option.activityRenderMode.summary.description',
    },
];
...
const TIME_FORMAT_OPTIONS: Option<'auto' | '12h' | '24h'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.mage.visual.option.timeFormat.auto.label',
        descriptionKey: 'settings.mage.visual.option.timeFormat.auto.description',
    },
    {
        id: '24h',
        labelKey: 'settings.mage.visual.option.timeFormat.24h.label',
        descriptionKey: 'settings.mage.visual.option.timeFormat.24h.description',
    },
    {
        id: '12h',
        labelKey: 'settings.mage.visual.option.timeFormat.12h.label',
        descriptionKey: 'settings.mage.visual.option.timeFormat.12h.description',
    },
];
...
const WEEK_START_OPTIONS: Option<'auto' | 'monday' | 'sunday'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.mage.visual.option.weekStart.auto.label',
        descriptionKey: 'settings.mage.visual.option.weekStart.auto.description',
    },
    {
        id: 'monday',
        labelKey: 'settings.mage.visual.option.weekStart.monday.label',
    },
    {
        id: 'sunday',
        labelKey: 'settings.mage.visual.option.weekStart.sunday.label',
    },
];
...
const FOLLOW_UP_BEHAVIOR_OPTIONS: Option<FollowUpBehavior>[] = [
    {
        id: 'steer',
        labelKey: 'settings.mage.visual.option.followUpBehavior.steer.label',
    },
    {
        id: 'queue',
        labelKey: 'settings.mage.visual.option.followUpBehavior.queue.label',
    },
];
...
interface MageVisualSettingsProps {
    /** Which settings to show. If undefined, shows all. */
    visibleSettings?: VisibleSetting[];
}

export const MageVisualSettings: React.FC<MageVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const handleFileViewerPreviewChange = React.useCallback((enabled: boolean) => {
        ...
        window.dispatchEvent(new CustomEvent('mage:file-viewer-preview-mode-changed', { detail: { enabled } }));
    ...
    const selectedTimeFormatLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.mage.visual.option.timeFormat.auto.label');
    ...
    const selectedWeekStartLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.mage.visual.option.weekStart.auto.label');
    ...
    const applyPwaInstallName = React.useCallback(async (value: string) => {
        ...
        if (typeof win.__MAGE_SET_PWA_INSTALL_NAME__ === 'function') {
            const resolved = win.__MAGE_SET_PWA_INSTALL_NAME__(persistedValue);
            setPwaInstallName(resolved);
            return;
        }

        setPwaInstallName(persistedValue || DEFAULT_PWA_INSTALL_NAME);
        win.__MAGE_UPDATE_PWA_MANIFEST__?.();
    }, []);
    ...
    const applyPwaOrientation = React.useCallback(async (value: 'system' | 'portrait' | 'landscape') => {
        ...
        if (typeof win.__MAGE_SET_PWA_ORIENTATION__ === 'function') {
            const resolved = win.__MAGE_SET_PWA_ORIENTATION__(normalized);
        ...
        <div className="space-y-8">
                ...
                {hasAppearanceSettings && (
                    <div className="mb-8 space-y-6">
                        {hasThemeSettings && (
                            <section className="px-2 pb-2 pt-0 space-y-2">
                                <div className="flex min-w-0 flex-col gap-1.5">
                                    <span className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.colorMode')}</span>
                                ...
                                {showMobileLayoutSetting && (
                                    <div className="flex min-w-0 flex-col gap-1.5 py-1.5">
                                        <span className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.mobileLayout')}</span>
                                        <div className="flex flex-wrap items-center gap-1">
                                ...
                                <div className="grid grid-cols-1 gap-2 py-1.5 md:grid-cols-[14rem_auto] md:gap-x-8 md:gap-y-2">
                                    <div data-settings-item="appearance.light-theme" className="flex min-w-0 items-center gap-2">
                                        <span className="typography-ui-label text-foreground shrink-0">{t('settings.mage.visual.field.lightTheme')}</span>
                                        <Select value={selectedLightTheme?.metadata.id ?? ''} onValueChange={setLightThemePreference}>
                                            <SelectTrigger aria-label={t('settings.mage.visual.field.selectLightThemeAria')} className="w-fit">
                                                <SelectValue placeholder={t('settings.mage.visual.field.selectThemePlaceholder')}>
                                                    {selectedLightTheme
                                    ...
                                    <div data-settings-item="appearance.dark-theme" className="flex min-w-0 items-center gap-2">
                                        <span className="typography-ui-label text-foreground shrink-0">{t('settings.mage.visual.field.darkTheme')}</span>
                                        <Select value={selectedDarkTheme?.metadata.id ?? ''} onValueChange={setDarkThemePreference}>
                                            <SelectTrigger aria-label={t('settings.mage.visual.field.selectDarkThemeAria')} className="w-fit">
                                                <SelectValue placeholder={t('settings.mage.visual.field.selectThemePlaceholder')}>
                                                    {selectedDarkTheme
                                ...
                                <div className="flex items-center gap-2 py-1.5">
                                    ...
                                    >
                                        {themesReloading ? t('settings.mage.visual.actions.reloadingThemes') : t('settings.mage.visual.actions.reloadThemes')}
                                    </button>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <button
                                                ...
                                                aria-label={t('settings.mage.visual.field.themeImportInfoAria')}
                                            >
                                                <Icon name="information" className="h-3.5 w-3.5" />
                                            </button>
                                        </TooltipTrigger>
                                        <TooltipContent sideOffset={8}>
                                            {t('settings.mage.visual.field.themeImportInfoTooltip')}
                                        </TooltipContent>
                                    </Tooltip>
                                </div>
                                    ...
                                    <div data-settings-item="appearance.window-transparency" className="flex flex-col gap-1.5 border-t border-border/40 pt-3">
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.macVibrancy')}
                                            />
                                            <div className="flex min-w-0 flex-col">
                                                <span className="typography-ui-label text-foreground">
                                                    {t('settings.mage.visual.field.macVibrancy')}
                                                </span>
                                                <span className="typography-meta text-muted-foreground">
                                                    {t('settings.mage.visual.field.macVibrancyHint')}
                                                </span>
                                            </div>
                                        </div>
                                        {vibrancyChecked !== macVibrancyEnabled && (
                                            <div className="pl-6">
                                                ...
                                                >
                                                    {vibrancyRestarting
                                                        ? t('settings.mage.visual.actions.restarting')
                                                        : t('settings.mage.visual.actions.saveAndRestart')}
                                                </Button>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div data-settings-item="appearance.dock-badge" className="flex flex-col gap-1.5 border-t border-border/40 pt-3">
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.dockBadge')}
                                            />
                                            <div className="flex min-w-0 flex-col">
                                                <span className="typography-ui-label text-foreground">
                                                    {t('settings.mage.visual.field.dockBadge')}
                                                </span>
                                                <span className="typography-meta text-muted-foreground">
                                                    {t('settings.mage.visual.field.dockBadgeHint')}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {hasLocalizationSettings && (
                            <section className="px-2 pb-2 pt-0 space-y-2">
                                <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.localization')}</h4>
                                    ...
                                    <div className="grid grid-cols-1 gap-2 py-1.5 md:grid-cols-[14rem_auto] md:gap-x-8 md:gap-y-2">
                                        {shouldShow('timeFormat') && (
                                            <div data-settings-item="appearance.time-format" className="flex min-w-0 items-center gap-2">
                                                <span className="typography-ui-label text-foreground shrink-0">{t('settings.mage.visual.field.timeFormat')}</span>
                                                <Select value={timeFormatPreference} onValueChange={(value: 'auto' | '12h' | '24h') => handleTimeFormatPreferenceChange(value)}>
                                                    <SelectTrigger aria-label={t('settings.mage.visual.field.selectTimeFormatAria')} className="w-fit">
                                        ...
                                        {shouldShow('weekStart') && (
                                            <div data-settings-item="appearance.week-start" className="flex min-w-0 items-center gap-2">
                                                <span className="typography-ui-label text-foreground shrink-0">{t('settings.mage.visual.field.weekStartsOn')}</span>
                                                <Select value={weekStartPreference} onValueChange={(value: 'auto' | 'monday' | 'sunday') => handleWeekStartPreferenceChange(value)}>
                                                    <SelectTrigger aria-label={t('settings.mage.visual.field.selectWeekStartAria')} className="w-fit">
                        ...
                        {(showPwaInstallNameSetting || showPwaOrientationSetting || showMobileKeyboardModeSetting) && (
                            ...
                            {showPwaInstallNameSetting && (
                                <div data-settings-item="appearance.pwa-install-name" className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.installAppName')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.mage.visual.field.installAppNameHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[28rem] items-center gap-2">
                                        <Input
                                            ...
                                            className="h-7"
                                            maxLength={64}
                                            aria-label={t('settings.mage.visual.field.pwaInstallAppNameAria')}
                                        />
                                        <Button size="sm"
                                            type="button"
                                            variant="ghost"
                                            ...
                                            aria-label={t('settings.mage.visual.actions.resetInstallAppNameAria')}
                            ...
                            {showPwaOrientationSetting && (
                                <div data-settings-item="appearance.pwa-orientation" className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.installOrientation')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.mage.visual.field.installOrientationHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[18rem] items-center gap-2">
                                        ...
                                        >
                                            <SelectTrigger aria-label={t('settings.mage.visual.field.pwaInstallOrientationAria')} className="w-full">
                                                <SelectValue placeholder={t('settings.mage.visual.field.selectOrientationPlaceholder')}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetInstallOrientationAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {showMobileKeyboardModeSetting && (
                                <div data-settings-item="appearance.mobile-keyboard-mode" className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.mobileKeyboardMode')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.mage.visual.field.mobileKeyboardModeHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[18rem] items-center gap-2">
                                        <Select
                                        ...
                                        >
                                            <SelectTrigger aria-label={t('settings.mage.visual.field.mobileKeyboardModeAria')} className="w-full">
                                                <SelectValue placeholder={t('settings.mage.visual.field.selectMobileKeyboardModePlaceholder')}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetMobileKeyboardModeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                ...
                {hasLayoutSettings && (
                    <div className="mb-8 space-y-3">
                        <section className="p-2 space-y-0.5">
                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.spacingAndLayout')}</h4>
                            <div className="pl-2">
                            ...
                            {shouldShow('fontSize') && !isMobile && (
                                <div data-settings-item="appearance.interface-font-size" className="flex items-center gap-8 py-1">
                                    <div className="flex min-w-0 flex-col w-56 shrink-0">
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.interfaceFont')}</span>
                                    </div>
                                    <div className="flex items-center gap-2 w-fit">
                                        <Select value={uiFont} onValueChange={(value) => setUiFont(value as UiFontOption)}>
                                            <SelectTrigger aria-label={t('settings.mage.visual.field.selectInterfaceFontAria')} className="w-[13rem]">
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetInterfaceFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('terminalFontSize') && (
                                <div className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.codeFont')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <Select value={monoFont} onValueChange={(value) => setMonoFont(value as MonoFontOption)}>
                                            <SelectTrigger aria-label={t('settings.mage.visual.field.selectCodeFontAria')} className="w-[13rem]">
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetCodeFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('fontSize') && !isMobile && (
                                <div className="flex items-center gap-8 py-1">
                                    <div className="flex min-w-0 flex-col w-56 shrink-0">
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.interfaceFontSize')}</span>
                                    </div>
                                    <div className="flex items-center gap-2 w-fit">
                                        <NumberInput
                                            value={fontSize}
                                            ...
                                            max={200}
                                            step={5}
                                            aria-label={t('settings.mage.visual.field.fontSizePercentageAria')}
                                            className="w-16"
                                        />
                                        <Button size="sm"
                                            type="button"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetFontSizeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('terminalFontSize') && (
                                <div data-settings-item="appearance.terminal-font-size" className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.terminalFontSize')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <NumberInput
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetTerminalFontSizeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('editorFontSize') && (
                                <div data-settings-item="appearance.editor-font-size" className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.editorFontSize')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <NumberInput
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetEditorFontSizeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('spacing') && (
                                <div data-settings-item="appearance.spacing-density" className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.spacingDensity')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <NumberInput
                                            value={padding}
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetSpacingAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                                ...
                                <div data-settings-item="appearance.input-bar-offset" className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <div className="flex items-center gap-1.5">
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.inputBarOffset')}</span>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <Icon name="information" className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                                </TooltipTrigger>
                                                <TooltipContent sideOffset={8} className="max-w-xs">
                                                    {t('settings.mage.visual.field.inputBarOffsetTooltip')}
                                                </TooltipContent>
                                            </Tooltip>
                                        </div>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.mage.visual.actions.resetInputBarOffsetAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                ...
                {hasNavigationSettings && (
                    <div className="space-y-3">
                        <section className="px-2 pb-2 pt-0">
                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.navigation')}</h4>
                            {shouldShow('fileEditorKeymap') && (
                                <div data-settings-item="appearance.file-editor-keymap" className="flex flex-col gap-2 py-1.5 sm:flex-row sm:items-start sm:gap-8">
                                    <span className="typography-ui-label text-foreground sm:w-56 shrink-0">
                                        {t('settings.mage.visual.field.fileEditorKeymap')}
                                    </span>
                                    <div
                                        role="radiogroup"
                                        aria-label={t('settings.mage.visual.field.fileEditorKeymap')}
                                        className="space-y-0"
                                    >
                                        {(['default', 'vim'] as const).map((keymap) => {
                                            const selected = fileEditorKeymap === keymap;
                                            const labelText = t(`settings.mage.visual.option.fileEditorKeymap.${keymap}`);
                                            return (
                                                <button
                                                    key={keymap}
                                                    type="button"
                            ...
                            {shouldShow('expandedEditorToolbar') && (
                                ...
                                >
                                    <Checkbox
                                        ...
                                        ariaLabel={t('settings.mage.visual.field.expandedEditorToolbarAria')}
                                    />
                                    <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.expandedEditorToolbar')}</span>
                                </div>
                            )}
                            {shouldShow('terminalQuickKeys') && !isMobile && (
                                ...
                                >
                                    <Checkbox
                                        ...
                                        ariaLabel={t('settings.mage.visual.field.terminalQuickKeysAria')}
                                    />
                                    <div className="flex min-w-0 items-center gap-1.5">
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.terminalQuickKeys')}</span>
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Icon name="information" className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                            </TooltipTrigger>
                                            <TooltipContent sideOffset={8} className="max-w-xs">
                                                {t('settings.mage.visual.field.terminalQuickKeysTooltip')}
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-y-2 md:grid-cols-[minmax(0,16rem)_minmax(0,16rem)] md:justify-start md:gap-x-2">
                                    {shouldShow('chatRenderMode') && (
                                        <section data-settings-item="chat.render-mode" className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.chatRenderMode')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.mage.visual.section.chatRenderModeAria')} className="mt-1 grid w-full max-w-[26rem] grid-cols-1 gap-3 sm:grid-cols-2">
                                    ...
                                    {shouldShow('messageTransport') && (
                                        <section data-settings-item="chat.message-transport" className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.messageStreamTransport')}</h4>
                                    ...
                                    {shouldShow('activityRenderMode') && chatRenderMode === 'sorted' && (
                                        <section className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.activityDefault')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.mage.visual.section.activityDefaultAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.mage.visual.field.activityDefaultModeAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('expandedTools') && (
                                        <section className="p-2 md:col-span-2 space-y-0.5">
                                            <div className="typography-ui-header font-medium text-foreground py-1.5">{t('settings.mage.visual.section.showToolsOpenedByDefault')}</div>
                                            ...
                                            >
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.mage.visual.field.showExpandedBashToolsAria')}
                                                />
                                                <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.bash')}</span>
                                            </div>
                                            ...
                                            >
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.mage.visual.field.showExpandedEditToolsAria')}
                                                />
                                                <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.editTools')}</span>
                                            </div>
                                        </section>
                                    )}
                                    ...
                                    {shouldShow('userMessageRendering') && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.userMessageRendering')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.mage.visual.section.userMessageRenderingAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.mage.visual.field.userMessageRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('mermaidRendering') && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.mermaidRendering')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.mage.visual.section.mermaidRenderingAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.mage.visual.field.mermaidRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.diffLayout')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.mage.visual.section.diffLayoutAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.mage.visual.field.diffLayoutAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('followUpBehavior') && (
                                        <section data-settings-item="chat.follow-up-behavior" className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.section.followUpBehavior')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.mage.visual.section.followUpBehaviorAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.mage.visual.field.followUpBehaviorAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                            ...
                            {shouldShow('sessionGoal') && !isVSCode && (
                                <div className="mb-8">
                                    <div className="mb-1 px-1">
                                        <h3 className="typography-ui-header font-medium text-foreground">{t('settings.mage.visual.goal.sectionTitle')}</h3>
                                    </div>
                                    <section className="p-2 space-y-0.5">
                                        <div
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.sessionGoalAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.sessionGoal')}</span>
                                        </div>
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.mage.visual.goal.budgetAria')}
                                                />
                                                <span className="typography-ui-label text-foreground">{t('settings.mage.visual.goal.budgetLabel')}</span>
                                            </div>
                                        ...
                                        <p className="typography-meta text-muted-foreground/70 px-0.5 pt-0.5">{t('settings.mage.visual.goal.description')}</p>
                                    </section>
                                </div>
                            )}
                                    ...
                                    {shouldShow('sessionAssist') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.sessionRecapAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.sessionRecap')}</span>
                                        </div>
                                        <div
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.sessionSuggestionAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.sessionSuggestion')}</span>
                                        </div>
                                        </>
                                    )}
                                    {shouldShow('reasoning') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.showReasoningTracesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.showReasoningTraces')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('reasoning') && showReasoningTraces && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.collapsibleThinkingBlocksAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.collapsibleThinkingBlocks')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('collapsibleUserMessages') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.collapsibleUserMessagesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.collapsibleUserMessages')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('stickyUserHeader') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.stickyUserHeaderAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.stickyUserHeader')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('wideChatLayout') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.wideChatLayoutAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.wideChatLayout')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('splitAssistantMessageActions') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.showSplitAssistantMessageActionsAria')}
                                            />
                                            <div className="flex min-w-0 items-center gap-1.5">
                                                <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.showSplitAssistantMessageActions')}</span>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Icon name="information" className="h-3.5 w-3.5 cursor-help text-muted-foreground/60" />
                                                    </TooltipTrigger>
                                                    <TooltipContent sideOffset={8} className="max-w-xs">
                                                        {t('settings.mage.visual.field.showSplitAssistantMessageActionsTooltip')}
                                                    </TooltipContent>
                                                </Tooltip>
                                            </div>
                                        </div>
                                    ...
                                    {shouldShow('codeBlockLineWrap') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.codeBlockLineWrapAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.codeBlockLineWrap')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('showToolFileIcons') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.showToolFileIconsAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.showToolFileIcons')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('showTurnChangedFiles') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.showTurnChangedFilesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.showTurnChangedFiles')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('dotfiles') && !isVSCodeRuntime() && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.showDotfilesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.showDotfiles')}</span>
                                        </div>
                                    )}
                                        ...
                                        >
                                            <span onClick={(event) => event.stopPropagation()}>
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.mage.defaults.field.openFilesPreviewAria')}
                                                />
                                            </span>
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.defaults.field.openFilesPreview')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('persistDraft') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.persistDraftMessagesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.persistDraftMessages')}</span>
                                        </div>
                                    )}
                                    ...
                                    {!isMobile && shouldShow('inputSpellcheck') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.mage.visual.field.enableSpellcheckInTextInputsAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.enableSpellcheckInTextInputs')}</span>
                                        </div>
                                    )}
                ...
                {shouldShow('reportUsage') && (
                    <div className="space-y-3">
                        <section className="px-2 pb-2 pt-0">
                            <h4 className="typography-ui-header font-medium text-foreground mb-2">{t('settings.mage.visual.section.privacy')}</h4>
                            <div data-settings-item="appearance.usage-reports" className="flex items-start gap-2 py-1.5">
                                <Checkbox
                                    checked={reportUsage}
                                    onChange={handleReportUsageChange}
                                    ariaLabel={t('settings.mage.visual.field.sendAnonymousUsageReportsAria')}
                                />
                                <div className="flex min-w-0 flex-col gap-0.5">
                                    ...
                                    >
                                        <span className="typography-ui-label text-foreground">{t('settings.mage.visual.field.sendAnonymousUsageReports')}</span>
                                    </div>
                                    <span className="typography-meta text-muted-foreground pointer-events-none">
                                        {t('settings.mage.visual.field.sendAnonymousUsageReportsHint')}
                                    </span>
                                </div>
                            </div>
                        </section>
