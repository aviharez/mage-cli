...
export function CodeMirrorEditor({
  ...
  React.useEffect(() => {
    ...
    const cspNonce = (() => {
      ...
      const windowNonce = (window as Window & { __MAGE_CSP_NONCE__?: string }).__MAGE_CSP_NONCE__;
    ...
    const state = EditorState.create({
      ...
      extensions: [
        ...
        // Duplicate @codemirror/view resolutions in the dependency tree (a transitive
        // hoisting artifact, not a real API mismatch) make these bindings structurally
        // identical but nominally distinct types.
        keymap.of([indentWithTab, ...defaultKeymap, ...historyKeymap] as Parameters<typeof keymap.of>[0]),
