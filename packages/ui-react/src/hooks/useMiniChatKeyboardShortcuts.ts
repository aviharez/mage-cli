...
import { canUseElectronDesktopIPC, hasElectronCapability, invokeDesktop } from '@/lib/desktop';
...
export const useMiniChatKeyboardShortcuts = () => {
  ...
  React.useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (canUseElectronDesktopIPC() && hasElectronCapability('mini-chat') && eventMatchesShortcut(event, combo('new_mini_chat'))) {
        event.preventDefault();
