...
import mage_dark_Raw from './fields-of-the-shire-dark.json';
import mage_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  mage_dark_Raw as Theme,
  mage_light_Raw as Theme,
