...
const FR_MESSAGES: BootstrapMessages = {
  ...
  initialDataLoadFailed: 'Mage est connecté, mais le chargement initial des données a échoué.',
...
const ZH_CN_MESSAGES: BootstrapMessages = {
  ...
  disconnected: '已断开连接',
  reconnecting: '正在重新连接…',
  initialDataLoadFailed: 'Mage 已连接，但初始数据加载失败。',
  cliNotFound: '未找到 Mage CLI。请先安装它。',
  providersReady: '✓ 提供商',
...
const ZH_TW_MESSAGES: BootstrapMessages = {
  ...
  disconnected: '已中斷連線',
  reconnecting: '正在重新連線…',
  initialDataLoadFailed: 'Mage 已連線，但初始資料載入失敗。',
  cliNotFound: '找不到 Mage CLI。請先安裝。',
  providersReady: '✓ 提供者',
...
const UK_MESSAGES: BootstrapMessages = {
  ...
  initialDataLoadFailed: 'Mage підключено, але початкове завантаження даних не вдалося.',
  cliNotFound: 'Mage CLI не знайдено. Спершу встановіть його.',
...
const ES_MESSAGES: BootstrapMessages = {
  startingApi: 'Iniciando la API de Mage…',
  ...
  initialDataLoadFailed: 'Mage se conectó, pero falló la carga inicial de datos.',
  cliNotFound: 'No se encontró Mage CLI. Instálalo primero.',
...
const PT_BR_MESSAGES: BootstrapMessages = {
  startingApi: 'Iniciando a API do Mage…',
  initializing: 'Inicializando…',
  connecting: 'Conectando…',
  connected: 'Conectado!',
  ...
  disconnected: 'Desconectado',
  reconnecting: 'Reconectando…',
  initialDataLoadFailed: 'Mage conectado, mas o carregamento inicial dos dados falhou.',
  cliNotFound: 'Mage CLI não encontrado. Instale-o primeiro.',
...
const KO_MESSAGES: BootstrapMessages = {
  ...
  initialDataLoadFailed: 'Mage에 연결되었지만 초기 데이터 로드에 실패했습니다.',
  cliNotFound: 'Mage CLI를 찾을 수 없습니다. 먼저 설치하세요.',
  providersReady: '✓ 공급자',
...
const PL_MESSAGES: BootstrapMessages = {
  startingApi: 'Uruchamianie API Mage…',
  ...
  initialDataLoadFailed: 'Mage połączony, ale początkowe ładowanie danych nie powiodło się.',
  cliNotFound: 'Nie znaleziono Mage CLI. Najpierw go zainstaluj.',
...
const JA_MESSAGES: BootstrapMessages = {
  ...
  reconnecting: '再接続中…',
  initialDataLoadFailed: 'Mage に接続しましたが、初期データの読み込みに失敗しました。',
  cliNotFound: 'Mage CLI が見つかりません。先にインストールしてください。',
