...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть Mage для швидшого доступу",  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.dismiss": "Сховати",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "Mage встановлено",  "shareOpinion.actions.shareOpinion": "Поділитися думкою",
  ...
  "shareOpinion.toast.title": "Допоможіть сформувати Mage",  "shareOpinion.toast.description": "Розкажіть, що корисне, незрозуміле чи відсутнє, щоб допомогти сформувати наступні кроки.",
  ...
  "mobile.connect.welcome.title": "Підключись до Mage",  "mobile.connect.welcome.description": "Додай адресу сервера або відскануй QR-код pairing, щоб почати користуватись мобільною апкою.",
  ...
  "mobile.connect.password.placeholder": "Пароль Mage",  "mobile.connect.connectButton": "Підключити",
  ...
  "mobile.connect.scan.invalid": "Це не QR-код підключення Mage.",  "mobile.connect.scan.unsupported": "Сканування QR доступне лише у встановленій мобільній апці.",
  "mobile.connect.saved.title": "Збережені підключення",
  "mobile.connect.saved.empty": "Збережених підключень ще немає.",
  "mobile.connect.relay.badge": "через Mage Relay",  "mobile.connect.error.urlRequired": "Введи адресу сервера.",
  "mobile.connect.error.invalidUrl": "Ця адреса сервера некоректна.",
  "mobile.connect.error.unreachable": "Не вдалося достукатись до цього Mage сервера.",  "mobile.connect.error.authRequired": "Цьому серверу потрібен пароль або client token.",
  ...
  "sessions.sidebar.footer.actions.aboutMage": "Про Mage",  "sessions.sidebar.footer.actions.update": "Оновити",
  ...
  "sessions.sidebar.group.pr.status.open": "MR відкрито",
  ...
  "sessions.sidebar.group.pr.status.draft": "Чернетка MR",
  ...
  "gitView.pr.actions.cancelEditingAria": "Скасувати редагування MR",
  "gitView.pr.actions.createPr": "Створити MR",
  "gitView.pr.actions.edit": "Редагувати",
  "gitView.pr.actions.editPr": "Редагувати MR",
  "gitView.pr.actions.editPrAria": "Редагувати MR",
  "gitView.pr.actions.hide": "Сховати",
  "gitView.pr.actions.markReady": "Позначити готовим",
  "gitView.pr.actions.markReadyAria": "Позначити MR готовим для перегляду",
  "gitView.pr.actions.mergePr": "Злити MR",
  "gitView.pr.actions.mergePrAria": "Злити MR",
  ...
  "gitView.pr.actions.openCommentsAria": "Відкрити коментарі MR",
  "gitView.pr.actions.openOnGitLab": "Відкрити на GitLab",
  "gitView.pr.actions.openOnGitLabAria": "Відкрити MR на GitLab",
  ...
  "gitView.pr.actions.savePr": "Зберегти MR",
  "gitView.pr.actions.savePrAria": "Зберегти зміни MR",
  ...
  "gitView.pr.actions.shareCommentsAria": "Надсилати агенту коментарі MR",
  "gitView.pr.actions.toggleDraftAria": "Перемкнути стан чернетки",
  "gitView.pr.actions.refresh": "Оновити статус MR",
  "gitView.pr.actions.refreshAria": "Оновити статус merge request",
  ...
  "gitView.pr.checkingStatus": "Перевірка статусу MR...",
  ...
  "gitView.pr.createTitle": "Створити MR",
  "gitView.pr.draftMustBeReady": "Перед злиттям чернетку MR необхідно позначити як готову.",
  ...
  "gitView.pr.gitlabNotConnected": "GitLab не підключено",
  ...
  "gitView.pr.placeholder.main": "Узагальніть свій MR",
  "gitView.pr.placeholder.selectBaseBranch": "Вибрати базову гілку",
  "gitView.pr.placeholder.title": "Назва MR",
  "gitView.pr.placeholder.whatChanged": "Що змінилося і чому?",
  "gitView.pr.statusUnavailable": "Статус MR недоступний",
  ...
  "gitView.pr.toast.createPrFailed": "Не вдалося створити MR",
  "gitView.pr.toast.generateDescriptionFailed": "Не вдалося створити опис MR",
  "gitView.pr.toast.gitlabApiUnavailable": "GitLab API недоступний",
  "gitView.pr.toast.loadCheckDetailsFailed": "Не вдалося завантажити деталі перевірки",
  "gitView.pr.toast.loadChecksFailed": "Не вдалося завантажити перевірки MR",
  "gitView.pr.toast.loadCommentsFailed": "Не вдалося завантажити коментарі",
  "gitView.pr.toast.loadPrCommentsFailed": "Не вдалося завантажити коментарі MR",
  "gitView.pr.toast.markReadyFailed": "Не вдалося позначити MR як готовий",
  "gitView.pr.toast.markedReady": "MR позначено як готовий для перегляду",
  "gitView.pr.toast.mergeFailed": "Не вдалося злити MR",
  ...
  "gitView.pr.toast.noPrComments": "Коментарі до MR не знайдено",
  "gitView.pr.toast.mrCreated": "Створено MR",
  "gitView.pr.toast.mrMerged": "MR злито",
  "gitView.pr.toast.prNotMerged": "MR не було злито",
  "gitView.pr.toast.mrUpdated": "MR оновлено",
  ...
  "gitView.pr.toast.updatePrFailed": "Не вдалося оновити MR",
  "gitView.pullRequest.createHint": "Створюйте MR з цієї гілки та керуйте ними.",
  "gitView.pullRequest.availableOnFeatureBranches": "Доступно, коли поточна гілка може відкрити MR.",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до Mage — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",  "contextPanel.tab.closeTabAria": "Закрити вкладку {label}",
  ...
  "header.gitlab.connected": "GitLab підключено",
  "header.gitlab.avatarWithLogin": "Аватар {login}",
  "header.gitlab.avatar": "Аватар GitLab",
  "header.gitlab.accountsTitle": "Облікові записи GitLab",
  ...
  "header.services.shutdownDev": "Зупинити Mage",  "header.services.modelFamily.other": "інше",
  ...
  "aboutDialog.mageAppVersionLabel": "Версія Mage {version}",  "aboutDialog.mageCliVersionLabel": "Версія Mage {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан Mage, стан Mage, каталоги та проєкти.",  "aboutDialog.footerNote": "Зроблено з любов'ю до спільноти",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації Mage",  "helpDialog.section.navigationCommands": "Навігація та команди",
  ...
  "header.actions.openAppMenu": "Меню Mage",  "header.actions.openAppMenuAria": "Відкрити меню Mage",  "header.actions.openSessionsWithShortcut": "Відкрити сесії ({shortcut})",
  ...
  "session.gitlabIssuePicker.error.noActiveProject": "Немає активного проєкту",
  "session.gitlabIssuePicker.error.runtimeUnavailable": "GitLab API недоступний",
  "session.gitlabIssuePicker.error.notConnected": "GitLab не підключено",
  "session.gitlabIssuePicker.error.repoNotResolvable": "Не вдалося визначити репозиторій",
  "session.gitlabIssuePicker.error.repoMustBeGitLab": "remote origin має бути GitLab URL",
  "session.gitlabIssuePicker.error.issueNotFound": "Issue не знайдено",
  "session.gitlabIssuePicker.error.noModelSelected": "Модель не вибрано",
  "session.gitlabIssuePicker.toast.loadMoreFailed": "Не вдалося завантажити додаткові issue",
  "session.gitlabIssuePicker.toast.loadIssueDetailsFailed": "Не вдалося завантажити деталі issue",
  "session.gitlabIssuePicker.toast.sendContextFailed": "Не вдалося надіслати контекст issue",
  "session.gitlabIssuePicker.toast.sessionCreated": "Сесію створено з issue",
  "session.gitlabIssuePicker.toast.startSessionFailed": "Не вдалося почати сесію",
  "session.gitlabIssuePicker.title.select": "Пов’язати GitLab issue",
  "session.gitlabIssuePicker.title.createSession": "Нова сесія з GitLab issue",
  "session.gitlabIssuePicker.description.select": "Виберіть issue, щоб пов’язати її з цією сесією.",
  "session.gitlabIssuePicker.description.createSession": "Запускає нову сесію із прихованим контекстом issue: заголовком, текстом, мітками й коментарями.",
  "session.gitlabIssuePicker.searchPlaceholder": "Пошук за допомогою синтаксису пошуку коду GitLab",
  "session.gitlabIssuePicker.empty.noActiveProject": "Не вибрано жодного активного проєкту.",
  "session.gitlabIssuePicker.empty.runtimeUnavailable": "GitLab API недоступний.",
  "session.gitlabIssuePicker.empty.notConnected": "GitLab не підключено. Підключіть обліковий запис GitLab у налаштуваннях.",
  "session.gitlabIssuePicker.empty.noIssuesFound": "Issue не знайдено",
  "session.gitlabIssuePicker.empty.noOpenIssuesFound": "Відкритих issue не знайдено",
  "session.gitlabIssuePicker.loading.issues": "Завантаження issue...",
  "session.gitlabIssuePicker.loading.more": "Завантаження...",
  "session.gitlabIssuePicker.actions.openSettings": "Відкрити налаштування",
  "session.gitlabIssuePicker.actions.useIssue": "Використовувати issue №{number}",
  "session.gitlabIssuePicker.actions.openInGitLabAria": "Відкрити в GitLab",
  "session.gitlabIssuePicker.actions.loadMore": "Завантажити ще",
  "session.gitlabIssuePicker.actions.sectionTitle": "Дії",
  "session.gitlabIssuePicker.actions.toggleWorktreeAria": "Перемкнути worktree",
  "session.gitlabIssuePicker.actions.createInWorktree": "Створити в worktree",
  "session.gitlabIssuePicker.actions.openRepo": "Відкрити репозиторій",
  "session.gitlabIssuePicker.actions.refresh": "Оновити",
  "session.gitlabMrPicker.error.noActiveProject": "Немає активного проєкту",
  "session.gitlabMrPicker.error.runtimeUnavailable": "GitLab API недоступний",
  "session.gitlabMrPicker.error.notConnected": "GitLab не підключено",
  "session.gitlabMrPicker.error.prNotFound": "MR не знайдено",
  "session.gitlabMrPicker.error.repoNotResolvable": "Не вдалося визначити репозиторій",
  "session.gitlabMrPicker.error.repoMustBeGitLab": "remote origin має бути GitLab URL",
  "session.gitlabMrPicker.toast.loadMoreFailed": "Не вдалося завантажити додаткові MR",
  "session.gitlabMrPicker.toast.loadDetailsFailed": "Не вдалося завантажити деталі MR",
  "session.gitlabMrPicker.title": "Пов’язати GitLab MR",
  "session.gitlabMrPicker.description": "Виберіть MR, щоб додати контекст рев’ю до цього повідомлення.",
  "session.gitlabMrPicker.searchPlaceholder": "Пошук за допомогою синтаксису пошуку коду GitLab",
  "session.gitlabMrPicker.includeDiffAria": "Додати diff MR у вкладений контекст",
  "session.gitlabMrPicker.includeDiff": "Додати diff MR",
  "session.gitlabMrPicker.empty.noActiveProject": "Не вибрано жодного активного проєкту.",
  "session.gitlabMrPicker.empty.runtimeUnavailable": "GitLab API недоступний.",
  "session.gitlabMrPicker.empty.notConnected": "GitLab не підключено. Підключіть обліковий запис GitLab у налаштуваннях.",
  "session.gitlabMrPicker.empty.noPullRequestsFound": "MR не знайдено",
  "session.gitlabMrPicker.empty.noOpenPullRequestsFound": "Не знайдено відкритих MR",
  "session.gitlabMrPicker.loading.pullRequests": "Завантаження MR...",
  "session.gitlabMrPicker.loading.more": "Завантаження...",
  "session.gitlabMrPicker.actions.openSettings": "Відкрити налаштування",
  "session.gitlabMrPicker.actions.usePullRequest": "Використовувати MR #{number}",
  "session.gitlabMrPicker.actions.openInGitLabAria": "Відкрити в GitLab",
  "session.gitlabMrPicker.actions.loadMore": "Завантажити ще",
  ...
  "session.newWorktree.actions.startFromGitLabIssuePr": "Почати з GitLab issue/MR",
  "session.newWorktree.usingPrBranch": "Використовується MR-гілка: {branch}",
  ...
  "session.newWorktree.error.sendGitLabContextFailed": "Не вдалося надіслати контекст GitLab",
  ...
  "session.newWorktree.toast.sessionFromPr": "Сесію створено з MR",
  ...
  "session.gitlabIntegration.title": "Виберіть із GitLab",
  "session.gitlabIntegration.tabs.issues": "Issue",
  "session.gitlabIntegration.tabs.pullRequests": "MR",
  "session.gitlabIntegration.connect.title": "Підключитися до GitLab",
  "session.gitlabIntegration.connect.description": "Пов’яжіть issue або MR, щоб автоматично заповнити деталі worktree",
  "session.gitlabIntegration.connect.action": "Підключити GitLab",
  "session.gitlabIntegration.search.issuesPlaceholder": "Пошук за допомогою синтаксису пошуку коду GitLab",
  "session.gitlabIntegration.search.prsPlaceholder": "Пошук за допомогою синтаксису пошуку коду GitLab",
  "session.gitlabIntegration.empty.noIssuesFound": "Issue не знайдено",
  "session.gitlabIntegration.empty.noPullRequestsFound": "MR не знайдено",
  "session.gitlabIntegration.actions.loadMore": "Завантажити ще",
  "session.gitlabIntegration.actions.cancel": "Скасувати",
  "session.gitlabIntegration.actions.select": "Вибрати",
  "session.gitlabIntegration.selected.issueNumber": "issue №{number}",
  "session.gitlabIntegration.selected.prNumber": "MR #{number}",
  "session.gitlabIntegration.includeDiffAria": "Додати diff MR у контекст сесії",
  "session.gitlabIntegration.includeDiff": "Додати diff MR",
  "session.gitlabIntegration.error.notConnected": "GitLab не підключено",
  "session.gitlabIntegration.error.loadDataFailed": "Не вдалося завантажити дані",
  "session.gitlabIntegration.validation.branchAlreadyCheckedOut": "Гілку вже відкрито в worktree",
  "session.gitlabIntegration.validation.branchAlreadyExists": "Гілка вже існує локально",
  "session.gitlabIntegration.validation.failed": "Помилка перевірки",
  ...
  "chat.emptyState.mageUnreachable": "Mage недоступний",
  ...
  "chat.generatedResult.pullRequest.title": "Згенерований merge request",
  ...
  "chat.chatInput.actions.linkGitlabIssue": "Пов’язати GitLab issue",
  "chat.chatInput.actions.linkGitlabMr": "Пов’язати GitLab MR",
  ...
  "chat.chatInput.linked.pr.openInBrowserAria": "Відкрити MR в браузері",
  "chat.chatInput.linked.pr.removeAria": "Видалити пов’язаний MR",
  ...
  "mageStatusDialog.title": "Статус Mage",
  "mageStatusDialog.description": "Перегляньте поточний стан Mage і діагностику.",
  "mageStatusDialog.actions.copy": "Копіювати",
  "mageStatusDialog.empty.noData": "Немає даних.",
  "mageStatusDialog.toast.copiedTitle": "Скопійовано",
  "mageStatusDialog.toast.copiedDescription": "Статус скопійовано в буфер обміну",
  "mageStatusDialog.toast.copyFailed": "Не вдалося скопіювати статус",
  ...
  "sessionAuth.error.networkDescription": "Нам не вдалося перевірити сесію інтерфейсу. Якщо ви відкриваєте Mage з іншого пристрою у локальній мережі, увімкніть Desktop Network Access у настільному застосунку та використайте LAN-адресу, показану в налаштуваннях.",  "sessionAuth.error.retry": "Повторити спробу",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати Mage",  "sessionAuth.locked.tunnelDescription": "Відкрийте цей тунель за допомогою одноразового посилання для з’єднання з настільної програми.",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими Mage серверами",  "desktopHostSwitcher.header.current": "поточний",
  ...
  "multiRun.window.description": "Вікно мультизапуску Mage.",  "voice.status.idle": "Голос готовий",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до Mage",  "onboarding.chooser.description": "Щоб почати, виберіть спосіб підключення.",
  ...
  "onboarding.localSetup.title": "Налаштування Mage",
  "onboarding.localSetup.description": "Установіть Mage CLI, щоб продовжити.",
  "onboarding.localSetup.dialog.selectMageBinary": "Вибрати виконуваний файл mage",
  "onboarding.localSetup.errors.cliNotReady": "Mage CLI ще не готовий. Підтвердьте, що встановлення завершено, і повторіть спробу.",
  "onboarding.localSetup.errors.detectionFailed": "Не вдалося виявити",
  "onboarding.localSetup.windows.title": "Налаштування Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Встановіть Mage за допомогою наведеної нижче команди.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо Mage не визначає Mage автоматично, укажіть шлях до виконуваного файла нижче.",  "onboarding.localSetup.intro": "Mage — серце Mage. Встановіть його, щоб почати.",  "onboarding.localSetup.docs.windows": "Документація Mage",
  "onboarding.localSetup.docs.default": "Документація Mage",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Натисніть, щоб перевірити, чи доступний Mage CLI. У разі успіху ви автоматично перейдете на головний екран.",
  "onboarding.localSetup.status.watching": "Очікування Mage",
  "onboarding.localSetup.status.autoContinue": "Ми автоматично продовжимо після виявлення.",
  "onboarding.localSetup.field.alreadyInstalled": "Вже встановлено? Встановіть шлях Mage CLI:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в Mage і перезавантажує конфігурацію Mage.",  "onboarding.localSetup.remotePreference": "Бажаєте використовувати віддалений сервер?",
  "onboarding.localSetup.actions.connectRemoteServer": "Підключитися до віддаленого сервера →",
  "onboarding.localSetup.windows.hintInstallInWsl": "У Windows інсталюйте та запускайте Mage нативно.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Якщо виявлення не вдається, укажіть нативний шлях, наприклад mage.cmd або mage.exe.",
  "onboarding.localSetup.hint.ensurePath": "Вже встановлено? Переконайтеся, що mage знаходиться у вашому PATH.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера Mage для підключення.",  "onboarding.remoteConnection.field.serverAddress": "Адреса сервера",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер Mage або зверніться до адміністратора сервера.",  "onboarding.remoteConnection.actions.testing": "Тестування…",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Цей інстанс працює з іншою версією Mage. Можна підключитися, але оновіть обидва застосунки, якщо щось не працюватиме.",  "onboarding.remoteConnection.probe.incompatibleMessage": "Сервер працює з Mage, але несумісний із цією версією застосунку. Оновіть Mage на сервері та повторіть спробу.",  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює Mage. Перевірте, чи адреса вказує на сервер Mage.",  "onboarding.remoteConnection.probe.unreachableMessage": "Сервер недоступний. Перевірте підключення до мережі та адресу сервера.",
  "onboarding.desktopRecovery.localUnavailable.title": "Mage Local недоступний",
  "onboarding.desktopRecovery.localUnavailable.description": "Mage CLI не вдалося запустити або не встановлено. Встановіть Mage або підключіться до віддаленого сервера.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено Mage. Перевірте, чи адреса вказує на сервер Mage.",  "onboarding.desktopRecovery.remoteIncompatible.title": "Потрібне оновлення сервера",
  "onboarding.desktopRecovery.remoteIncompatible.description": "Сервер Mage на \"{host}\" несумісний із цією версією застосунку. Оновіть Mage на сервері та повторіть спробу.",  "onboarding.desktopRecovery.common.useLocal": "Використовувати Local",
  ...
  "startup.initRecovery.description": "Mage не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",  "startup.initRecovery.retry": "Повторити спробу",
  ...
  "updateDialog.header.updating": "Оновлення Mage...",  "updateDialog.changelog.title": "Що нового",
  ...
  "updateDialog.error.takingLonger": "Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: mage update",
  "mobileUpdate.toast.available.title": "Доступне оновлення Mage",  "mobileUpdate.toast.available.description": "Версія {version} готова для Android.",
  "mobileUpdate.toast.actions.download": "Завантажити",
  "mobileUpdate.toast.actions.dismiss": "Сховати",
  "mageUpdate.toast.available.title": "Оновлення Mage",
  "mageUpdate.toast.available.description": "Версія {version} доступна.",
  "mageUpdate.toast.actions.update": "Оновити",
  "mageUpdate.toast.actions.dismiss": "Сховати",
  "mageUpdate.toast.actions.reload": "Перезавантажити Mage",
  "mageUpdate.toast.upgrading.title": "Оновлення Mage...",
  "mageUpdate.toast.upgrading.description": "Залиште Mage відкритим.",  "mageUpdate.toast.updated.title": "Mage оновлено",
  "mageUpdate.toast.updated.description": "Оновлення встановлено.",
  "mageUpdate.toast.updated.descriptionWithVersion": "Версію {version} встановлено.",
  "mageUpdate.toast.failed.title": "Не вдалося оновити Mage",
  "mageUpdate.toast.failed.description": "Оновлення Mage не вдалося.",
  "mageUpdate.toast.reload.message": "Перезапуск Mage...",
  ...
  "memoryDebugPanel.metric.gitlabTotalRequests": "Загальна кількість запитів GitLab",
  ...
  "mageLogo.aria.logo": "Логотип Mage",  "markdownRenderer.code.actions.copyTitle": "Скопіювати код",
