...
export const dict: Record<I18nKey, string> = {
  ...
  'shareOpinion.toast.title': '帮助塑造 Mage',
  ...
  'mobile.connect.welcome.title': '连接到 Mage',
  ...
  'mobile.connect.password.placeholder': 'Mage 密码',
  ...
  'sessions.sidebar.footer.actions.aboutMage': '关于 Mage',
  ...
  'sessions.sidebar.group.pr.status.open': 'MR 已打开',
  ...
  'gitView.pr.actions.cancelEditingAria': '取消 MR 编辑',
  'gitView.pr.actions.createPr': '创建 MR',
  'gitView.pr.actions.edit': '编辑',
  'gitView.pr.actions.editPr': '编辑 MR',
  ...
  'gitView.pr.actions.mergePr': '合并 MR',
  ...
  'gitView.pr.actions.openOnGitLab': '在 GitLab 中打开',
  'gitView.pr.actions.openOnGitLabAria': '在 GitLab 中打开拉取请求',
  ...
  'gitView.pr.actions.savePr': '保存 MR',
  ...
  'gitView.pr.actions.refresh': '刷新 MR 状态',
  ...
  'gitView.pr.toast.gitlabApiUnavailable': 'GitLab API 不可用',
  ...
  'gitView.pr.toast.mrCreated': '拉取请求已创建',
  'gitView.pr.toast.mrMerged': '拉取请求已合并',
  'gitView.pr.toast.prNotMerged': '拉取请求未合并',
  'gitView.pr.toast.mrUpdated': '拉取请求已更新',
  ...
  'gitView.pullRequest.availableOnFeatureBranches': '当前分支可以打开 MR 时可用。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Mage 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'header.gitlab.connected': 'GitLab 已连接',
  'header.gitlab.avatarWithLogin': '{login} 头像',
  'header.gitlab.avatar': 'GitLab 头像',
  'header.gitlab.accountsTitle': 'GitLab 账户',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Mage 状态、Mage 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Mage',
  ...
  'header.actions.openAppMenu': 'Mage 菜单',
  'header.actions.openAppMenuAria': '打开 Mage 菜单',
  ...
  'session.gitlabIssuePicker.error.noActiveProject': '没有活动项目',
  'session.gitlabIssuePicker.error.runtimeUnavailable': 'GitLab 运行时 API 不可用',
  'session.gitlabIssuePicker.error.notConnected': 'GitLab 未连接',
  'session.gitlabIssuePicker.error.repoNotResolvable': '无法解析仓库',
  'session.gitlabIssuePicker.error.repoMustBeGitLab': 'origin 远程仓库必须是 GitLab URL',
  'session.gitlabIssuePicker.error.issueNotFound': '未找到 Issue',
  'session.gitlabIssuePicker.error.noModelSelected': '未选择模型',
  'session.gitlabIssuePicker.toast.loadMoreFailed': '加载更多 Issue 失败',
  'session.gitlabIssuePicker.toast.loadIssueDetailsFailed': '加载 Issue 详情失败',
  'session.gitlabIssuePicker.toast.sendContextFailed': '发送 Issue 上下文失败',
  'session.gitlabIssuePicker.toast.sessionCreated': '已从 Issue 创建会话',
  'session.gitlabIssuePicker.toast.startSessionFailed': '启动会话失败',
  'session.gitlabIssuePicker.title.select': '关联 GitLab Issue',
  'session.gitlabIssuePicker.title.createSession': '从 GitLab Issue 新建会话',
  'session.gitlabIssuePicker.description.select': '选择一个 Issue 关联到当前会话。',
  'session.gitlabIssuePicker.description.createSession': '使用隐藏的 Issue 上下文（标题/正文/标签/评论）初始化新会话。',
  'session.gitlabIssuePicker.searchPlaceholder': '使用 GitLab 代码搜索语法进行搜索',
  'session.gitlabIssuePicker.empty.noActiveProject': '未选择活动项目。',
  'session.gitlabIssuePicker.empty.runtimeUnavailable': 'GitLab 运行时 API 不可用。',
  'session.gitlabIssuePicker.empty.notConnected': 'GitLab 未连接。请在设置中连接 GitLab 账号。',
  'session.gitlabIssuePicker.empty.noIssuesFound': '未找到 Issue',
  'session.gitlabIssuePicker.empty.noOpenIssuesFound': '没有未关闭的 Issue',
  'session.gitlabIssuePicker.loading.issues': '正在加载 Issue...',
  'session.gitlabIssuePicker.loading.more': '加载中...',
  'session.gitlabIssuePicker.actions.openSettings': '打开设置',
  'session.gitlabIssuePicker.actions.useIssue': '使用 Issue #{number}',
  'session.gitlabIssuePicker.actions.openInGitLabAria': '在 GitLab 中打开',
  'session.gitlabIssuePicker.actions.loadMore': '加载更多',
  'session.gitlabIssuePicker.actions.sectionTitle': '操作',
  'session.gitlabIssuePicker.actions.toggleWorktreeAria': '切换工作树',
  'session.gitlabIssuePicker.actions.createInWorktree': '在工作树中创建',
  'session.gitlabIssuePicker.actions.openRepo': '打开仓库',
  'session.gitlabIssuePicker.actions.refresh': '刷新',
  'session.gitlabMrPicker.error.noActiveProject': '没有活动项目',
  'session.gitlabMrPicker.error.runtimeUnavailable': 'GitLab 运行时 API 不可用',
  'session.gitlabMrPicker.error.notConnected': 'GitLab 未连接',
  'session.gitlabMrPicker.error.prNotFound': '未找到 merge request',
  'session.gitlabMrPicker.error.repoNotResolvable': '无法解析仓库',
  'session.gitlabMrPicker.error.repoMustBeGitLab': 'origin 远程仓库必须是 GitLab URL',
  'session.gitlabMrPicker.toast.loadMoreFailed': '加载更多 merge request 失败',
  'session.gitlabMrPicker.toast.loadDetailsFailed': '加载 merge request 详情失败',
  'session.gitlabMrPicker.title': '关联 GitLab merge request',
  'session.gitlabMrPicker.description': '选择一个 merge request，将审查上下文附加到此消息。',
  'session.gitlabMrPicker.searchPlaceholder': '使用 GitLab 代码搜索语法进行搜索',
  'session.gitlabMrPicker.includeDiffAria': '在附加上下文中包含 MR 差异',
  'session.gitlabMrPicker.includeDiff': '包含 MR 差异',
  'session.gitlabMrPicker.empty.noActiveProject': '未选择活动项目。',
  'session.gitlabMrPicker.empty.runtimeUnavailable': 'GitLab 运行时 API 不可用。',
  'session.gitlabMrPicker.empty.notConnected': 'GitLab 未连接。请在设置中连接 GitLab 账号。',
  'session.gitlabMrPicker.empty.noPullRequestsFound': '未找到 merge request',
  'session.gitlabMrPicker.empty.noOpenPullRequestsFound': '没有未关闭的 merge request',
  'session.gitlabMrPicker.loading.pullRequests': '正在加载 merge request...',
  'session.gitlabMrPicker.loading.more': '加载中...',
  'session.gitlabMrPicker.actions.openSettings': '打开设置',
  'session.gitlabMrPicker.actions.usePullRequest': '使用 merge request #{number}',
  'session.gitlabMrPicker.actions.openInGitLabAria': '在 GitLab 中打开',
  'session.gitlabMrPicker.actions.loadMore': '加载更多',
  ...
  'session.newWorktree.actions.startFromGitLabIssuePr': '从 GitLab Issue/MR 开始',
  ...
  'session.newWorktree.error.sendGitLabContextFailed': '发送 GitLab 上下文失败',
  'session.newWorktree.error.createWorktreeFailed': '创建工作树失败',
  'session.newWorktree.toast.sessionFromIssue': '已从 Issue 创建会话',
  'session.newWorktree.toast.sessionFromPr': '已从 MR 创建会话',
  'session.newWorktree.toast.worktreeCreated': '工作树已创建',
  'session.newWorktree.toast.worktreeCreatedDescription': '{target} - 正在后台初始化',
  'session.gitlabIntegration.title': '从 GitLab 选择',
  'session.gitlabIntegration.tabs.issues': 'Issues',
  'session.gitlabIntegration.tabs.pullRequests': 'merge requests',
  'session.gitlabIntegration.connect.title': '连接到 GitLab',
  'session.gitlabIntegration.connect.description': '关联 Issue 或 merge request 以自动填充工作树详情',
  'session.gitlabIntegration.connect.action': '连接 GitLab',
  'session.gitlabIntegration.search.issuesPlaceholder': '使用 GitLab 代码搜索语法进行搜索',
  'session.gitlabIntegration.search.prsPlaceholder': '使用 GitLab 代码搜索语法进行搜索',
  'session.gitlabIntegration.empty.noIssuesFound': '未找到 Issue',
  'session.gitlabIntegration.empty.noPullRequestsFound': '未找到 merge request',
  'session.gitlabIntegration.actions.loadMore': '加载更多',
  'session.gitlabIntegration.actions.cancel': '取消',
  'session.gitlabIntegration.actions.select': '选择',
  'session.gitlabIntegration.selected.issueNumber': 'Issue #{number}',
  'session.gitlabIntegration.selected.prNumber': 'MR #{number}',
  'session.gitlabIntegration.includeDiffAria': '在会话上下文中包含 MR 差异',
  'session.gitlabIntegration.includeDiff': '包含 MR 差异',
  'session.gitlabIntegration.error.notConnected': 'GitLab 未连接',
  'session.gitlabIntegration.error.loadDataFailed': '加载数据失败',
  'session.gitlabIntegration.validation.branchAlreadyCheckedOut': '该分支已在某个工作树中检出',
  'session.gitlabIntegration.validation.branchAlreadyExists': '该分支已在本地存在',
  'session.gitlabIntegration.validation.failed': '校验失败',
  ...
  'chat.emptyState.mageUnreachable': '无法连接 Mage',
  ...
  'chat.chatInput.actions.linkGitlabIssue': '关联 GitLab Issue',
  'chat.chatInput.actions.linkGitlabMr': '关联 GitLab MR',
  ...
  'chat.chatInput.linked.pr.openInBrowserAria': '在浏览器中打开 merge request',
  'chat.chatInput.linked.pr.removeAria': '移除已关联的 merge request',
  ...
  'mageStatusDialog.title': 'Mage 状态',
  'mageStatusDialog.description': '查看当前 Mage 状态与诊断信息。',
  'mageStatusDialog.actions.copy': '复制',
  'mageStatusDialog.empty.noData': '无数据。',
  'mageStatusDialog.toast.copiedTitle': '已复制',
  'mageStatusDialog.toast.copiedDescription': '状态已复制到剪贴板',
  'mageStatusDialog.toast.copyFailed': '复制状态失败',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 Mage，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Mage',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Mage 服务器之间切换',
  ...
  'multiRun.window.description': 'Mage 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Mage',
  ...
  'onboarding.localSetup.title': '设置 Mage',
  'onboarding.localSetup.description': '安装 Mage CLI 以继续。',
  'onboarding.localSetup.dialog.selectMageBinary': '选择 Mage 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'Mage CLI 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 Mage。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Mage 未自动检测到 Mage，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'Mage 是 Mage 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'Mage 文档',
  'onboarding.localSetup.docs.default': 'Mage 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 Mage CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 Mage',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 Mage CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Mage 设置并重新加载 Mage 配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，请原生安装并运行 Mage。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若检测失败，请设置原生路径，例如 mage.cmd 或 mage.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安装？请确认 mage 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或设置 MAGE_BINARY 环境变量。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Mage 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Mage 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Mage。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Mage，但与此应用版本不兼容。请更新服务器上的 Mage 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Mage。请确认地址是否指向 Mage 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 Mage 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'Mage CLI 无法启动或未安装。请安装 Mage，或改为连接远程服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Mage。请确认地址是否指向 Mage 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Mage 服务器与此应用版本不兼容。请更新服务器上的 Mage 后重试。',
  ...
  'startup.initRecovery.description': 'Mage 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：mage update',
  ...
  'mageUpdate.toast.available.description': '版本 {version} 可用。',
  'mageUpdate.toast.actions.update': '更新',
  'mageUpdate.toast.actions.dismiss': '忽略',
  'mageUpdate.toast.actions.reload': '重载 Mage',
  'mageUpdate.toast.upgrading.title': '正在更新 Mage...',
  'mageUpdate.toast.upgrading.description': '请保持 Mage 打开。',
  'mageUpdate.toast.updated.title': 'Mage 已更新',
  'mageUpdate.toast.updated.description': '更新已安装。',
  'mageUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安装。',
  'mageUpdate.toast.failed.title': '无法更新 Mage',
  'mageUpdate.toast.failed.description': 'Mage 升级失败。',
  'mageUpdate.toast.reload.message': '正在重启 Mage...',
  ...
  'memoryDebugPanel.metric.gitlabTotalRequests': 'GitLab 请求总数',
