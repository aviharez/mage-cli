...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 Mage',
  ...
  'aboutDialog.openChamberVersionLabel': 'Mage 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Mage 状态、OpenCode 健康信息、目录和项目。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Mage 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 Mage 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Mage 设置并重新加载 OpenCode 配置。',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 Mage 打开。',
  ...
  'openChamberLogo.aria.logo': 'Mage 标志',
