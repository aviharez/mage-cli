...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o Mage para acessar mais rápido",  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Mage instalado",  "shareOpinion.actions.shareOpinion": "Compartilhar opinião",
  ...
  "shareOpinion.toast.title": "Ajude a moldar o Mage",  "shareOpinion.toast.description": "Conte o que é útil, confuso ou está faltando para ajudar a definir os próximos passos.",
  ...
  "mobile.connect.welcome.title": "Conectar ao Mage",  "mobile.connect.welcome.description": "Adicione a URL de um servidor ou leia um código QR de pareamento para começar a usar o app móvel.",
  ...
  "mobile.connect.password.placeholder": "Senha do Mage",  "mobile.connect.connectButton": "Conectar",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do Mage.",  "mobile.connect.scan.unsupported": "A leitura de QR só está disponível no app móvel instalado.",
  "mobile.connect.saved.title": "Conexões salvas",
  "mobile.connect.saved.empty": "Nenhuma conexão salva ainda.",
  "mobile.connect.relay.badge": "via Mage Relay",  "mobile.connect.error.urlRequired": "Informe a URL de um servidor.",
  "mobile.connect.error.invalidUrl": "Essa URL de servidor não é válida.",
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor Mage.",  "mobile.connect.error.authRequired": "Este servidor requer uma senha ou token do cliente.",
  ...
  "sessions.sidebar.footer.actions.aboutMage": "Sobre o Mage",  "sessions.sidebar.footer.actions.update": "Atualizar",
  ...
  "sessions.sidebar.group.pr.status.open": "MR aberta",
  ...
  "sessions.sidebar.group.pr.status.draft": "MR de rascunho",
  ...
  "gitView.pr.actions.cancelEditingAria": "Cancelar edição da MR",
  "gitView.pr.actions.createPr": "Criar MR",
  "gitView.pr.actions.edit": "Editar",
  "gitView.pr.actions.editPr": "Editar MR",
  "gitView.pr.actions.editPrAria": "Editar MR",
  "gitView.pr.actions.hide": "Ocultar",
  "gitView.pr.actions.markReady": "Marcar como pronto",
  "gitView.pr.actions.markReadyAria": "Marcar a MR como pronta para revisão",
  "gitView.pr.actions.mergePr": "Fazer merge da MR",
  "gitView.pr.actions.mergePrAria": "Fazer merge da MR",
  ...
  "gitView.pr.actions.openCommentsAria": "Abrir comentários da MR",
  "gitView.pr.actions.openOnGitLab": "Abrir em GitLab",
  "gitView.pr.actions.openOnGitLabAria": "Abrir MR em GitLab",
  ...
  "gitView.pr.actions.savePr": "Salvar MR",
  "gitView.pr.actions.savePrAria": "Salvar alterações da MR",
  ...
  "gitView.pr.actions.shareCommentsAria": "Enviar comentários da MR ao agente",
  "gitView.pr.actions.toggleDraftAria": "Alternar status de rascunho",
  "gitView.pr.actions.refresh": "Atualizar status da MR",
  "gitView.pr.actions.refreshAria": "Atualizar status do merge request",
  ...
  "gitView.pr.checkingStatus": "Verificando status da MR...",
  ...
  "gitView.pr.createTitle": "Criar MR",
  "gitView.pr.draftMustBeReady": "A MR em rascunho precisa ser marcada como pronta antes de fazer merge.",
  ...
  "gitView.pr.gitlabNotConnected": "GitLab não está conectado",
  ...
  "gitView.pr.noMergePermission": "Você não tem permissão para fazer merge desta MR.",
  "gitView.pr.notMergeable": "Não é possível fazer merge",
  "gitView.pr.numberLabel": "MR # {number}",
  ...
  "gitView.pr.placeholder.main": "Resume seu MR",
  "gitView.pr.placeholder.selectBaseBranch": "Selecionar branch base",
  "gitView.pr.placeholder.title": "Título da MR",
  "gitView.pr.placeholder.whatChanged": "O que mudou e por quê?",
  "gitView.pr.statusUnavailable": "Status da MR não disponível",
  ...
  "gitView.pr.toast.createPrFailed": "Não foi possível criar a MR",
  "gitView.pr.toast.generateDescriptionFailed": "Não foi possível gerar a descrição da MR",
  "gitView.pr.toast.gitlabApiUnavailable": "A API do GitLab não está disponível",
  "gitView.pr.toast.loadCheckDetailsFailed": "Não foi possível carregar os detalhes do check",
  "gitView.pr.toast.loadChecksFailed": "Não foi possível carregar os checks da MR",
  "gitView.pr.toast.loadCommentsFailed": "Não foi possível carregar os comentários",
  "gitView.pr.toast.loadPrCommentsFailed": "Não foi possível carregar os comentários da MR",
  "gitView.pr.toast.markReadyFailed": "Não foi possível marcar a MR como pronta",
  "gitView.pr.toast.markedReady": "A MR foi marcada como pronta para revisão",
  "gitView.pr.toast.mergeFailed": "Não foi possível fazer merge da MR",
  ...
  "gitView.pr.toast.noPrComments": "Nenhum comentário da MR encontrado",
  "gitView.pr.toast.mrCreated": "MR criada",
  "gitView.pr.toast.mrMerged": "Merge de MR concluído",
  "gitView.pr.toast.prNotMerged": "Não se hizo merge da MR",
  "gitView.pr.toast.mrUpdated": "MR atualizada",
  ...
  "gitView.pr.toast.updatePrFailed": "Não foi possível atualizar a MR",
  "gitView.pullRequest.createHint": "Crie e gerencie PRs desta branch.",
  "gitView.pullRequest.availableOnFeatureBranches": "Disponível quando a branch atual pode abrir uma MR.",
  "gitView.pullRequest.title": "MR",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Mage — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",  "contextPanel.tab.closeTabAria": "Fechar aba {label}",
  ...
  "header.gitlab.connectedWithLogin": "GitLab: {login}",
  "header.gitlab.connected": "Conectado a GitLab",
  "header.gitlab.avatarWithLogin": "Avatar de {login}",
  "header.gitlab.avatar": "Avatar de GitLab",
  "header.gitlab.accountsTitle": "Contas de GitLab",
  "header.gitlab.accountSource.oauth": "OAuth",
  "header.gitlab.accountSource.cli": "CLI",
  ...
  "header.services.shutdownDev": "Parar Mage",  "header.actions.openPlanAria": "Abrir plano",
  ...
  "aboutDialog.mageAppVersionLabel": "Versão do Mage {version}",  "aboutDialog.mageCliVersionLabel": "Versão do Mage {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Mage, a integridade do Mage, diretórios e projetos.",  "aboutDialog.footerNote": "Feito com carinho para a comunidade",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Mage com eficiência",  "helpDialog.section.navigationCommands": "Navegação e comandos",
  ...
  "header.actions.openAppMenu": "Menu do Mage",  "header.actions.openAppMenuAria": "Abrir menu do Mage",  "header.actions.openSessionsWithShortcut": "Abrir sessões ({shortcut})",
  ...
  "session.gitlabIssuePicker.error.noActiveProject": "Não há nenhum projeto ativo",
  "session.gitlabIssuePicker.error.runtimeUnavailable": "API de runtime de GitLab não disponível",
  "session.gitlabIssuePicker.error.notConnected": "GitLab não está conectado",
  "session.gitlabIssuePicker.error.repoNotResolvable": "Não foi possível resolver o repositório",
  "session.gitlabIssuePicker.error.repoMustBeGitLab": "O remoto origin deve ser uma URL de GitLab",
  "session.gitlabIssuePicker.error.issueNotFound": "Issue não encontrada",
  "session.gitlabIssuePicker.error.noModelSelected": "Não há nenhum modelo selecionado",
  "session.gitlabIssuePicker.toast.loadMoreFailed": "Não foi possível carregar mais issues",
  "session.gitlabIssuePicker.toast.loadIssueDetailsFailed": "Não foi possível carregar os detalhes da issue",
  "session.gitlabIssuePicker.toast.sendContextFailed": "Não foi possível enviar o contexto da issue",
  "session.gitlabIssuePicker.toast.sessionCreated": "Sessão criada a partir da issue",
  "session.gitlabIssuePicker.toast.startSessionFailed": "Não foi possível iniciar a sessão",
  "session.gitlabIssuePicker.title.select": "Vincular issue de GitLab",
  "session.gitlabIssuePicker.title.createSession": "Nova sessão de issue de GitLab",
  "session.gitlabIssuePicker.description.select": "Selecione uma issue para vinculá-la a esta sessão.",
  "session.gitlabIssuePicker.description.createSession": "Inicie uma nova sessão com contexto oculto do issue (título/corpo/etiquetas/comentários).",
  "session.gitlabIssuePicker.searchPlaceholder": "Pesquisar usando a sintaxe de busca de código do GitLab",
  "session.gitlabIssuePicker.empty.noActiveProject": "Não há nenhum projeto ativo selecionado.",
  "session.gitlabIssuePicker.empty.runtimeUnavailable": "API de runtime de GitLab não disponível.",
  "session.gitlabIssuePicker.empty.notConnected": "GitLab não está conectado. Conecte sua conta do GitLab nas configurações.",
  "session.gitlabIssuePicker.empty.noIssuesFound": "Nenhuma issue encontrada",
  "session.gitlabIssuePicker.empty.noOpenIssuesFound": "Nenhuma issue aberta encontrada",
  "session.gitlabIssuePicker.loading.issues": "Carregando issues...",
  "session.gitlabIssuePicker.loading.more": "Carregando...",
  "session.gitlabIssuePicker.actions.openSettings": "Abrir configurações",
  "session.gitlabIssuePicker.actions.useIssue": "Usar issue #{number}",
  "session.gitlabIssuePicker.actions.openInGitLabAria": "Abrir em GitLab",
  "session.gitlabIssuePicker.actions.loadMore": "Carregar mais",
  "session.gitlabIssuePicker.actions.sectionTitle": "Ações",
  "session.gitlabIssuePicker.actions.toggleWorktreeAria": "Ativar worktree",
  "session.gitlabIssuePicker.actions.createInWorktree": "Criar em worktree",
  "session.gitlabIssuePicker.actions.openRepo": "Abrir repositório",
  "session.gitlabIssuePicker.actions.refresh": "Atualizar",
  "session.gitlabMrPicker.error.noActiveProject": "Não há nenhum projeto ativo",
  "session.gitlabMrPicker.error.runtimeUnavailable": "API de runtime de GitLab não disponível",
  "session.gitlabMrPicker.error.notConnected": "GitLab não está conectado",
  "session.gitlabMrPicker.error.prNotFound": "MR não encontrada",
  "session.gitlabMrPicker.error.repoNotResolvable": "Não foi possível resolver o repositório",
  "session.gitlabMrPicker.error.repoMustBeGitLab": "O remoto origin deve ser uma URL de GitLab",
  "session.gitlabMrPicker.toast.loadMoreFailed": "Não foi possível carregar mais PRs",
  "session.gitlabMrPicker.toast.loadDetailsFailed": "Não foi possível carregar os detalhes da MR",
  "session.gitlabMrPicker.title": "Vincular MR de GitLab",
  "session.gitlabMrPicker.description": "Selecione uma MR para anexar contexto de revisão a esta mensagem.",
  "session.gitlabMrPicker.searchPlaceholder": "Pesquisar usando a sintaxe de busca de código do GitLab",
  "session.gitlabMrPicker.includeDiffAria": "Incluir diff da MR no contexto adjunto",
  "session.gitlabMrPicker.includeDiff": "Incluir diff da MR",
  "session.gitlabMrPicker.empty.noActiveProject": "Não há nenhum projeto ativo selecionado.",
  "session.gitlabMrPicker.empty.runtimeUnavailable": "API de runtime de GitLab não disponível.",
  "session.gitlabMrPicker.empty.notConnected": "GitLab não está conectado. Conecte sua conta do GitLab nas configurações.",
  "session.gitlabMrPicker.empty.noPullRequestsFound": "Nenhuma MR encontrada",
  "session.gitlabMrPicker.empty.noOpenPullRequestsFound": "Nenhuma MR aberta encontrada",
  "session.gitlabMrPicker.loading.pullRequests": "Carregando MR...",
  "session.gitlabMrPicker.loading.more": "Carregando...",
  "session.gitlabMrPicker.actions.openSettings": "Abrir configurações",
  "session.gitlabMrPicker.actions.usePullRequest": "Usar MR #{number}",
  "session.gitlabMrPicker.actions.openInGitLabAria": "Abrir em GitLab",
  "session.gitlabMrPicker.actions.loadMore": "Carregar mais",
  ...
  "session.newWorktree.actions.startFromGitLabIssuePr": "Iniciar de Issue/MR de GitLab",
  "session.newWorktree.usingPrBranch": "Usando branch da MR: {branch}",
  ...
  "session.newWorktree.prNumber": "MR #{number}",
  ...
  "session.newWorktree.error.sendGitLabContextFailed": "Não foi possível enviar o contexto de GitLab",
  ...
  "session.newWorktree.toast.sessionFromPr": "Sessão criada a partir da MR",
  ...
  "session.gitlabIntegration.title": "Selecionar de GitLab",
  "session.gitlabIntegration.tabs.issues": "Issues",
  "session.gitlabIntegration.tabs.pullRequests": "MR",
  "session.gitlabIntegration.connect.title": "Conectar a GitLab",
  "session.gitlabIntegration.connect.description": "Vincule issues ou PRs para preencher automaticamente os detalhes do worktree",
  "session.gitlabIntegration.connect.action": "Conectar a GitLab",
  "session.gitlabIntegration.search.issuesPlaceholder": "Pesquisar usando a sintaxe de busca de código do GitLab",
  "session.gitlabIntegration.search.prsPlaceholder": "Pesquisar usando a sintaxe de busca de código do GitLab",
  "session.gitlabIntegration.empty.noIssuesFound": "Nenhuma issue encontrada",
  "session.gitlabIntegration.empty.noPullRequestsFound": "Nenhuma MR encontrada",
  "session.gitlabIntegration.actions.loadMore": "Carregar mais",
  "session.gitlabIntegration.actions.cancel": "Cancelar",
  "session.gitlabIntegration.actions.select": "Selecionar",
  "session.gitlabIntegration.selected.issueNumber": "Issue #{number}",
  "session.gitlabIntegration.selected.prNumber": "MR #{number}",
  "session.gitlabIntegration.includeDiffAria": "Incluir diff do MR no contexto da sessão",
  "session.gitlabIntegration.includeDiff": "Incluir diff do MR",
  "session.gitlabIntegration.error.notConnected": "GitLab não está conectado",
  "session.gitlabIntegration.error.loadDataFailed": "Não foi possível carregar os dados",
  "session.gitlabIntegration.validation.branchAlreadyCheckedOut": "A branch já está em uso em um worktree",
  "session.gitlabIntegration.validation.branchAlreadyExists": "A branch já existe localmente",
  "session.gitlabIntegration.validation.failed": "Não foi possível validar",
  ...
  "chat.emptyState.mageUnreachable": "Mage não está acessível",
  ...
  "chat.generatedResult.pullRequest.title": "merge request gerado",
  ...
  "chat.chatInput.actions.linkGitlabIssue": "Vincular issue de GitLab",
  "chat.chatInput.actions.linkGitlabMr": "Vincular MR de GitLab",
  ...
  "chat.chatInput.linked.pr.number": "MR #{number}",
  "chat.chatInput.linked.pr.openInBrowserAria": "Abrir MR no navegador",
  "chat.chatInput.linked.pr.removeAria": "Excluir MR vinculada",
  ...
  "mageStatusDialog.title": "Status do Mage",
  "mageStatusDialog.description": "Inspecione o status atual do Mage e os diagnósticos.",
  "mageStatusDialog.actions.copy": "Copiar",
  "mageStatusDialog.empty.noData": "Não há dados.",
  "mageStatusDialog.toast.copiedTitle": "Copiado",
  "mageStatusDialog.toast.copiedDescription": "Status copiado para a área de transferência",
  "mageStatusDialog.toast.copyFailed": "Não foi possível copiar o status",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o Mage de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",  "sessionAuth.error.retry": "Tentar novamente",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Mage",  "sessionAuth.locked.tunnelDescription": "Abra este túnel usando o link de conexão única do aplicativo desktop.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Mage",  "desktopHostSwitcher.header.current": "Atual",
  ...
  "multiRun.window.description": "Janela do Mage Multi-Run.",  "voice.status.idle": "Voz pronta",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Mage",  "onboarding.chooser.description": "Escolha como deseja se conectar para começar.",
  "onboarding.chooser.tabs.localInstall": "Instalação local",
  "onboarding.chooser.tabs.connectRemote": "Conectar remoto",
  "onboarding.localSetup.title": "Configuração do Mage",
  "onboarding.localSetup.description": "Instale a CLI do Mage para continuar.",
  "onboarding.localSetup.dialog.selectMageBinary": "Selecionar executável de mage",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do Mage ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  "onboarding.localSetup.errors.detectionFailed": "Erro de detecção",
  "onboarding.localSetup.windows.title": "Configuração no Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Instale o Mage com o comando abaixo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Mage não detectar o Mage automaticamente, defina o caminho do executável a seguir.",  "onboarding.localSetup.intro": "Mage é o coração do Mage. Instale-o para começar.",  "onboarding.localSetup.docs.windows": "Documentação do Mage",
  "onboarding.localSetup.docs.default": "Documentação do Mage",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do Mage está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando Mage",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do Mage:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Mage e recarregue configurações do Mage.",  "onboarding.localSetup.remotePreference": "Prefere usar um servidor remoto?",
  "onboarding.localSetup.actions.connectRemoteServer": "Conectar a um servidor remoto →",
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute o Mage nativamente.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Se a detecção falhar, defina um caminho nativo, como mage.cmd ou mage.exe.",
  "onboarding.localSetup.hint.ensurePath": "Já está instalado? Confira se mage está no seu PATH.",
  "onboarding.localSetup.hint.setEnv": "Ou defina a variável de ambiente MAGE_BINARY.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Mage para conectar.",  "onboarding.remoteConnection.field.serverAddress": "Endereço do servidor",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Mage ou entre em contato com o administrador do servidor.",  "onboarding.remoteConnection.actions.testing": "Testando…",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Mage. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Mage, mas não é compatível com esta versão do app. Atualize o Mage no servidor e tente novamente.",  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Mage. Verifique se o endereço aponta para um servidor Mage.",  "onboarding.remoteConnection.probe.unreachableMessage": "O servidor não está disponível. Revise sua conexão de rede e verifique o endereço do servidor.",
  "onboarding.desktopRecovery.localUnavailable.title": "Mage Local não disponível",
  "onboarding.desktopRecovery.localUnavailable.description": "A CLI do Mage não pôde ser iniciada ou não está instalada. Instale o Mage ou conecte um servidor remoto no lugar dela.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Mage. Verifique se o endereço aponta para um servidor Mage.",  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Mage em \"{host}\" não é compatível com esta versão do app. Atualize o Mage no servidor e tente novamente.",  "onboarding.desktopRecovery.common.useLocal": "Usar Local",
  ...
  "startup.initRecovery.description": "O Mage não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",  "startup.initRecovery.retry": "Tentar novamente",
  ...
  "updateDialog.header.updating": "Atualizando Mage...",  "updateDialog.changelog.title": "O que há de novo",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: mage update",
  "mobileUpdate.toast.available.title": "Atualização do Mage disponível",  "mobileUpdate.toast.available.description": "A versão {version} está pronta para Android.",
  "mobileUpdate.toast.actions.download": "Baixar",
  "mobileUpdate.toast.actions.dismiss": "Dispensar",
  "mageUpdate.toast.available.title": "Atualização do Mage",
  "mageUpdate.toast.available.description": "Versão {version} disponível.",
  "mageUpdate.toast.actions.update": "Atualizar",
  "mageUpdate.toast.actions.dismiss": "Dispensar",
  "mageUpdate.toast.actions.reload": "Recarregar Mage",
  "mageUpdate.toast.upgrading.title": "Atualizando Mage...",
  "mageUpdate.toast.upgrading.description": "Mantenha o Mage aberto.",  "mageUpdate.toast.updated.title": "Mage atualizado",
  "mageUpdate.toast.updated.description": "Atualização instalada.",
  "mageUpdate.toast.updated.descriptionWithVersion": "Versão {version} instalada.",
  "mageUpdate.toast.failed.title": "Não foi possível atualizar o Mage",
  "mageUpdate.toast.failed.description": "A atualização do Mage falhou.",
  "mageUpdate.toast.reload.message": "Reiniciando Mage...",
  ...
  "memoryDebugPanel.metric.gitlabTotalRequests": "Solicitações totais do GitLab",
  ...
  "mageLogo.aria.logo": "Logo do Mage",  "markdownRenderer.code.actions.copyTitle": "Copiar código",
