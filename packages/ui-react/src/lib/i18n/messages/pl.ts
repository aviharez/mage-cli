...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Mage, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Mage został zainstalowany',
  ...
  'shareOpinion.toast.title': 'Pomóż kształtować Mage',
  ...
  'mobile.connect.welcome.title': 'Połącz z Mage',
  ...
  'mobile.connect.password.placeholder': 'Hasło Mage',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia Mage.',
  ...
  'mobile.connect.relay.badge': 'przez Mage Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem Mage.',
  ...
  'sessions.sidebar.footer.actions.aboutMage': 'O Mage',
  ...
  'sessions.sidebar.group.pr.status.open': 'MR otwarty',
  ...
  'sessions.sidebar.group.pr.status.draft': 'Szkic MR',
  ...
  'session.gitlabIntegration.title': 'Wybierz z GitLab',
  'session.gitlabIntegration.tabs.issues': 'Zagadnienia',
  'session.gitlabIntegration.tabs.pullRequests': 'Pull requesty',
  'session.gitlabIntegration.connect.title': 'Połącz z GitLab',
  'session.gitlabIntegration.connect.description': 'Połącz zagadnienia lub pull requesty aby auto-wypełnić szczegóły drzewa pracy',
  'session.gitlabIntegration.connect.action': 'Połącz GitLab',
  'session.gitlabIntegration.search.issuesPlaceholder': 'Szukaj używając składni wyszukiwania kodu GitLab',
  'session.gitlabIntegration.search.prsPlaceholder': 'Szukaj używając składni wyszukiwania kodu GitLab',
  'session.gitlabIntegration.empty.noIssuesFound': 'Nie znaleziono zagadnień',
  'session.gitlabIntegration.empty.noPullRequestsFound': 'Nie znaleziono merge requestów',
  'session.gitlabIntegration.actions.loadMore': 'Załaduj więcej',
  'session.gitlabIntegration.actions.cancel': 'Anuluj',
  'session.gitlabIntegration.actions.select': 'Wybierz',
  'session.gitlabIntegration.selected.issueNumber': 'Zagadnienie #{number}',
  'session.gitlabIntegration.selected.prNumber': 'MR #{number}',
  'session.gitlabIntegration.includeDiffAria': 'Dołącz diff MR do kontekstu sesji',
  'session.gitlabIntegration.includeDiff': 'Dołącz diff MR',
  'session.gitlabIntegration.error.notConnected': 'GitLab nie jest połączony',
  'session.gitlabIntegration.error.loadDataFailed': 'Nie udało się załadować danych',
  'session.gitlabIntegration.validation.branchAlreadyCheckedOut': 'Gałąź jest już wyewidencjonowana w drzewie pracy',
  'session.gitlabIntegration.validation.branchAlreadyExists': 'Gałąź już istnieje lokalnie',
  'session.gitlabIntegration.validation.failed': 'Walidacja nie powiodła się',
  ...
  'chat.emptyState.mageUnreachable': 'Mage jest nieosiągalny',
  ...
  'chat.generatedResult.pullRequest.title': 'Wygenerowany merge request',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Mage.',
  ...
  'onboarding.chooser.title': 'Witaj w Mage',
  ...
  'onboarding.localSetup.title': 'Konfiguracja Mage',
  'onboarding.localSetup.description': 'Zainstaluj CLI Mage aby kontynuować.',
  'onboarding.localSetup.dialog.selectMageBinary': 'Wybierz binarkę mage',
  'onboarding.localSetup.errors.cliNotReady': 'Mage CLI nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj Mage za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Mage nie wykryje Mage automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'Dokumentacja Mage',
  'onboarding.localSetup.docs.default': 'Wyświetl dokumentację',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy Mage CLI jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki Mage:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Mage i przeładowuje konfigurację Mage.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows zainstaluj i uruchom Mage natywnie.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'Jeśli wykrywanie nie powiedzie się, ustaw natywną ścieżkę, np. mage.cmd lub mage.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Juz zainstalowane? Upewnij się, że mage jest w twoim PATH.',
  'onboarding.localSetup.hint.setEnv': 'Lub ustaw zmienną środowiskową MAGE_BINARY.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Mage aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Mage, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Mage. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Mage, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Mage na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Mage. Zweryfikuj czy adres wskazuje na serwer Mage.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Mage lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić Mage CLI lub nie jest zainstalowany. Zainstaluj Mage lub połącz się z serwerem zdalnym.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Mage. Zweryfikuj czy adres wskazuje na serwer Mage.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Mage pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Mage na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Mage nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Mage, kondycję Mage, katalogi i projekty.',
  ...
  'aboutDialog.mageAppVersionLabel': 'Wersja Mage {version}',
  'aboutDialog.mageCliVersionLabel': 'Wersja Mage {version}',
  ...
  'chat.chatInput.linked.pr.openInBrowserAria': 'Otwórz merge request w przeglądarce',
  'chat.chatInput.linked.pr.removeAria': 'Usuń powiązany merge request',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Mage — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Mage',
  ...
  'gitView.pr.actions.cancelEditingAria': 'Anuluj edycję MR',
  'gitView.pr.actions.createPr': 'Utwórz MR',
  'gitView.pr.actions.edit': 'Edytuj',
  'gitView.pr.actions.editPr': 'Edytuj MR',
  'gitView.pr.actions.editPrAria': 'Edytuj merge request',
  'gitView.pr.actions.hide': 'Ukryj',
  'gitView.pr.actions.markReady': 'Oznacz jako gotowe',
  'gitView.pr.actions.markReadyAria': 'Oznacz merge request jako gotowy do recenzji',
  'gitView.pr.actions.mergePr': 'Scal MR',
  'gitView.pr.actions.mergePrAria': 'Scal merge request',
  ...
  'gitView.pr.actions.openOnGitLab': 'Otwórz w GitLab',
  'gitView.pr.actions.openOnGitLabAria': 'Otwórz merge request w GitLab',
  'gitView.pr.actions.openSettings': 'Otwórz ustawienia',
  'gitView.pr.actions.refresh': 'Odśwież status MR',
  ...
  'gitView.pr.actions.savePr': 'Zapisz MR',
  ...
  'gitView.pr.createTitle': 'Utwórz merge request',
  'gitView.pr.draftMustBeReady': 'Szkic MR musi zostać oznaczony jako gotowy przed scaleniem.',
  ...
  'gitView.pr.gitlabNotConnected': 'GitLab nie jest połączony',
  ...
  'gitView.pr.placeholder.main': 'Podsumuj swój merge request',
  ...
  'gitView.pr.toast.gitlabApiUnavailable': 'API GitLab jest niedostępne',
  ...
  'gitView.pr.toast.markedReady': 'merge request oznaczony jako gotowy do recenzji',
  ...
  'gitView.pr.toast.mrCreated': 'merge request utworzony',
  'gitView.pr.toast.mrMerged': 'merge request scalony',
  'gitView.pr.toast.prNotMerged': 'merge request nie został scalony',
  'gitView.pr.toast.mrUpdated': 'merge request zaktualizowany',
  ...
  'gitView.pullRequest.title': 'merge request',
  ...
  'header.actions.openAppMenu': 'Menu Mage',
  'header.actions.openAppMenuAria': 'Otwórz menu Mage',
  ...
  'header.gitlab.accountsTitle': 'Konta GitLab',
  'header.gitlab.accountSource.oauth': 'OAuth',
  'header.gitlab.accountSource.cli': 'CLI',
  'header.gitlab.avatar': 'Awatar GitLab',
  'header.gitlab.avatarWithLogin': 'Awatar {login}',
  'header.gitlab.connected': 'GitLab połączony',
  ...
  'header.services.shutdownDev': 'Zatrzymaj Mage',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Mage.',
  ...
  'memoryDebugPanel.metric.gitlabTotalRequests': 'Łączna liczba żądań GitLab',
  ...
  'mageStatusDialog.actions.copy': 'Kopiuj',
  'mageStatusDialog.description': 'Sprawdź bieżący status i diagnostykę Mage.',
  'mageStatusDialog.empty.noData': 'Brak danych.',
  'mageStatusDialog.title': 'Status Mage',
  'mageStatusDialog.toast.copiedDescription': 'Status skopiowany do schowka',
  'mageStatusDialog.toast.copiedTitle': 'Skopiowano',
  'mageStatusDialog.toast.copyFailed': 'Nie udało się skopiować statusu',
  ...
  'session.gitlabIssuePicker.actions.createInWorktree': 'Utwórz w drzewie pracy',
  'session.gitlabIssuePicker.actions.loadMore': 'Załaduj więcej',
  'session.gitlabIssuePicker.actions.openInGitLabAria': 'Otwórz w GitLab',
  'session.gitlabIssuePicker.actions.openRepo': 'Otwórz repozytorium',
  'session.gitlabIssuePicker.actions.openSettings': 'Otwórz ustawienia',
  'session.gitlabIssuePicker.actions.refresh': 'Odśwież',
  'session.gitlabIssuePicker.actions.sectionTitle': 'Akcje',
  'session.gitlabIssuePicker.actions.toggleWorktreeAria': 'Przełącz drzewo pracy',
  'session.gitlabIssuePicker.actions.useIssue': 'Użyj zgłoszenia #{number}',
  'session.gitlabIssuePicker.description.createSession': 'Tworzy nową sesję z ukrytym kontekstem zgłoszenia (tytuł/treść/etykiety/komentarze).',
  'session.gitlabIssuePicker.description.select': 'Wybierz zgłoszenie, które chcesz powiązać z tą sesją.',
  'session.gitlabIssuePicker.empty.noActiveProject': 'Nie wybrano aktywnego projektu.',
  'session.gitlabIssuePicker.empty.noIssuesFound': 'Nie znaleziono zgłoszeń',
  'session.gitlabIssuePicker.empty.noOpenIssuesFound': 'Nie znaleziono otwartych zgłoszeń',
  'session.gitlabIssuePicker.empty.notConnected': 'GitLab nie jest połączony. Połącz konto GitLab w ustawieniach.',
  'session.gitlabIssuePicker.empty.runtimeUnavailable': 'API środowiska GitLab jest niedostępne.',
  'session.gitlabIssuePicker.error.issueNotFound': 'Nie znaleziono zgłoszenia',
  'session.gitlabIssuePicker.error.noActiveProject': 'Brak aktywnego projektu',
  'session.gitlabIssuePicker.error.noModelSelected': 'Nie wybrano modelu',
  'session.gitlabIssuePicker.error.notConnected': 'GitLab nie jest połączony',
  'session.gitlabIssuePicker.error.repoMustBeGitLab': 'remote origin musi być adresem URL GitLab',
  'session.gitlabIssuePicker.error.repoNotResolvable': 'Nie udało się rozpoznać repozytorium',
  'session.gitlabIssuePicker.error.runtimeUnavailable': 'API środowiska GitLab jest niedostępne',
  'session.gitlabIssuePicker.loading.issues': 'Ładowanie zgłoszeń...',
  'session.gitlabIssuePicker.loading.more': 'Ładowanie...',
  'session.gitlabIssuePicker.searchPlaceholder': 'Szukaj używając składni wyszukiwania kodu GitLab',
  'session.gitlabIssuePicker.title.createSession': 'Nowa sesja ze zgłoszenia GitLab',
  'session.gitlabIssuePicker.title.select': 'Połącz zgłoszenie GitLab',
  'session.gitlabIssuePicker.toast.loadIssueDetailsFailed': 'Nie udało się załadować szczegółów zgłoszenia',
  'session.gitlabIssuePicker.toast.loadMoreFailed': 'Nie udało się załadować kolejnych zgłoszeń',
  'session.gitlabIssuePicker.toast.sendContextFailed': 'Nie udało się wysłać kontekstu zgłoszenia',
  'session.gitlabIssuePicker.toast.sessionCreated': 'Sesja utworzona ze zgłoszenia',
  'session.gitlabIssuePicker.toast.startSessionFailed': 'Nie udało się uruchomić sesji',
  'session.gitlabMrPicker.actions.loadMore': 'Załaduj więcej',
  'session.gitlabMrPicker.actions.openInGitLabAria': 'Otwórz w GitLab',
  'session.gitlabMrPicker.actions.openSettings': 'Otwórz ustawienia',
  'session.gitlabMrPicker.actions.usePullRequest': 'Użyj pull requesta #{number}',
  'session.gitlabMrPicker.description': 'Wybierz merge request, aby dołączyć kontekst recenzji do tej wiadomości.',
  'session.gitlabMrPicker.empty.noActiveProject': 'Nie wybrano aktywnego projektu.',
  'session.gitlabMrPicker.empty.noOpenPullRequestsFound': 'Nie znaleziono otwartych merge requestów',
  'session.gitlabMrPicker.empty.noPullRequestsFound': 'Nie znaleziono merge requestów',
  'session.gitlabMrPicker.empty.notConnected': 'GitLab nie jest połączony. Połącz konto GitLab w ustawieniach.',
  'session.gitlabMrPicker.empty.runtimeUnavailable': 'API środowiska GitLab jest niedostępne.',
  'session.gitlabMrPicker.error.noActiveProject': 'Brak aktywnego projektu',
  'session.gitlabMrPicker.error.notConnected': 'GitLab nie jest połączony',
  'session.gitlabMrPicker.error.prNotFound': 'Nie znaleziono pull requesta',
  'session.gitlabMrPicker.error.repoMustBeGitLab': 'remote origin musi być adresem URL GitLab',
  'session.gitlabMrPicker.error.repoNotResolvable': 'Nie udało się rozpoznać repozytorium',
  'session.gitlabMrPicker.error.runtimeUnavailable': 'API środowiska GitLab jest niedostępne',
  'session.gitlabMrPicker.includeDiff': 'Dołącz diff MR',
  'session.gitlabMrPicker.includeDiffAria': 'Dołącz diff MR do załączonego kontekstu',
  'session.gitlabMrPicker.loading.more': 'Ładowanie...',
  'session.gitlabMrPicker.loading.pullRequests': 'Ładowanie merge requestów...',
  'session.gitlabMrPicker.searchPlaceholder': 'Szukaj używając składni wyszukiwania kodu GitLab',
  'session.gitlabMrPicker.title': 'Połącz merge request GitLab',
  'session.gitlabMrPicker.toast.loadDetailsFailed': 'Nie udało się załadować szczegółów pull requesta',
  'session.gitlabMrPicker.toast.loadMoreFailed': 'Nie udało się załadować kolejnych merge requestów',
  ...
  'session.newWorktree.actions.startFromGitLabIssuePr': 'Rozpocznij ze zgłoszenia/MR GitLab',
  ...
  'session.newWorktree.error.sendGitLabContextFailed': 'Nie udało się wysłać kontekstu GitLab',
  ...
  'session.newWorktree.toast.sessionFromPr': 'Sesja utworzona z MR',
  ...
  'session.newWorktree.usingPrBranch': 'Używana gałąź MR: {branch}',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz Mage z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Mage',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: mage update',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja Mage',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Mage...',
  ...
  'mageUpdate.toast.available.title': 'Aktualizacja Mage',
  'mageUpdate.toast.available.description': 'Wersja {version} dostępna.',
  'mageUpdate.toast.actions.update': 'Aktualizuj',
  'mageUpdate.toast.actions.dismiss': 'Odrzuć',
  'mageUpdate.toast.actions.reload': 'Przeładuj Mage',
  'mageUpdate.toast.upgrading.title': 'Aktualizowanie Mage...',
  'mageUpdate.toast.upgrading.description': 'Pozostaw Mage otwarte.',
  'mageUpdate.toast.updated.title': 'Mage zaktualizowany',
  'mageUpdate.toast.updated.description': 'Aktualizacja zainstalowana.',
  'mageUpdate.toast.updated.descriptionWithVersion': 'Wersja {version} zainstalowana.',
  'mageUpdate.toast.failed.title': 'Nie udało się zaktualizować Mage',
  'mageUpdate.toast.failed.description': 'Aktualizacja Mage nie powiodła się.',
  'mageUpdate.toast.reload.message': 'Ponowne uruchamianie Mage...',
  ...
  'onboarding.localSetup.intro': 'Mage to serce Mage — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na Mage',
  ...
  'settings.mage.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.mage.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.mage.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.mage.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.mage.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.mage.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.mage.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.mage.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
