export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Skopiuj ID z adresu panelu i cookie auth z narzędzi deweloperskich przeglądarki. Mage nigdy nie skanuje plików cookie przeglądarki.',
  ...
  'settings.openchamber.about.title': 'O Mage',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj Mage przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj Mage przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimalizuj i zamykaj Mage do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimalizuj i zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje Mage w zasobniku systemowym Windows, gdy główne okno jest zminimalizowane lub zamknięte.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy Mage jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy Mage jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Mage pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez Mage.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie Mage',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie Mage',
