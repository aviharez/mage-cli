...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Mage를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Mage가 설치되었습니다',
  ...
  'shareOpinion.toast.title': 'Mage의 방향을 함께 만들어 주세요',
  ...
  'mobile.connect.welcome.title': 'Mage에 연결',
  ...
  'mobile.connect.password.placeholder': 'Mage 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 Mage 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'Mage Relay 경유',
  'mobile.connect.error.urlRequired': '서버 URL을 입력하세요.',
  'mobile.connect.error.invalidUrl': '유효하지 않은 서버 URL입니다.',
  'mobile.connect.error.unreachable': '해당 Mage 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutMage': 'Mage 정보',
  ...
  'gitView.pr.actions.cancelEditingAria': 'MR 편집 취소',
  'gitView.pr.actions.createPr': 'MR 생성',
  'gitView.pr.actions.edit': '편집',
  'gitView.pr.actions.editPr': 'MR 편집',
  'gitView.pr.actions.editPrAria': '편집 MR',
  'gitView.pr.actions.hide': '숨기기',
  'gitView.pr.actions.markReady': '리뷰 준비로 표시',
  'gitView.pr.actions.markReadyAria': 'MR을 리뷰 준비 상태로 표시',
  'gitView.pr.actions.mergePr': 'MR 병합',
  'gitView.pr.actions.mergePrAria': 'MR 병합',
  'gitView.pr.actions.openChecks': '체크 열기',
  'gitView.pr.actions.openChecksAria': '실패한 검사 열기',
  'gitView.pr.actions.openComments': '댓글 열기',
  'gitView.pr.actions.openCommentsAria': 'MR 댓글 열기',
  'gitView.pr.actions.openOnGitLab': 'GitLab에서 열기',
  'gitView.pr.actions.openOnGitLabAria': 'GitLab에서 MR 열기',
  ...
  'gitView.pr.actions.savePr': '저장 MR',
  'gitView.pr.actions.savePrAria': 'MR 변경 사항 저장',
  ...
  'gitView.pr.actions.shareCommentsAria': '보내기 MR 댓글로 에이전트',
  'gitView.pr.actions.toggleDraftAria': '드래프트 상태 전환',
  'gitView.pr.actions.refresh': 'MR 상태 새로고침',
  ...
  'gitView.pr.checkingStatus': 'MR 상태 확인 중…',
  ...
  'gitView.pr.createTitle': 'MR 생성',
  'gitView.pr.draftMustBeReady': '드래프트 MR은 병합 전에 리뷰 준비 상태로 바꿔야 합니다.',
  'gitView.pr.field.baseBranch': '기본 브랜치',
  'gitView.pr.field.description': '설명',
  'gitView.pr.field.draft': '드래프트',
  'gitView.pr.field.title': '제목',
  'gitView.pr.gitlabNotConnected': 'GitLab에 연결되지 않음',
  ...
  'gitView.pr.noMergePermission': '이 MR을 병합할 권한이 없습니다.',
  ...
  'gitView.pr.placeholder.main': 'MR 요약',
  'gitView.pr.placeholder.selectBaseBranch': '기본 브랜치 선택',
  'gitView.pr.placeholder.title': 'MR 제목',
  'gitView.pr.placeholder.whatChanged': '무엇이 왜 바뀌었나요?',
  'gitView.pr.statusUnavailable': 'MR 상태를 사용할 수 없음',
  'gitView.pr.toast.baseBranchRequired': '기본 브랜치를 선택하세요',
  'gitView.pr.toast.baseMustDifferFromHead': '기본 브랜치는 현재 브랜치와 달라야 합니다',
  'gitView.pr.toast.createPrFailed': 'MR 생성 실패',
  'gitView.pr.toast.generateDescriptionFailed': 'MR 설명 생성 실패',
  'gitView.pr.toast.gitlabApiUnavailable': 'GitLab API를 사용할 수 없음',
  'gitView.pr.toast.loadCheckDetailsFailed': '체크 상세 로드 실패',
  'gitView.pr.toast.loadChecksFailed': 'MR 체크 로드 실패',
  'gitView.pr.toast.loadCommentsFailed': '댓글 로드 실패',
  'gitView.pr.toast.loadPrCommentsFailed': 'MR 댓글 로드 실패',
  'gitView.pr.toast.markReadyFailed': 'MR 준비 상태 변경 실패',
  'gitView.pr.toast.markedReady': 'MR을 리뷰 준비 상태로 표시함',
  'gitView.pr.toast.mergeFailed': 'MR 병합 실패',
  ...
  'gitView.pr.toast.noPrComments': 'MR 댓글 없음',
  'gitView.pr.toast.mrCreated': 'MR 생성됨',
  'gitView.pr.toast.mrMerged': 'MR이 병합되었습니다',
  'gitView.pr.toast.prNotMerged': 'MR이 병합되지 않았습니다',
  'gitView.pr.toast.mrUpdated': 'MR 업데이트됨',
  'gitView.pr.toast.sendMessageFailed': '에이전트에 메시지 전송 실패',
  'gitView.pr.toast.titleRequired': '제목 필수',
  'gitView.pr.toast.updatePrFailed': 'MR 업데이트 실패',
  'gitView.pullRequest.createHint': '이 브랜치에서 MR을 만들고 관리하세요.',
  'gitView.pullRequest.availableOnFeatureBranches': '현재 브랜치에서 MR을 열 수 있을 때 사용할 수 있습니다.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Mage에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'Mage 종료',
  ...
  'header.gitlab.connected': 'GitLab 연결됨',
  'header.gitlab.avatarWithLogin': '{login} 아바타',
  'header.gitlab.avatar': 'GitLab 아바타',
  'header.gitlab.accountsTitle': 'GitLab 계정',
  ...
  'aboutDialog.mageAppVersionLabel': 'Mage 버전 {version}',
  'aboutDialog.mageCliVersionLabel': 'Mage 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Mage 상태, Mage 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 Mage를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Mage 메뉴',
  'header.actions.openAppMenuAria': 'Mage 메뉴 열기',
  ...
  'session.gitlabIssuePicker.error.noActiveProject': '활성 프로젝트가 없습니다',
  'session.gitlabIssuePicker.error.runtimeUnavailable': 'GitLab 런타임 API를 사용할 수 없습니다',
  'session.gitlabIssuePicker.error.notConnected': 'GitLab에 연결되어 있지 않습니다',
  'session.gitlabIssuePicker.error.repoNotResolvable': '저장소를 확인할 수 없습니다',
  'session.gitlabIssuePicker.error.repoMustBeGitLab': 'origin 리모트는 GitLab URL이어야 합니다',
  'session.gitlabIssuePicker.error.issueNotFound': '이슈를 찾을 수 없습니다',
  'session.gitlabIssuePicker.error.noModelSelected': '선택된 모델이 없습니다',
  'session.gitlabIssuePicker.toast.loadMoreFailed': '이슈를 더 불러오지 못했습니다',
  'session.gitlabIssuePicker.toast.loadIssueDetailsFailed': '이슈 상세 정보를 불러오지 못했습니다',
  'session.gitlabIssuePicker.toast.sendContextFailed': '이슈 컨텍스트 전송에 실패했습니다',
  'session.gitlabIssuePicker.toast.sessionCreated': '이슈에서 세션을 생성했습니다',
  'session.gitlabIssuePicker.toast.startSessionFailed': '세션 시작에 실패했습니다',
  'session.gitlabIssuePicker.title.select': 'GitLab 이슈 연결',
  'session.gitlabIssuePicker.title.createSession': 'GitLab 이슈로 새 세션 만들기',
  'session.gitlabIssuePicker.description.select': '이 세션에 연결할 이슈를 선택하세요.',
  'session.gitlabIssuePicker.description.createSession': '제목, 본문, 라벨, 댓글을 숨겨진 이슈 컨텍스트로 새 세션에 추가합니다.',
  'session.gitlabIssuePicker.searchPlaceholder': 'GitLab 코드 검색 구문을 사용하여 검색',
  'session.gitlabIssuePicker.empty.noActiveProject': '선택된 활성 프로젝트가 없습니다',
  'session.gitlabIssuePicker.empty.runtimeUnavailable': 'GitLab 런타임 API를 사용할 수 없습니다.',
  'session.gitlabIssuePicker.empty.notConnected': 'GitLab에 연결되지 않았습니다. 설정에서 GitLab 계정을 연결하세요.',
  'session.gitlabIssuePicker.empty.noIssuesFound': '이슈 없음',
  'session.gitlabIssuePicker.empty.noOpenIssuesFound': '열린 이슈가 없습니다',
  'session.gitlabIssuePicker.loading.issues': '이슈 로드 중…',
  'session.gitlabIssuePicker.loading.more': '로드 중…',
  'session.gitlabIssuePicker.actions.openSettings': '설정 열기',
  'session.gitlabIssuePicker.actions.useIssue': '이슈 #{number} 사용',
  'session.gitlabIssuePicker.actions.openInGitLabAria': 'GitLab에서 열기',
  'session.gitlabIssuePicker.actions.loadMore': '더 불러오기',
  'session.gitlabIssuePicker.actions.sectionTitle': '작업',
  'session.gitlabIssuePicker.actions.toggleWorktreeAria': '토글 워크트리',
  'session.gitlabIssuePicker.actions.createInWorktree': '워크트리에서 생성',
  'session.gitlabIssuePicker.actions.openRepo': '레포지토리 열기',
  'session.gitlabIssuePicker.actions.refresh': '새로고침',
  'session.gitlabMrPicker.error.noActiveProject': '활성 프로젝트가 없습니다',
  'session.gitlabMrPicker.error.runtimeUnavailable': 'GitLab 런타임 API를 사용할 수 없습니다',
  'session.gitlabMrPicker.error.notConnected': 'GitLab에 연결되어 있지 않습니다',
  'session.gitlabMrPicker.error.prNotFound': 'MR을 찾을 수 없습니다',
  'session.gitlabMrPicker.error.repoNotResolvable': '저장소를 확인할 수 없습니다',
  'session.gitlabMrPicker.error.repoMustBeGitLab': 'origin 리모트는 GitLab URL이어야 합니다',
  'session.gitlabMrPicker.toast.loadMoreFailed': 'MR을 더 불러오지 못했습니다',
  'session.gitlabMrPicker.toast.loadDetailsFailed': 'MR 상세 정보를 불러오지 못했습니다',
  'session.gitlabMrPicker.title': 'GitLab MR 연결',
  'session.gitlabMrPicker.description': '이 메시지에 리뷰 컨텍스트로 첨부할 MR을 선택하세요.',
  'session.gitlabMrPicker.searchPlaceholder': 'GitLab 코드 검색 구문을 사용하여 검색',
  'session.gitlabMrPicker.includeDiffAria': 'MR 변경사항을 첨부 컨텍스트에 포함',
  'session.gitlabMrPicker.includeDiff': 'MR 변경사항 포함',
  'session.gitlabMrPicker.empty.noActiveProject': '선택된 활성 프로젝트가 없습니다',
  'session.gitlabMrPicker.empty.runtimeUnavailable': 'GitLab 런타임 API를 사용할 수 없습니다.',
  'session.gitlabMrPicker.empty.notConnected': 'GitLab에 연결되지 않았습니다. 설정에서 GitLab 계정을 연결하세요.',
  'session.gitlabMrPicker.empty.noPullRequestsFound': 'MR이 없습니다',
  'session.gitlabMrPicker.empty.noOpenPullRequestsFound': '열린 MR이 없습니다',
  'session.gitlabMrPicker.loading.pullRequests': 'MR 불러오는 중…',
  'session.gitlabMrPicker.loading.more': '로드 중…',
  'session.gitlabMrPicker.actions.openSettings': '설정 열기',
  'session.gitlabMrPicker.actions.usePullRequest': 'MR #{number} 사용',
  'session.gitlabMrPicker.actions.openInGitLabAria': 'GitLab에서 열기',
  'session.gitlabMrPicker.actions.loadMore': '더 불러오기',
  ...
  'session.newWorktree.actions.startFromGitLabIssuePr': 'GitLab 이슈/MR에서 시작',
  'session.newWorktree.usingPrBranch': 'MR 브랜치 사용 중: {branch}',
  ...
  'session.newWorktree.error.sendGitLabContextFailed': 'GitLab 컨텍스트 전송에 실패했습니다',
  'session.newWorktree.error.createWorktreeFailed': '워크트리 생성에 실패했습니다',
  'session.newWorktree.toast.sessionFromIssue': '이슈에서 세션을 생성했습니다',
  'session.newWorktree.toast.sessionFromPr': 'MR에서 세션을 생성했습니다',
  ...
  'session.gitlabIntegration.title': 'GitLab에서 선택',
  'session.gitlabIntegration.tabs.issues': '이슈',
  'session.gitlabIntegration.tabs.pullRequests': 'MR',
  'session.gitlabIntegration.connect.title': 'GitLab에 연결',
  'session.gitlabIntegration.connect.description': '이슈 또는 MR을 연결해 워크트리 정보를 자동으로 채웁니다',
  'session.gitlabIntegration.connect.action': 'GitLab 연결',
  'session.gitlabIntegration.search.issuesPlaceholder': 'GitLab 코드 검색 구문을 사용하여 검색',
  'session.gitlabIntegration.search.prsPlaceholder': 'GitLab 코드 검색 구문을 사용하여 검색',
  'session.gitlabIntegration.empty.noIssuesFound': '이슈 없음',
  'session.gitlabIntegration.empty.noPullRequestsFound': 'MR이 없습니다',
  'session.gitlabIntegration.actions.loadMore': '더 불러오기',
  'session.gitlabIntegration.actions.cancel': '취소',
  'session.gitlabIntegration.actions.select': '선택',
  'session.gitlabIntegration.selected.issueNumber': '이슈 #{number}',
  'session.gitlabIntegration.selected.prNumber': 'MR #{number}',
  'session.gitlabIntegration.includeDiffAria': 'MR 변경사항을 세션 컨텍스트에 포함',
  'session.gitlabIntegration.includeDiff': 'MR 변경사항 포함',
  'session.gitlabIntegration.error.notConnected': 'GitLab에 연결되어 있지 않습니다',
  'session.gitlabIntegration.error.loadDataFailed': '데이터를 불러오지 못했습니다',
  'session.gitlabIntegration.validation.branchAlreadyCheckedOut': '브랜치가 이미 워크트리에 체크아웃되어 있습니다',
  'session.gitlabIntegration.validation.branchAlreadyExists': '브랜치가 이미 로컬에 있습니다',
  'session.gitlabIntegration.validation.failed': '유효성 검사에 실패했습니다',
  ...
  'chat.emptyState.mageUnreachable': 'Mage에 연결할 수 없음',
  ...
  'chat.generatedResult.pullRequest.title': '생성된 merge request',
  ...
  'chat.chatInput.actions.linkGitlabIssue': 'GitLab 이슈 연결',
  'chat.chatInput.actions.linkGitlabMr': 'GitLab MR 연결',
  ...
  'chat.chatInput.linked.pr.openInBrowserAria': '브라우저에서 MR 열기',
  'chat.chatInput.linked.pr.removeAria': '연결된 MR 제거',
  ...
  'mageStatusDialog.title': 'Mage 상태',
  'mageStatusDialog.description': '현재 Mage 상태와 진단 정보를 확인합니다.',
  'mageStatusDialog.actions.copy': '복사',
  'mageStatusDialog.empty.noData': '데이터가 없습니다',
  'mageStatusDialog.toast.copiedTitle': '복사됨',
  'mageStatusDialog.toast.copiedDescription': '상태를 클립보드에 복사했습니다',
  'mageStatusDialog.toast.copyFailed': '상태 복사에 실패했습니다',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 Mage를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'Mage 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Mage 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Mage 멀티런 창.',
  ...
  'onboarding.chooser.title': 'Mage에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'Mage 설정',
  'onboarding.localSetup.description': '계속하려면 Mage CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectMageBinary': 'mage 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'Mage CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 Mage를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Mage가 Mage를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'Mage는 Mage의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'Mage 문서',
  'onboarding.localSetup.docs.default': 'Mage 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Mage CLI를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'Mage 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? Mage CLI 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Mage 설정에 저장하고 Mage 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 Mage를 네이티브로 설치하고 실행하세요.',
  'onboarding.localSetup.windows.hintDetectionFailed': '감지에 실패하면 mage.cmd 또는 mage.exe 같은 네이티브 경로를 설정하세요.',
  'onboarding.localSetup.hint.ensurePath': '이미 설치되어 있나요? mage가 PATH에 있는지 확인하세요.',
  ...
  'onboarding.remoteConnection.description': '연결할 Mage 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Mage 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Mage 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Mage가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Mage를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Mage가 실행 중이 아닙니다. 주소가 Mage 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 Mage를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'Mage CLI를 시작할 수 없거나 설치되어 있지 않습니다. Mage를 설치하거나 원격 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 Mage가 실행 중이 아닙니다. 주소가 Mage 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 Mage 서버가 이 앱 버전과 호환되지 않습니다. 서버의 Mage를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'Mage 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'Mage 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `mage update`를 실행하세요.',
  'mobileUpdate.toast.available.title': 'Mage 업데이트 사용 가능',
  ...
  'mageUpdate.toast.available.title': 'Mage 업데이트',
  'mageUpdate.toast.available.description': '버전 {version} 사용 가능.',
  'mageUpdate.toast.actions.update': '업데이트',
  'mageUpdate.toast.actions.dismiss': '닫기',
  'mageUpdate.toast.actions.reload': 'Mage 다시 로드',
  'mageUpdate.toast.upgrading.title': 'Mage 업데이트 중...',
  'mageUpdate.toast.upgrading.description': 'Mage를 열어 두세요.',
  'mageUpdate.toast.updated.title': 'Mage 업데이트 완료',
  'mageUpdate.toast.updated.description': '업데이트가 설치되었습니다.',
  'mageUpdate.toast.updated.descriptionWithVersion': '버전 {version}이 설치되었습니다.',
  'mageUpdate.toast.failed.title': 'Mage를 업데이트할 수 없음',
  'mageUpdate.toast.failed.description': 'Mage 업그레이드에 실패했습니다.',
  'mageUpdate.toast.reload.message': 'Mage 다시 시작 중...',
  ...
  'memoryDebugPanel.metric.gitlabTotalRequests': 'GitLab 전체 요청',
