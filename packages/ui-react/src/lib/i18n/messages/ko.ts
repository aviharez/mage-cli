...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'Mage 정보',
  ...
  'aboutDialog.openChamberVersionLabel': 'Mage 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Mage 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Mage가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 Mage의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Mage 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Mage를 열어 두세요.',
  ...
  'openChamberLogo.aria.logo': 'Mage 로고',
