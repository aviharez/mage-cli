export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': '대시보드 URL에서 워크스페이스 ID를, 브라우저 개발자 도구에서 auth 쿠키를 복사하세요. Mage는 브라우저 쿠키 저장소를 검색하지 않습니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.about.title': 'Mage 정보',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '로그인 시 Mage 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '로그인 시 Mage 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '창을 열지 않고 백그라운드에서 앱을 시작합니다. 데스크톱 상태 아이콘으로 열 수 있습니다.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Mage를 시스템 트레이로 최소화하거나 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '시스템 트레이로 최소화하고 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '메인 창을 최소화하거나 닫아도 Mage가 Windows 시스템 트레이에서 계속 실행됩니다.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Mage가 실행되는 동안 컴퓨터 절전 방지',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Mage가 실행되는 동안 컴퓨터 절전 방지',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Mage는 다시 시작 후 비밀번호를 요청하고, 이후 로그인 세션이 만료되면 다시 요청합니다. 기본 12시간, 이 디바이스 신뢰 선택 시 7일입니다. 로그인을 끄려면 비워 두세요.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Mage 설치 중',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Mage 업데이트 중',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '키는 OpenCode로 직접 전송되며 Mage에 저장되지 않습니다.',
