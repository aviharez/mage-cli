export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': '从控制面板网址复制工作区 ID，并从浏览器开发者工具复制 auth Cookie。Mage 绝不会扫描浏览器 Cookie 存储。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.about.title': '关于 Mage',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登录时启动 Mage',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登录时启动 Mage',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在后台启动应用且不打开窗口。可通过桌面状态图标打开。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '将 Mage 最小化和关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '最小化和关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '主窗口最小化或关闭时，让 Mage 继续在 Windows 系统托盘中运行。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Mage 运行时保持电脑唤醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Mage 运行时保持电脑唤醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Mage 会在重启后要求输入密码，之后在登录会话过期时再次要求：12 小时后，或选择“信任此设备”后 7 天。留空可关闭登录。',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': '正在安装 Mage',
  'settings.remoteInstances.page.phase.updatingOpenChamber': '正在更新 Mage',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '密钥将直接发送给 OpenCode，不会被 Mage 存储。',
