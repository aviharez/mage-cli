...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About Mage',
  ...
  'aboutDialog.openChamberVersionLabel': 'Mage version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Mage state, OpenCode health, directories, and projects.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Mage does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Mage — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Mage settings and reloads OpenCode configuration.',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Mage open.',
  ...
  'openChamberLogo.aria.logo': 'Mage logo',
