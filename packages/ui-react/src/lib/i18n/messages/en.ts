...
export const dict = {
  ...
  'shareOpinion.toast.title': 'Help shape Mage',
  ...
  'mobile.connect.welcome.title': 'Connect to Mage',
  ...
  'mobile.connect.password.placeholder': 'Mage password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Mage connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Mage server.',
  ...
  'sessions.sidebar.footer.actions.aboutMage': 'About Mage',
  ...
  'sessions.sidebar.group.pr.status.open': 'MR open',
  ...
  'sessions.sidebar.group.pr.status.draft': 'Draft MR',
  ...
  'gitView.pr.actions.cancelEditingAria': 'Cancel MR editing',
  'gitView.pr.actions.createPr': 'Create MR',
  'gitView.pr.actions.edit': 'Edit',
  'gitView.pr.actions.editPr': 'Edit MR',
  'gitView.pr.actions.editPrAria': 'Edit merge request',
  'gitView.pr.actions.hide': 'Hide',
  'gitView.pr.actions.markReady': 'Mark ready',
  'gitView.pr.actions.markReadyAria': 'Mark merge request ready for review',
  'gitView.pr.actions.mergePr': 'Merge MR',
  'gitView.pr.actions.mergePrAria': 'Merge merge request',
  ...
  'gitView.pr.actions.openCommentsAria': 'Open merge request comments',
  'gitView.pr.actions.openOnGitLab': 'Open on GitLab',
  'gitView.pr.actions.openOnGitLabAria': 'Open merge request on GitLab',
  ...
  'gitView.pr.actions.savePr': 'Save MR',
  'gitView.pr.actions.savePrAria': 'Save merge request changes',
  ...
  'gitView.pr.actions.shareCommentsAria': 'Send merge request comments to agent',
  'gitView.pr.actions.toggleDraftAria': 'Toggle draft state',
  'gitView.pr.actions.refresh': 'Refresh MR status',
  'gitView.pr.actions.refreshAria': 'Refresh merge request status',
  ...
  'gitView.pr.checkingStatus': 'Checking merge request status...',
  ...
  'gitView.pr.createTitle': 'Create merge request',
  'gitView.pr.draftMustBeReady': 'Draft MR must be marked ready before merge.',
  ...
  'gitView.pr.gitlabNotConnected': 'GitLab is not connected',
  ...
  'gitView.pr.noMergePermission': 'You do not have permission to merge this merge request.',
  ...
  'gitView.pr.placeholder.main': 'Summarize your merge request',
  'gitView.pr.placeholder.selectBaseBranch': 'Select base branch',
  'gitView.pr.placeholder.title': 'merge request title',
  'gitView.pr.placeholder.whatChanged': 'What changed and why?',
  'gitView.pr.statusUnavailable': 'merge request status unavailable',
  ...
  'gitView.pr.toast.createPrFailed': 'Failed to create merge request',
  'gitView.pr.toast.generateDescriptionFailed': 'Failed to generate merge request description',
  'gitView.pr.toast.gitlabApiUnavailable': 'GitLab API is unavailable',
  'gitView.pr.toast.loadCheckDetailsFailed': 'Failed to load check details',
  'gitView.pr.toast.loadChecksFailed': 'Failed to load merge request checks',
  'gitView.pr.toast.loadCommentsFailed': 'Failed to load comments',
  'gitView.pr.toast.loadPrCommentsFailed': 'Failed to load merge request comments',
  'gitView.pr.toast.markReadyFailed': 'Failed to mark merge request ready',
  'gitView.pr.toast.markedReady': 'merge request marked ready for review',
  'gitView.pr.toast.mergeFailed': 'Failed to merge merge request',
  ...
  'gitView.pr.toast.noPrComments': 'No merge request comments found',
  'gitView.pr.toast.mrCreated': 'merge request created',
  'gitView.pr.toast.mrMerged': 'merge request merged',
  'gitView.pr.toast.prNotMerged': 'merge request was not merged',
  'gitView.pr.toast.mrUpdated': 'merge request updated',
  'gitView.pr.toast.sendMessageFailed': 'Failed to send message to agent',
  'gitView.pr.toast.titleRequired': 'Title is required',
  'gitView.pr.toast.updatePrFailed': 'Failed to update merge request',
  'gitView.pullRequest.createHint': 'Create and manage merge requests from this branch.',
  'gitView.pullRequest.availableOnFeatureBranches': 'Available when the current branch can open a merge request.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Mage — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.gitlab.connected': 'GitLab connected',
  'header.gitlab.avatarWithLogin': '{login} avatar',
  'header.gitlab.avatar': 'GitLab avatar',
  'header.gitlab.accountsTitle': 'GitLab Accounts',
  ...
  'header.services.shutdownDev': 'Stop Mage',
  ...
  'aboutDialog.mageAppVersionLabel': 'Mage version {version}',
  'aboutDialog.mageCliVersionLabel': 'Mage version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Mage state, Mage health, directories, and projects.',
  'aboutDialog.footerNote': 'SQI RnD MDZ TCP',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Mage efficiently',
  ...
  'header.actions.openAppMenu': 'Mage menu',
  'header.actions.openAppMenuAria': 'Open Mage menu',
  ...
  'session.gitlabIssuePicker.searchPlaceholder': 'Search using GitLab code search syntax',
  ...
  'session.gitlabMrPicker.error.prNotFound': 'merge request not found',
  ...
  'session.gitlabMrPicker.searchPlaceholder': 'Search using GitLab code search syntax',
  ...
  'session.gitlabMrPicker.empty.noPullRequestsFound': 'No merge requests found',
  'session.gitlabMrPicker.empty.noOpenPullRequestsFound': 'No open merge requests found',
  'session.gitlabMrPicker.loading.pullRequests': 'Loading merge requests...',
  'session.gitlabMrPicker.loading.more': 'Loading...',
  'session.gitlabMrPicker.actions.openSettings': 'Open settings',
  'session.gitlabMrPicker.actions.usePullRequest': 'Use merge request #{number}',
  ...
  'session.newWorktree.actions.startFromGitLabIssuePr': 'Start from GitLab Issue/MR',
  'session.newWorktree.usingPrBranch': 'Using MR branch: {branch}',
  ...
  'session.newWorktree.toast.sessionFromPr': 'Session created from MR',
  ...
  'session.gitlabIntegration.search.issuesPlaceholder': 'Search using GitLab code search syntax',
  'session.gitlabIntegration.search.prsPlaceholder': 'Search using GitLab code search syntax',
  'session.gitlabIntegration.empty.noIssuesFound': 'No issues found',
  'session.gitlabIntegration.empty.noPullRequestsFound': 'No merge requests found',
  ...
  'chat.emptyState.mageUnreachable': 'Mage is not reachable',
  ...
  'chat.generatedResult.pullRequest.title': 'Generated merge request',
  ...
  'chat.chatInput.linked.pr.openInBrowserAria': 'Open merge request in browser',
  'chat.chatInput.linked.pr.removeAria': 'Remove linked merge request',
  ...
  'mageStatusDialog.title': 'Mage Status',
  'mageStatusDialog.description': 'Inspect current Mage status and diagnostics.',
  'mageStatusDialog.actions.copy': 'Copy',
  'mageStatusDialog.empty.noData': 'No data.',
  'mageStatusDialog.toast.copiedTitle': 'Copied',
  'mageStatusDialog.toast.copiedDescription': 'Status copied to clipboard',
  'mageStatusDialog.toast.copyFailed': 'Failed to copy status',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening Mage from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Mage',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Mage servers',
  ...
  'multiRun.window.description': 'Mage Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Mage',
  ...
  'onboarding.localSetup.title': 'Setting Up Mage',
  'onboarding.localSetup.description': 'Install Mage CLI to continue.',
  'onboarding.localSetup.dialog.selectMageBinary': 'Select mage binary',
  'onboarding.localSetup.errors.cliNotReady': 'Mage CLI is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install Mage with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Mage does not detect Mage automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'Mage is the heart of Mage — install it to get started.',
  'onboarding.localSetup.docs.windows': 'Mage docs',
  'onboarding.localSetup.docs.default': 'Mage docs',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if Mage CLI is available. If successful, you\'ll automatically enter the main screen.',
  'onboarding.localSetup.status.watching': 'Waiting for Mage',
  'onboarding.localSetup.status.autoContinue': "We'll continue automatically once it's detected.",
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the Mage CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Mage settings and reloads Mage configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run Mage natively.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'If detection fails, set a native path such as mage.cmd or mage.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Already installed? Make sure mage is in your PATH.',
  'onboarding.localSetup.hint.setEnv': 'Or set MAGE_BINARY environment variable.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Mage server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Mage server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Mage version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Mage but is not compatible with this app version. Update Mage on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Mage. Verify the address points to an Mage server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local Mage Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'Mage CLI could not be started or is not installed. Install Mage or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Mage. Verify the address points to an Mage server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Mage server at "{host}" is not compatible with this app version. Update Mage on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Mage could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Mage...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: mage update',
  'mobileUpdate.toast.available.title': 'Mage update available',
  ...
  'mageUpdate.toast.available.title': 'Mage update',
  'mageUpdate.toast.available.description': 'Version {version} available.',
  'mageUpdate.toast.actions.update': 'Update',
  'mageUpdate.toast.actions.dismiss': 'Dismiss',
  'mageUpdate.toast.actions.reload': 'Reload Mage',
  'mageUpdate.toast.upgrading.title': 'Updating Mage...',
  'mageUpdate.toast.upgrading.description': 'Keep Mage open.',
  'mageUpdate.toast.updated.title': 'Mage updated',
  'mageUpdate.toast.updated.description': 'Update installed.',
  'mageUpdate.toast.updated.descriptionWithVersion': 'Version {version} installed.',
  'mageUpdate.toast.failed.title': 'Could not update Mage',
  'mageUpdate.toast.failed.description': 'The Mage upgrade failed.',
  'mageUpdate.toast.reload.message': 'Restarting Mage...',
  ...
  'memoryDebugPanel.metric.gitlabTotalRequests': 'GitLab Total Requests',
