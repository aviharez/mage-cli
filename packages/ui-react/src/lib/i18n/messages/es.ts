...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de Mage",  "sessions.sidebar.footer.actions.update": "Actualizar",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de Mage {version}",  "aboutDialog.openCodeVersionLabel": "Versión de OpenCode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Mage, el estado de OpenCode, directorios y proyectos.",  "aboutDialog.footerNote": "Hecho con amor para la comunidad",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Mage no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",  "onboarding.localSetup.intro": "OpenCode es el corazón de Mage. Instálalo para empezar.",  "onboarding.localSetup.docs.windows": "Documentación de OpenCode",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Mage y recarga la configuración de OpenCode.",  "onboarding.localSetup.remotePreference": "¿Prefieres usar un servidor remoto?",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén Mage abierto.",  "opencodeUpdate.toast.updated.title": "OpenCode actualizado",
  ...
  "openChamberLogo.aria.logo": "Logo de Mage",  "markdownRenderer.code.actions.copyTitle": "Copiar código",
