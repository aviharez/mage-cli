...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala Mage para acceder más rápido",  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "Mage se instaló",  "shareOpinion.actions.shareOpinion": "Compartir opinión",
  ...
  "shareOpinion.toast.title": "Ayuda a dar forma a Mage",  "shareOpinion.toast.description": "Cuenta qué es útil, confuso o falta para ayudar a definir lo que viene después.",
  ...
  "mobile.connect.welcome.title": "Conéctate a Mage",  "mobile.connect.welcome.description": "Agrega una URL de servidor o escanea un código QR de emparejamiento para empezar a usar la app móvil.",
  ...
  "mobile.connect.password.placeholder": "Contraseña de Mage",  "mobile.connect.connectButton": "Conectar",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de Mage.",  "mobile.connect.scan.unsupported": "El escaneo de QR solo está disponible en la app móvil instalada.",
  "mobile.connect.saved.title": "Conexiones guardadas",
  "mobile.connect.saved.empty": "Aún no hay conexiones guardadas.",
  "mobile.connect.relay.badge": "a través de Mage Relay",  "mobile.connect.error.urlRequired": "Introduce una URL de servidor.",
  "mobile.connect.error.invalidUrl": "Esa URL de servidor no es válida.",
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de Mage.",  "mobile.connect.error.authRequired": "Este servidor requiere una contraseña o un token de cliente.",
  ...
  "sessions.sidebar.footer.actions.aboutMage": "Acerca de Mage",  "sessions.sidebar.footer.actions.update": "Actualizar",
  ...
  "sessions.sidebar.group.pr.status.open": "MR abierto",
  ...
  "sessions.sidebar.group.pr.status.draft": "MR en borrador",
  ...
  "gitView.pr.actions.cancelEditingAria": "Cancelar edición de MR",
  "gitView.pr.actions.createPr": "Crear MR",
  ...
  "gitView.pr.actions.markReadyAria": "Marcar la MR como lista para revisión",
  "gitView.pr.actions.mergePr": "Hacer merge de la MR",
  "gitView.pr.actions.mergePrAria": "Hacer merge de la MR",
  ...
  "gitView.pr.actions.openCommentsAria": "Abrir comentarios de la MR",
  "gitView.pr.actions.openOnGitLab": "Abrir en GitLab",
  "gitView.pr.actions.openOnGitLabAria": "Abrir MR en GitLab",
  ...
  "gitView.pr.actions.savePr": "Guardar MR",
  "gitView.pr.actions.savePrAria": "Guardar cambios de la MR",
  ...
  "gitView.pr.actions.shareCommentsAria": "Enviar comentarios de la MR al agente",
  "gitView.pr.actions.toggleDraftAria": "Alternar estado de borrador",
  "gitView.pr.actions.refresh": "Actualizar estado de la MR",
  "gitView.pr.actions.refreshAria": "Actualizar estado del merge request",
  ...
  "gitView.pr.checkingStatus": "Comprobando estado de la MR...",
  ...
  "gitView.pr.createTitle": "Crear MR",
  "gitView.pr.draftMustBeReady": "La MR en borrador debe marcarse como lista antes de hacer merge.",
  ...
  "gitView.pr.gitlabNotConnected": "GitLab no está conectado",
  ...
  "gitView.pr.noMergePermission": "No tienes permiso para hacer merge de esta MR.",
  ...
  "gitView.pr.placeholder.main": "Resume tu MR",
  "gitView.pr.placeholder.selectBaseBranch": "Seleccionar rama base",
  "gitView.pr.placeholder.title": "Título de la MR",
  "gitView.pr.placeholder.whatChanged": "¿Qué cambió y por qué?",
  "gitView.pr.statusUnavailable": "Estado de la MR no disponible",
  ...
  "gitView.pr.toast.createPrFailed": "No se pudo crear la MR",
  "gitView.pr.toast.generateDescriptionFailed": "No se pudo generar la descripción de la MR",
  "gitView.pr.toast.gitlabApiUnavailable": "La API de GitLab no está disponible",
  "gitView.pr.toast.loadCheckDetailsFailed": "No se pudieron cargar los detalles del check",
  "gitView.pr.toast.loadChecksFailed": "No se pudieron cargar los checks de la MR",
  "gitView.pr.toast.loadCommentsFailed": "No se pudieron cargar los comentarios",
  "gitView.pr.toast.loadPrCommentsFailed": "No se pudieron cargar los comentarios de la MR",
  "gitView.pr.toast.markReadyFailed": "No se pudo marcar la MR como lista",
  "gitView.pr.toast.markedReady": "La MR se marcó como lista para revisión",
  "gitView.pr.toast.mergeFailed": "No se pudo hacer merge de la MR",
  ...
  "gitView.pr.toast.noPrComments": "No se encontraron comentarios de la MR",
  "gitView.pr.toast.mrCreated": "MR creada",
  "gitView.pr.toast.mrMerged": "Merge de MR completado",
  "gitView.pr.toast.prNotMerged": "No se hizo merge de la MR",
  "gitView.pr.toast.mrUpdated": "MR actualizada",
  ...
  "gitView.pr.toast.updatePrFailed": "No se pudo actualizar la MR",
  "gitView.pullRequest.createHint": "Crea y gestiona MR desde esta rama.",
  "gitView.pullRequest.availableOnFeatureBranches": "Disponible cuando la rama actual puede abrir un MR.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Mage: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",  "contextPanel.tab.closeTabAria": "Cerrar pestaña {label}",
  ...
  "header.gitlab.accountsTitle": "Cuentas de GitLab",
  ...
  "header.services.shutdownDev": "Detener Mage",  "header.actions.openPlanAria": "Abrir plan",
  ...
  "aboutDialog.mageAppVersionLabel": "Versión de Mage {version}",  "aboutDialog.mageCliVersionLabel": "Versión de Mage {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Mage, el estado de Mage, directorios y proyectos.",  "aboutDialog.footerNote": "Hecho con amor para la comunidad",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Mage de manera eficiente",  "helpDialog.section.navigationCommands": "Navegación y comandos",
  ...
  "header.actions.openAppMenu": "Menú de Mage",  "header.actions.openAppMenuAria": "Abrir menú de Mage",  "header.actions.openSessionsWithShortcut": "Abrir sesiones ({shortcut})",
  ...
  "session.gitlabIssuePicker.error.noActiveProject": "No hay ningún proyecto activo",
  "session.gitlabIssuePicker.error.runtimeUnavailable": "API de runtime de GitLab no disponible",
  "session.gitlabIssuePicker.error.notConnected": "GitLab no está conectado",
  "session.gitlabIssuePicker.error.repoNotResolvable": "No se pudo resolver el repositorio",
  "session.gitlabIssuePicker.error.repoMustBeGitLab": "El remoto origin debe ser una URL de GitLab",
  "session.gitlabIssuePicker.error.issueNotFound": "No se encontró el issue",
  "session.gitlabIssuePicker.error.noModelSelected": "No hay ningún modelo seleccionado",
  "session.gitlabIssuePicker.toast.loadMoreFailed": "No se pudo cargar más issues",
  "session.gitlabIssuePicker.toast.loadIssueDetailsFailed": "No se pudieron cargar los detalles del issue",
  "session.gitlabIssuePicker.toast.sendContextFailed": "No se pudo enviar el contexto del issue",
  "session.gitlabIssuePicker.toast.sessionCreated": "Sesión creada desde el issue",
  "session.gitlabIssuePicker.toast.startSessionFailed": "No se pudo iniciar la sesión",
  "session.gitlabIssuePicker.title.select": "Vincular issue de GitLab",
  "session.gitlabIssuePicker.title.createSession": "Nueva sesión desde issue de GitLab",
  "session.gitlabIssuePicker.description.select": "Selecciona un issue para vincularlo a esta sesión.",
  "session.gitlabIssuePicker.description.createSession": "Inicia una nueva sesión con contexto oculto del issue (título/cuerpo/etiquetas/comentarios).",
  "session.gitlabIssuePicker.searchPlaceholder": "Buscar usando la sintaxis de búsqueda de código de GitLab",
  "session.gitlabIssuePicker.empty.noActiveProject": "No hay ningún proyecto activo seleccionado.",
  "session.gitlabIssuePicker.empty.runtimeUnavailable": "API de runtime de GitLab no disponible.",
  "session.gitlabIssuePicker.empty.notConnected": "GitLab no está conectado. Conecta tu cuenta de GitLab en configuración.",
  "session.gitlabIssuePicker.empty.noIssuesFound": "No se encontraron issues",
  "session.gitlabIssuePicker.empty.noOpenIssuesFound": "No se encontraron issues abiertos",
  "session.gitlabIssuePicker.loading.issues": "Cargando issues...",
  "session.gitlabIssuePicker.loading.more": "Cargando...",
  "session.gitlabIssuePicker.actions.openSettings": "Abrir configuración",
  "session.gitlabIssuePicker.actions.useIssue": "Usar issue #{number}",
  "session.gitlabIssuePicker.actions.openInGitLabAria": "Abrir en GitLab",
  "session.gitlabIssuePicker.actions.loadMore": "Cargar más",
  "session.gitlabIssuePicker.actions.sectionTitle": "Acciones",
  "session.gitlabIssuePicker.actions.toggleWorktreeAria": "Activar worktree",
  "session.gitlabIssuePicker.actions.createInWorktree": "Crear en worktree",
  "session.gitlabIssuePicker.actions.openRepo": "Abrir repositorio",
  "session.gitlabIssuePicker.actions.refresh": "Actualizar",
  "session.gitlabMrPicker.error.noActiveProject": "No hay ningún proyecto activo",
  "session.gitlabMrPicker.error.runtimeUnavailable": "API de runtime de GitLab no disponible",
  "session.gitlabMrPicker.error.notConnected": "GitLab no está conectado",
  "session.gitlabMrPicker.error.prNotFound": "No se encontró la MR",
  "session.gitlabMrPicker.error.repoNotResolvable": "No se pudo resolver el repositorio",
  "session.gitlabMrPicker.error.repoMustBeGitLab": "El remoto origin debe ser una URL de GitLab",
  "session.gitlabMrPicker.toast.loadMoreFailed": "No se pudieron cargar más MR",
  "session.gitlabMrPicker.toast.loadDetailsFailed": "No se pudieron cargar los detalles de la MR",
  "session.gitlabMrPicker.title": "Vincular MR de GitLab",
  "session.gitlabMrPicker.description": "Selecciona una MR para adjuntar contexto de revisión a este mensaje.",
  "session.gitlabMrPicker.searchPlaceholder": "Buscar usando la sintaxis de búsqueda de código de GitLab",
  "session.gitlabMrPicker.includeDiffAria": "Incluir diff de la MR en el contexto adjunto",
  "session.gitlabMrPicker.includeDiff": "Incluir diff de la MR",
  "session.gitlabMrPicker.empty.noActiveProject": "No hay ningún proyecto activo seleccionado.",
  "session.gitlabMrPicker.empty.runtimeUnavailable": "API de runtime de GitLab no disponible.",
  "session.gitlabMrPicker.empty.notConnected": "GitLab no está conectado. Conecta tu cuenta de GitLab en configuración.",
  "session.gitlabMrPicker.empty.noPullRequestsFound": "No se encontraron MR",
  "session.gitlabMrPicker.empty.noOpenPullRequestsFound": "No se encontraron MR abiertas",
  "session.gitlabMrPicker.loading.pullRequests": "Cargando MR...",
  "session.gitlabMrPicker.loading.more": "Cargando...",
  "session.gitlabMrPicker.actions.openSettings": "Abrir configuración",
  "session.gitlabMrPicker.actions.usePullRequest": "Usar MR #{number}",
  "session.gitlabMrPicker.actions.openInGitLabAria": "Abrir en GitLab",
  "session.gitlabMrPicker.actions.loadMore": "Cargar más",
  ...
  "session.newWorktree.actions.startFromGitLabIssuePr": "Iniciar desde Issue/MR de GitLab",
  "session.newWorktree.usingPrBranch": "Usando rama de la MR: {branch}",
  ...
  "session.newWorktree.error.sendGitLabContextFailed": "No se pudo enviar el contexto de GitLab",
  ...
  "session.newWorktree.toast.sessionFromPr": "Sesión creada desde MR",
  ...
  "session.gitlabIntegration.title": "Seleccionar desde GitLab",
  ...
  "session.gitlabIntegration.connect.description": "Vincula issues o MR para rellenar automáticamente los detalles del worktree",
  "session.gitlabIntegration.connect.action": "Conectar a GitLab",
  "session.gitlabIntegration.search.issuesPlaceholder": "Buscar usando la sintaxis de búsqueda de código de GitLab",
  "session.gitlabIntegration.search.prsPlaceholder": "Buscar usando la sintaxis de búsqueda de código de GitLab",
  "session.gitlabIntegration.empty.noIssuesFound": "No se encontraron issues",
  "session.gitlabIntegration.empty.noPullRequestsFound": "No se encontraron MR",
  "session.gitlabIntegration.actions.loadMore": "Cargar más",
  "session.gitlabIntegration.actions.cancel": "Cancelar",
  "session.gitlabIntegration.actions.select": "Seleccionar",
  "session.gitlabIntegration.selected.issueNumber": "Issue #{number}",
  "session.gitlabIntegration.selected.prNumber": "MR #{number}",
  "session.gitlabIntegration.includeDiffAria": "Incluir diff del MR en el contexto de la sesión",
  "session.gitlabIntegration.includeDiff": "Incluir diff del MR",
  "session.gitlabIntegration.error.notConnected": "GitLab no está conectado",
  "session.gitlabIntegration.error.loadDataFailed": "No se pudieron cargar los datos",
  "session.gitlabIntegration.validation.branchAlreadyCheckedOut": "La rama ya está en uso en un worktree",
  "session.gitlabIntegration.validation.branchAlreadyExists": "La rama ya existe localmente",
  "session.gitlabIntegration.validation.failed": "No se pudo validar",
  ...
  "chat.emptyState.mageUnreachable": "Mage no es accesible",
  ...
  "chat.generatedResult.pullRequest.title": "merge request generado",
  ...
  "chat.chatInput.linked.pr.openInBrowserAria": "Abrir MR en el navegador",
  "chat.chatInput.linked.pr.removeAria": "Eliminar MR vinculada",
  ...
  "mageStatusDialog.title": "Estado de Mage",
  "mageStatusDialog.description": "Inspecciona el estado actual de Mage y diagnósticos.",
  "mageStatusDialog.actions.copy": "Copiar",
  "mageStatusDialog.empty.noData": "No hay datos.",
  "mageStatusDialog.toast.copiedTitle": "Copiado",
  "mageStatusDialog.toast.copiedDescription": "Estado copiado al portapapeles",
  "mageStatusDialog.toast.copyFailed": "No se pudo copiar el estado",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres Mage desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",  "sessionAuth.error.retry": "Volver a intentar",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Mage",  "sessionAuth.locked.tunnelDescription": "Abre este túnel usando el enlace de conexión única desde la aplicación de escritorio.",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Mage",  "desktopHostSwitcher.header.current": "Actual",
  ...
  "multiRun.window.description": "Ventana de Mage Multi-Run.",  "voice.status.idle": "Voz lista",
  ...
  "onboarding.chooser.title": "Bienvenido a Mage",  "onboarding.chooser.description": "Elige cómo quieres conectar para comenzar.",
  "onboarding.chooser.tabs.localInstall": "Instalación local",
  "onboarding.chooser.tabs.connectRemote": "Conectar remoto",
  "onboarding.localSetup.title": "Configuración de Mage",
  "onboarding.localSetup.description": "Instala la CLI de Mage para continuar.",
  "onboarding.localSetup.dialog.selectMageBinary": "Seleccionar ejecutable de mage",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de Mage aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepInstallWsl": "Instala Mage con el comando siguiente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Mage no detecta Mage automáticamente, establece la ruta del ejecutable a continuación.",  "onboarding.localSetup.intro": "Mage es el corazón de Mage. Instálalo para empezar.",  "onboarding.localSetup.docs.windows": "Documentación de Mage",
  "onboarding.localSetup.docs.default": "Documentación de Mage",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de Mage está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando Mage",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de Mage:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Mage y recarga la configuración de Mage.",  "onboarding.localSetup.remotePreference": "¿Prefieres usar un servidor remoto?",
  "onboarding.localSetup.actions.connectRemoteServer": "Conectar a un servidor remoto →",
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta Mage de forma nativa.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Si la detección falla, establece una ruta nativa como mage.cmd u mage.exe.",
  "onboarding.localSetup.hint.ensurePath": "¿Ya está instalado? Asegúrate de que mage esté en tu PATH.",
  "onboarding.localSetup.hint.setEnv": "O establece la variable de entorno MAGE_BINARY.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Mage para conectar.",  "onboarding.remoteConnection.field.serverAddress": "Dirección del servidor",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Mage o contacta al administrador del servidor.",  "onboarding.remoteConnection.actions.testing": "Probando…",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Mage. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Mage pero no es compatible con esta versión de la app. Actualiza Mage en el servidor y vuelve a intentarlo.",  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Mage. Verifica que la dirección apunte a un servidor Mage.",  "onboarding.remoteConnection.probe.unreachableMessage": "El servidor no está disponible. Revisa tu conexión de red y verifica la dirección del servidor.",
  "onboarding.desktopRecovery.localUnavailable.title": "Mage Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de Mage no pudo iniciarse o no está instalado. Instala Mage o conecta a un servidor remoto en su lugar.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando Mage. Verifica que la dirección apunte a un servidor Mage.",  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor Mage en \"{host}\" no es compatible con esta versión de la app. Actualiza Mage en el servidor y vuelve a intentarlo.",  "onboarding.desktopRecovery.common.useLocal": "Usar Local",
  ...
  "startup.initRecovery.description": "Mage no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",  "startup.initRecovery.retry": "Reintentar",
  ...
  "updateDialog.header.updating": "Actualizando Mage...",  "updateDialog.changelog.title": "¿Qué hay de nuevo",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: mage update",
  "mobileUpdate.toast.available.title": "Actualización de Mage disponible",  "mobileUpdate.toast.available.description": "La versión {version} está lista para Android.",
  "mobileUpdate.toast.actions.download": "Descargar",
  "mobileUpdate.toast.actions.dismiss": "Descartar",
  "mageUpdate.toast.available.title": "Actualización de Mage",
  "mageUpdate.toast.available.description": "Versión {version} disponible.",
  "mageUpdate.toast.actions.update": "Actualizar",
  "mageUpdate.toast.actions.dismiss": "Descartar",
  "mageUpdate.toast.actions.reload": "Recargar Mage",
  "mageUpdate.toast.upgrading.title": "Actualizando Mage...",
  "mageUpdate.toast.upgrading.description": "Mantén Mage abierto.",  "mageUpdate.toast.updated.title": "Mage actualizado",
  "mageUpdate.toast.updated.description": "Actualización instalada.",
  "mageUpdate.toast.updated.descriptionWithVersion": "Versión {version} instalada.",
  "mageUpdate.toast.failed.title": "No se pudo actualizar Mage",
  "mageUpdate.toast.failed.description": "La actualización de Mage falló.",
  ...
  "memoryDebugPanel.metric.gitlabTotalRequests": "Solicitudes totales de GitLab",
  ...
  "mageLogo.aria.logo": "Logo de Mage",  "markdownRenderer.code.actions.copyTitle": "Copiar código",
