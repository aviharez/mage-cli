...
export const dict: Record<I18nKey, string> = {
  ...
  'shareOpinion.toast.title': '協助塑造 Mage',
  ...
  'mobile.connect.welcome.title': '連線至 Mage',
  ...
  'mobile.connect.password.placeholder': 'Mage 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Mage 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 Mage Relay 連線',
  'mobile.connect.error.urlRequired': '請輸入伺服器網址。',
  'mobile.connect.error.invalidUrl': '該伺服器網址無效。',
  'mobile.connect.error.unreachable': '無法連線至該 Mage 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Mage。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Mage，但與此應用程式版本不相容。請更新伺服器上的 Mage 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Mage 伺服器與此應用程式版本不相容。請更新伺服器上的 Mage 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutMage': '關於 Mage',
  ...
  'gitView.pr.actions.cancelEditingAria': '取消 MR 編輯',
  'gitView.pr.actions.createPr': '建立 MR',
  'gitView.pr.actions.edit': '編輯',
  'gitView.pr.actions.editPr': '編輯 MR',
  'gitView.pr.actions.editPrAria': '編輯 merge request',
  'gitView.pr.actions.hide': '隱藏',
  'gitView.pr.actions.markReady': '標記為可審查',
  'gitView.pr.actions.markReadyAria': '將 merge request 標記為可審查',
  'gitView.pr.actions.mergePr': '合併 MR',
  'gitView.pr.actions.mergePrAria': '合併 merge request',
  'gitView.pr.actions.openChecks': '開啟檢查',
  'gitView.pr.actions.openChecksAria': '開啟失敗的檢查',
  'gitView.pr.actions.openComments': '開啟留言',
  'gitView.pr.actions.openCommentsAria': '開啟 merge request 留言',
  'gitView.pr.actions.openOnGitLab': '在 GitLab 中開啟',
  'gitView.pr.actions.openOnGitLabAria': '在 GitLab 中開啟 merge request',
  ...
  'gitView.pr.actions.savePr': '儲存 MR',
  'gitView.pr.actions.savePrAria': '儲存 merge request 變更',
  ...
  'gitView.pr.actions.shareCommentsAria': '將 merge request 留言傳送給 Agent',
  'gitView.pr.actions.toggleDraftAria': '切換草稿狀態',
  'gitView.pr.actions.refresh': '重新整理 MR 狀態',
  'gitView.pr.actions.refreshAria': '重新整理 merge request 狀態',
  ...
  'gitView.pr.checkingStatus': '正在檢查 merge request 狀態...',
  ...
  'gitView.pr.createTitle': '建立 merge request',
  'gitView.pr.draftMustBeReady': '草稿 MR 必須先標記為可審查才能合併。',
  'gitView.pr.field.baseBranch': '基底分支',
  'gitView.pr.field.description': '描述',
  'gitView.pr.field.draft': '草稿',
  'gitView.pr.field.title': '標題',
  'gitView.pr.gitlabNotConnected': 'GitLab 未連線',
  ...
  'gitView.pr.noMergePermission': '你沒有權限合併此 merge request。',
  ...
  'gitView.pr.placeholder.main': '總結你的 merge request',
  'gitView.pr.placeholder.selectBaseBranch': '選擇基底分支',
  'gitView.pr.placeholder.title': 'merge request 標題',
  'gitView.pr.placeholder.whatChanged': '改了什麼，為什麼改？',
  'gitView.pr.statusUnavailable': 'merge request 狀態無法使用',
  'gitView.pr.toast.baseBranchRequired': '請選擇基底分支',
  'gitView.pr.toast.baseMustDifferFromHead': '基底分支必須與目前分支不同',
  'gitView.pr.toast.createPrFailed': '建立 merge request 失敗',
  'gitView.pr.toast.generateDescriptionFailed': '生成 merge request 描述失敗',
  'gitView.pr.toast.gitlabApiUnavailable': 'GitLab API 無法使用',
  'gitView.pr.toast.loadCheckDetailsFailed': '載入檢查詳情失敗',
  'gitView.pr.toast.loadChecksFailed': '載入 merge request 檢查失敗',
  'gitView.pr.toast.loadCommentsFailed': '載入留言失敗',
  'gitView.pr.toast.loadPrCommentsFailed': '載入 merge request 留言失敗',
  'gitView.pr.toast.markReadyFailed': '標記 merge request 可審查失敗',
  'gitView.pr.toast.markedReady': 'merge request 已標記為可審查',
  'gitView.pr.toast.mergeFailed': '合併 merge request 失敗',
  ...
  'gitView.pr.toast.noPrComments': '找不到 merge request 留言',
  'gitView.pr.toast.mrCreated': 'merge request 已建立',
  'gitView.pr.toast.mrMerged': 'merge request 已合併',
  'gitView.pr.toast.prNotMerged': 'merge request 未合併',
  'gitView.pr.toast.mrUpdated': 'merge request 已更新',
  'gitView.pr.toast.sendMessageFailed': '向 Agent 傳送訊息失敗',
  'gitView.pr.toast.titleRequired': '標題不能為空',
  'gitView.pr.toast.updatePrFailed': '更新 merge request 失敗',
  'gitView.pullRequest.createHint': '從目前分支建立並管理 merge request。',
  'gitView.pullRequest.availableOnFeatureBranches': '目前分支可以開啟 MR 時可用。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Mage 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'header.gitlab.connected': 'GitLab 已連線',
  'header.gitlab.avatarWithLogin': '{login} 頭像',
  'header.gitlab.avatar': 'GitLab 頭像',
  'header.gitlab.accountsTitle': 'GitLab 帳戶',
  ...
  'header.services.shutdownDev': '停止 Mage',
  ...
  'aboutDialog.mageAppVersionLabel': 'Mage 版本 {version}',
  'aboutDialog.mageCliVersionLabel': 'Mage 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Mage 狀態、Mage 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Mage',
  ...
  'header.actions.openAppMenu': 'Mage 選單',
  'header.actions.openAppMenuAria': '開啟 Mage 選單',
  ...
  'session.gitlabIssuePicker.error.noActiveProject': '沒有活動專案',
  'session.gitlabIssuePicker.error.runtimeUnavailable': 'GitLab 執行時 API 無法使用',
  'session.gitlabIssuePicker.error.notConnected': 'GitLab 未連線',
  'session.gitlabIssuePicker.error.repoNotResolvable': '無法解析儲存庫',
  'session.gitlabIssuePicker.error.repoMustBeGitLab': 'origin 遠端儲存庫必須是 GitLab URL',
  'session.gitlabIssuePicker.error.issueNotFound': '找不到 Issue',
  'session.gitlabIssuePicker.error.noModelSelected': '未選擇模型',
  'session.gitlabIssuePicker.toast.loadMoreFailed': '載入更多 Issue 失敗',
  'session.gitlabIssuePicker.toast.loadIssueDetailsFailed': '載入 Issue 詳情失敗',
  'session.gitlabIssuePicker.toast.sendContextFailed': '傳送 Issue 上下文失敗',
  'session.gitlabIssuePicker.toast.sessionCreated': '已從 Issue 建立會話',
  'session.gitlabIssuePicker.toast.startSessionFailed': '啟動會話失敗',
  'session.gitlabIssuePicker.title.select': '關聯 GitLab Issue',
  'session.gitlabIssuePicker.title.createSession': '從 GitLab Issue 新增會話',
  'session.gitlabIssuePicker.description.select': '選擇一個 Issue 關聯到目前會話。',
  'session.gitlabIssuePicker.description.createSession': '使用隱藏的 Issue 上下文（標題/內文/標籤/留言）初始化新會話。',
  'session.gitlabIssuePicker.searchPlaceholder': '按標題或 #123 搜尋，或貼上 Issue URL',
  'session.gitlabIssuePicker.empty.noActiveProject': '未選擇活動專案。',
  'session.gitlabIssuePicker.empty.runtimeUnavailable': 'GitLab 執行時 API 無法使用。',
  'session.gitlabIssuePicker.empty.notConnected': 'GitLab 未連線。請在設定中連接 GitLab 帳號。',
  'session.gitlabIssuePicker.empty.noIssuesFound': '找不到 Issue',
  'session.gitlabIssuePicker.empty.noOpenIssuesFound': '沒有未關閉的 Issue',
  'session.gitlabIssuePicker.loading.issues': '正在載入 Issue...',
  'session.gitlabIssuePicker.loading.more': '載入中...',
  'session.gitlabIssuePicker.actions.openSettings': '開啟設定',
  'session.gitlabIssuePicker.actions.useIssue': '使用 Issue #{number}',
  'session.gitlabIssuePicker.actions.openInGitLabAria': '在 GitLab 中開啟',
  'session.gitlabIssuePicker.actions.loadMore': '載入更多',
  'session.gitlabIssuePicker.actions.sectionTitle': '操作',
  'session.gitlabIssuePicker.actions.toggleWorktreeAria': '切換 worktree',
  'session.gitlabIssuePicker.actions.createInWorktree': '在 worktree 中建立',
  'session.gitlabIssuePicker.actions.openRepo': '開啟儲存庫',
  'session.gitlabIssuePicker.actions.refresh': '重新整理',
  'session.gitlabMrPicker.error.noActiveProject': '沒有活動專案',
  'session.gitlabMrPicker.error.runtimeUnavailable': 'GitLab 執行時 API 無法使用',
  'session.gitlabMrPicker.error.notConnected': 'GitLab 未連線',
  'session.gitlabMrPicker.error.prNotFound': '找不到 merge request',
  'session.gitlabMrPicker.error.repoNotResolvable': '無法解析儲存庫',
  'session.gitlabMrPicker.error.repoMustBeGitLab': 'origin 遠端儲存庫必須是 GitLab URL',
  'session.gitlabMrPicker.toast.loadMoreFailed': '載入更多 merge request 失敗',
  'session.gitlabMrPicker.toast.loadDetailsFailed': '載入 merge request 詳情失敗',
  'session.gitlabMrPicker.title': '關聯 GitLab merge request',
  'session.gitlabMrPicker.description': '選擇一個 merge request，將審查上下文附加到此訊息。',
  'session.gitlabMrPicker.searchPlaceholder': '按標題或 #123 搜尋，或貼上 merge request URL',
  'session.gitlabMrPicker.includeDiffAria': '在附加上下文中包含 MR diff',
  'session.gitlabMrPicker.includeDiff': '包含 MR diff',
  'session.gitlabMrPicker.empty.noActiveProject': '未選擇活動專案。',
  'session.gitlabMrPicker.empty.runtimeUnavailable': 'GitLab 執行時 API 無法使用。',
  'session.gitlabMrPicker.empty.notConnected': 'GitLab 未連線。請在設定中連接 GitLab 帳號。',
  'session.gitlabMrPicker.empty.noPullRequestsFound': '找不到 merge request',
  'session.gitlabMrPicker.empty.noOpenPullRequestsFound': '沒有未關閉的 merge request',
  'session.gitlabMrPicker.loading.pullRequests': '正在載入 merge request...',
  'session.gitlabMrPicker.loading.more': '載入中...',
  'session.gitlabMrPicker.actions.openSettings': '開啟設定',
  'session.gitlabMrPicker.actions.usePullRequest': '使用 merge request #{number}',
  'session.gitlabMrPicker.actions.openInGitLabAria': '在 GitLab 中開啟',
  'session.gitlabMrPicker.actions.loadMore': '載入更多',
  ...
  'session.newWorktree.actions.startFromGitLabIssuePr': '從 GitLab Issue/MR 開始',
  'session.newWorktree.usingPrBranch': '使用 MR 分支：{branch}',
  ...
  'session.gitlabIntegration.title': '從 GitLab 選擇',
  'session.gitlabIntegration.tabs.issues': 'Issues',
  'session.gitlabIntegration.tabs.pullRequests': 'merge requests',
  'session.gitlabIntegration.connect.title': '連接到 GitLab',
  'session.gitlabIntegration.connect.description': '關聯 Issue 或 merge request 以自動填入 worktree 詳情',
  'session.gitlabIntegration.connect.action': '連接 GitLab',
  'session.gitlabIntegration.search.issuesPlaceholder': '搜尋 Issue 或輸入 #123...',
  'session.gitlabIntegration.search.prsPlaceholder': '搜尋 MR 或輸入 #456...',
  'session.gitlabIntegration.empty.noIssuesFound': '找不到 Issue',
  'session.gitlabIntegration.empty.noPullRequestsFound': '找不到 merge request',
  'session.gitlabIntegration.actions.loadMore': '載入更多',
  'session.gitlabIntegration.actions.cancel': '取消',
  'session.gitlabIntegration.actions.select': '選擇',
  'session.gitlabIntegration.selected.issueNumber': 'Issue #{number}',
  'session.gitlabIntegration.selected.prNumber': 'MR #{number}',
  'session.gitlabIntegration.includeDiffAria': '在會話上下文中包含 MR diff',
  'session.gitlabIntegration.includeDiff': '包含 MR diff',
  'session.gitlabIntegration.error.notConnected': 'GitLab 未連線',
  'session.gitlabIntegration.error.loadDataFailed': '載入資料失敗',
  'session.gitlabIntegration.validation.branchAlreadyCheckedOut': '該分支已在某個 worktree 中簽出',
  'session.gitlabIntegration.validation.branchAlreadyExists': '該分支已在本地存在',
  'session.gitlabIntegration.validation.failed': '驗證失敗',
  ...
  'chat.emptyState.mageUnreachable': '無法連線 Mage',
  ...
  'chat.generatedResult.pullRequest.title': '生成的 merge request',
  ...
  'chat.chatInput.actions.linkGitlabIssue': '關聯 GitLab Issue',
  'chat.chatInput.actions.linkGitlabMr': '關聯 GitLab MR',
  ...
  'chat.chatInput.linked.pr.openInBrowserAria': '在瀏覽器中開啟 merge request',
  'chat.chatInput.linked.pr.removeAria': '移除已關聯的 merge request',
  ...
  'mageStatusDialog.title': 'Mage 狀態',
  'mageStatusDialog.description': '查看目前 Mage 狀態與診斷資訊。',
  'mageStatusDialog.actions.copy': '複製',
  'mageStatusDialog.empty.noData': '無資料。',
  'mageStatusDialog.toast.copiedTitle': '已複製',
  'mageStatusDialog.toast.copiedDescription': '狀態已複製到剪貼簿',
  'mageStatusDialog.toast.copyFailed': '複製狀態失敗',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 Mage，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Mage',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Mage 伺服器之間切換',
  ...
  'multiRun.window.description': 'Mage 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Mage',
  ...
  'onboarding.localSetup.title': '設定 Mage',
  'onboarding.localSetup.description': '安裝 Mage CLI 以繼續。',
  'onboarding.localSetup.dialog.selectMageBinary': '選擇 Mage 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'Mage CLI 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 Mage。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Mage 未自動偵測到 Mage，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'Mage 是 Mage 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'Mage 文件',
  'onboarding.localSetup.docs.default': 'Mage 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 Mage CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 Mage',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 Mage CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Mage 設定並重新載入 Mage 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 Mage。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若偵測失敗，請設定原生路徑，例如 mage.cmd 或 mage.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安裝？請確認 mage 在你的 PATH 中。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Mage 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Mage 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Mage。請確認位址是否指向 Mage 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 Mage 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'Mage CLI 無法啟動或未安裝。請安裝 Mage，或改為連接遠端伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Mage。請確認位址是否指向 Mage 伺服器。',
  ...
  'startup.initRecovery.description': 'Mage 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 Mage...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：mage update',
  'mobileUpdate.toast.available.title': 'Mage 更新可用',
  ...
  'mageUpdate.toast.available.title': 'Mage 更新',
  'mageUpdate.toast.available.description': '版本 {version} 可安裝。',
  'mageUpdate.toast.actions.update': '更新',
  'mageUpdate.toast.actions.dismiss': '忽略',
  'mageUpdate.toast.actions.reload': '重新載入 Mage',
  'mageUpdate.toast.upgrading.title': '正在更新 Mage...',
  'mageUpdate.toast.upgrading.description': '請保持 Mage 開啟。',
  'mageUpdate.toast.updated.title': 'Mage 已更新',
  'mageUpdate.toast.updated.description': '更新已安裝。',
  'mageUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安裝。',
  'mageUpdate.toast.failed.title': '無法更新 Mage',
  'mageUpdate.toast.failed.description': 'Mage 升級失敗。',
  'mageUpdate.toast.reload.message': '正在重新啟動 Mage...',
  ...
  'memoryDebugPanel.metric.gitlabTotalRequests': 'GitLab 請求總數',
