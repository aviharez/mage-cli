...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 Mage',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Mage 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Mage 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 Mage 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Mage 設定並重新載入 OpenCode 設定。',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 Mage 開啟。',
  ...
  'openChamberLogo.aria.logo': 'Mage 標誌',
