export const settingsDict = {
  ...
  'settings.mage.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.mage/data/cloudflare-managed-remote-tunnels.json.',
  ...
  'settings.mage.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.mage/themes/',
