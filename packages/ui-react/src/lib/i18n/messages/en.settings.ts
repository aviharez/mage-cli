export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. Mage never scans browser cookie storage.',
  ...
  'settings.openchamber.about.title': 'About Mage',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start Mage at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start Mage when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close Mage to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps Mage running in the Windows system tray when the main window is minimized or closed.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while Mage is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while Mage is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Mage asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing Mage',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating Mage',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Mage.',
