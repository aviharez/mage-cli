export const settingsDict = {
  'settings.providers.page.mageGo.title': 'Mage Go usage tracking',
  'settings.providers.page.mageGo.description': 'Connect the Mage Go dashboard to show rolling, weekly, and monthly quota.',
  'settings.providers.page.mageGo.workspaceId': 'Workspace ID',
  'settings.providers.page.mageGo.authCookie': 'Auth cookie',
  'settings.providers.page.mageGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. Mage never scans browser cookie storage.',
  'settings.providers.page.mageGo.save': 'Save and validate',
  'settings.providers.page.mageGo.replace': 'Replace',
  'settings.providers.page.mageGo.validate': 'Validate',
  'settings.providers.page.mageGo.delete': 'Delete',
  'settings.providers.page.mageGo.saved': 'Mage Go credentials saved.',
  'settings.providers.page.mageGo.saveFailed': 'Could not validate Mage Go credentials.',
  'settings.providers.page.mageGo.valid': 'Mage Go credentials are valid.',
  'settings.providers.page.mageGo.invalid': 'Mage Go credentials are invalid or expired.',
  'settings.providers.page.mageGo.deleted': 'Mage Go credentials deleted.',
  'settings.providers.page.mageGo.deleteFailed': 'Could not delete Mage Go credentials.',
  ...
  'settings.window.description': 'Mage settings window.',
  ...
  'settings.view.actions.reloadMage': 'Reload Mage',
  'settings.view.actions.reloadMageTooltip': 'Restart Mage and reload its configuration.',
  ...
  'settings.snippets.page.hint': 'Use #name in prompts. Supports aliases and prepend/append blocks compatible with mage-snippets.',
  ...
  'settings.mage.tunnel.title': 'Remote Tunnel',
  'settings.mage.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.mage.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.mage.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.mage.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.mage.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.mage.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.mage.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.mage.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.mage.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.mage.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.mage.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.mage.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.mage.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.mage.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.mage.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.mage.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.mage.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.mage.tunnel.field.provider': 'Provider',
  'settings.mage.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.mage.tunnel.field.tunnelType': 'Tunnel type',
  'settings.mage.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.mage.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.mage.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.mage.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.mage.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.mage.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.mage.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.mage.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.mage.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.mage.tunnel.field.configurationFile': 'Configuration file',
  'settings.mage.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.mage.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.mage.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.mage.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.mage.tunnel.field.connectLink': 'Connect link',
  'settings.mage.tunnel.field.expires': 'Expires',
  'settings.mage.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.mage.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.mage.tunnel.actions.saveToken': 'Save token',
  'settings.mage.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.mage.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.mage.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.mage.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.mage.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.mage.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.mage.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.mage.tunnel.actions.stopping': 'Stopping...',
  'settings.mage.tunnel.actions.newConnectLink': 'New connect link',
  'settings.mage.tunnel.actions.copied': 'Copied',
  'settings.mage.tunnel.actions.retry': 'Retry',
  'settings.mage.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.mage.tunnel.option.mode.quick.label': 'Quick',
  'settings.mage.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.mage.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.mage.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.mage.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.mage.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.mage.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.mage.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  'settings.mage.tunnel.badge.quick': 'QUICK',
  'settings.mage.tunnel.badge.remote': 'REMOTE',
  'settings.mage.tunnel.badge.local': 'LOCAL',
  'settings.mage.tunnel.state.loading': 'Loading',
  'settings.mage.tunnel.state.expired': 'Expired',
  'settings.mage.tunnel.state.revoked': 'Revoked',
  'settings.mage.tunnel.state.inactive': 'Inactive',
  'settings.mage.tunnel.state.noExpiry': 'No expiry',
  'settings.mage.tunnel.state.never': 'Never',
  'settings.mage.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.mage.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.mage.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.mage.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.mage.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.mage.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/mage/cloudflare-managed-remote-tunnels.json.',
  'settings.mage.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.mage.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.mage.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.mage.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.mage.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.mage.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.mage.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.mage.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.mage.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.mage.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.mage.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.mage.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.mage.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.mage.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.mage.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.mage.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.mage.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.mage.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.mage.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.mage.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.mage.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.mage.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.mage.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.mage.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.mage.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.mage.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.magicPrompts.sidebar.item.gitPrGenerate': 'MR Generation',
  ...
  'settings.magicPrompts.sidebar.item.gitlabMrReview': 'MR Review',
  'settings.magicPrompts.sidebar.item.gitlabIssueReview': 'Issue Review',
  'settings.magicPrompts.sidebar.item.gitlabMrFailedChecksReview': 'MR Failed Checks Review',
  'settings.magicPrompts.sidebar.item.gitlabMrCommentsReview': 'MR Comments Review',
  'settings.magicPrompts.sidebar.item.gitlabSingleMrCommentReview': 'Single MR Comment Review',
  ...
  'settings.remoteInstances.direct.title': 'Other Mage servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another Mage server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Mage server.',
  'settings.remoteInstances.direct.import.placeholder': 'mage://connect?...',
  'settings.remoteInstances.direct.import.action': 'Import Link',
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Mage connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Mage Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Mage connection QR code',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Enlarge QR code',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the Mage app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through Mage Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the Mage app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Mage should start the server for you, or connect to one that is already running.',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': 'Keep Mage running on the remote machine after you disconnect.',
  ...
  'settings.mage.about.title': 'About Mage',
  'settings.mage.about.field.version': 'Version',
  'settings.mage.about.field.mageCliVersion': 'Mage version',
  'settings.mage.about.state.checking': 'Checking...',
  'settings.mage.about.state.upToDate': 'Up to date',
  'settings.mage.about.state.unknown': 'unknown',
  'settings.mage.about.actions.checkUpdates': 'Check updates',
  'settings.mage.about.actions.update': 'Update',
  'settings.mage.about.actions.updateToVersion': 'Update to {version}',
  'settings.mage.about.actions.checkForUpdates': 'Check for updates',
  'settings.mage.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Saved to disk. Restart your connected Mage server to apply the changes.',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. Mage also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.gitIdentities.editor.field.emailAddressTooltip': 'Should match your email in GitLab/GitLab for proper attribution.',
  ...
  'settings.skills.location.option.userMage.label': 'User / Mage',
  'settings.skills.location.option.userMage.description': 'Global Mage config location',
  'settings.skills.location.option.projectMage.label': 'Project / Mage',
  'settings.skills.location.option.projectMage.description': 'Current project .mage location',
  ...
  'settings.skills.catalog.shared.field.repositoryPlaceholder': 'owner/repo or git@gitlab.com:owner/repo.git',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Mage will scan it for folders containing',
  ...
  'settings.skills.catalog.installFromRepo.repositoryHintPrefix': 'For GitLab shorthand, you can add a subpath like',
  ...
  'settings.mage.passkeys.title': 'Passkeys',
  'settings.mage.passkeys.field.currentDevice': 'Current device',
  'settings.mage.passkeys.actions.add': 'Add passkey',
  'settings.mage.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.mage.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.mage.passkeys.actions.signingOut': 'Signing out…',
  'settings.mage.passkeys.actions.removing': 'Removing…',
  'settings.mage.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.mage.passkeys.state.loading': 'Loading passkeys…',
  'settings.mage.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.mage.passkeys.item.lastUsed': 'Last used {time}',
  'settings.mage.passkeys.item.added': 'Added {time}',
  'settings.mage.passkeys.time.neverUsed': 'Never used',
  'settings.mage.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.mage.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.mage.passkeys.toast.added': 'Passkey added',
  'settings.mage.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.mage.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.mage.passkeys.toast.removed': 'Passkey removed',
  'settings.mage.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.mage.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.mage.sessionRetention.title': 'Session Retention',
  'settings.mage.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.mage.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.mage.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.mage.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.mage.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.mage.sessionRetention.field.days': 'days',
  'settings.mage.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.mage.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.mage.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.mage.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.mage.sessionRetention.action.archive': 'Archive',
  'settings.mage.sessionRetention.action.delete': 'Delete',
  'settings.mage.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.mage.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.mage.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.mage.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.mage.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.mage.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.mage.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.mage.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.mage.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.mage.desktopNetwork.title': 'Desktop Network Access',
  'settings.mage.desktopNetwork.field.launchAtLoginAria': 'Start Mage at login',
  'settings.mage.desktopNetwork.field.launchAtLogin': 'Start Mage when you log in',
  'settings.mage.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.mage.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close Mage to the system tray',
  'settings.mage.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.mage.desktopNetwork.field.minimizeToTrayDescription': 'Keeps Mage running in the Windows system tray when the main window is minimized or closed.',
  'settings.mage.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while Mage is running',
  'settings.mage.desktopNetwork.field.keepAwake': 'Keep computer awake while Mage is running',
  'settings.mage.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.mage.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.mage.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.mage.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.mage.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.mage.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.mage.desktopPassword.field.password': 'Desktop UI Password',
  'settings.mage.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.mage.desktopPassword.field.passwordDescription': 'Mage asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.mage.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.mage.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.mage.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.mage.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.mage.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.mage.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.mage.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.mage.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.mage.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.mage.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.mage.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.mage.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.mage.mageCli.title': 'Mage CLI',
  'settings.mage.mageCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.mage.mageCli.tooltipSuffix': 'binary.',
  'settings.mage.mageCli.field.binaryPath': 'Mage Binary Path',
  'settings.mage.mageCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/mage',
  'settings.mage.mageCli.field.showUpdateNotifications': 'Show Mage update notifications',
  'settings.mage.mageCli.field.showUpdateNotificationsAria': 'Show Mage update notifications',
  'settings.mage.mageCli.actions.browseAria': 'Browse for Mage binary path',
  'settings.mage.mageCli.actions.browse': 'Browse',
  'settings.mage.mageCli.actions.saveAndReload': 'Save + Reload',
  'settings.mage.mageCli.actions.restartingMage': 'Restarting Mage…',
  'settings.mage.mageCli.dialog.selectBinaryTitle': 'Select mage binary',
  'settings.mage.mageCli.tipPrefix': 'Tip: you can also use',
  'settings.mage.mageCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.plugins.toast.reloadFailed': 'mage reload failed — restart required',
  ...
  'settings.mage.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.mage.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.mage.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.mage.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.mage.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.mage.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.mage.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.mage.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.mage.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.mage.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.mage.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.mage.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.mage.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.mage.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.mage.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.mage.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.mage.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.mage.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.mage.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.mage.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.mage.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.mage.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.mage.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.mage.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.mage.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.mage.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.mage.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.mage.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.mage.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.mage.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.mage.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.mage.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.mage.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Mage there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Mage on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Mage should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote Mage server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Mage UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Mage should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingMage': 'Installing Mage',
  'settings.remoteInstances.page.phase.updatingMage': 'Updating Mage',
  ...
  'settings.mage.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.mage.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.mage.worktrees.setup.title': 'Setup commands',
  'settings.mage.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.mage.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.mage.worktrees.setup.loading': 'Loading...',
  'settings.mage.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.mage.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.mage.worktrees.setup.addCommand': 'Add command',
  'settings.mage.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.mage.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.mage.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.mage.worktrees.list.title': 'Existing worktrees',
  'settings.mage.worktrees.list.tooltip': 'Worktrees live outside the repo (Mage-managed). Deleting a worktree also removes linked sessions.',
  'settings.mage.worktrees.list.loading': 'Loading worktrees...',
  'settings.mage.worktrees.list.empty': 'No worktrees found for this project',
  'settings.mage.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.mage.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.sidebar.empty.description': 'Check your Mage configuration',
  ...
  'settings.providers.page.empty.checkMageConfiguration': 'Check your Mage configuration',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to Mage and never stored by Mage.',
  ...
  'settings.mcp.page.status.description.connected': 'Connected and ready for Mage to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'Mage could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForMage': 'Waiting for Mage to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use Mage\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let Mage infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.env.plainTextWarning': '⚠ Values are stored as plain text in mage.json',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'Mage will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but Mage reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but Mage reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. Mage reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. Mage reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but Mage reload failed',
  ...
  'settings.mcp.page.toast.mageReloadFailedAfterCallbackSave': 'Mage reload failed after saving the browser callback URL',
  ...
  'settings.mage.defaults.title': 'Session Defaults',
  'settings.mage.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.mage.defaults.summaryMageDefault': 'Mage agent default',
  'settings.mage.defaults.field.defaultModel': 'Default Model',
  'settings.mage.defaults.field.defaultThinking': 'Default Thinking',
  'settings.mage.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.mage.defaults.field.defaultAgent': 'Default Agent',
  'settings.mage.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.mage.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.mage.defaults.smallModel.title': 'Small Model',
  'settings.mage.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.mage.defaults.smallModel.useDefault': 'Use default small model',
  'settings.mage.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.mage.defaults.smallModel.overrideModel': 'Override model',
  'settings.mage.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.mage.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.mage.defaults.option.default': 'Default',
  'settings.mage.defaults.option.defaultLowercase': 'default',
  'settings.mage.git.title': 'Git Preferences',
  'settings.mage.git.changesViewTitle': 'Changes View',
  'settings.mage.git.changesViewAria': 'Git changes view mode',
  'settings.mage.git.option.flatList': 'Flat List',
  'settings.mage.git.option.treeView': 'Tree View',
  'settings.mage.git.optionAria': 'Git changes view mode: {option}',
  'settings.mage.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.mage.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.mage.git.showGitignoredAria': 'Display gitignored files',
  'settings.mage.git.showGitignored': 'Display Gitignored Files',
  'settings.gitlab.page.tooltip.connectAccount': 'Connect a GitLab account for in-app MR and issue workflows.',
  ...
  'settings.gitlab.page.label.scopes': 'Scopes: {value}',
  ...
  'settings.gitlab.page.actions.switchTo': 'Switch to',
  'settings.gitlab.page.actions.addAccount': 'Add Account',
  'settings.gitlab.page.actions.openGitlab': 'Open GitLab',
  'settings.gitlab.page.status.notConnected': 'Not Connected',
  'settings.gitlab.page.status.active': 'Active',
  'settings.gitlab.page.flow.title': 'Authorize Mage',
  'settings.gitlab.page.flow.description': 'In GitLab, enter the following code to authorize this device:',
  'settings.gitlab.page.flow.waiting': 'Waiting for approval… (auto-refresh)',
  'settings.gitlab.page.toast.startConnectFailed': 'Failed to start GitLab connect',
  'settings.gitlab.page.toast.connected': 'GitLab connected',
  'settings.gitlab.page.toast.authorizationFailed': 'GitLab authorization failed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Mage.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the Mage server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the Mage server (Kokoro, English). The model downloads automatically; no API key needed.',
  ...
  'settings.mage.visual.section.colorMode': 'Color Mode',
  'settings.mage.visual.section.mobileLayout': 'Mobile Layout',
  'settings.mage.visual.option.mobileLayout.default': 'Old',
  'settings.mage.visual.option.mobileLayout.new': 'New',
  'settings.mage.visual.section.localization': 'Localization',
  'settings.mage.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.mage.visual.section.navigation': 'Navigation',
  'settings.mage.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.mage.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.mage.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.mage.visual.section.activityDefault': 'Activity Default',
  'settings.mage.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.mage.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.mage.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.mage.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.mage.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.mage.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.mage.visual.section.diffLayout': 'Diff Layout',
  'settings.mage.visual.section.diffLayoutAria': 'Diff layout',
  'settings.mage.visual.section.privacy': 'Privacy',
  'settings.mage.visual.field.lightTheme': 'Light Theme',
  'settings.mage.visual.field.darkTheme': 'Dark Theme',
  'settings.mage.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.mage.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.mage.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.mage.visual.field.timeFormat': 'Time Format',
  'settings.mage.visual.field.weekStartsOn': 'Week Starts On',
  'settings.mage.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.mage.visual.field.selectWeekStartAria': 'Select week start',
  'settings.mage.visual.actions.reloadThemes': 'Reload themes',
  'settings.mage.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.mage.visual.field.macVibrancy': 'Window transparency',
  'settings.mage.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
  'settings.mage.visual.field.dockBadge': 'Dock badge',
  'settings.mage.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.mage.visual.actions.saveAndRestart': 'Save & restart',
  'settings.mage.visual.actions.restarting': 'Restarting…',
  'settings.mage.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.mage.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/mage/themes/',
  'settings.mage.visual.field.installAppName': 'Install App Name',
  'settings.mage.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.mage.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.mage.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.mage.visual.field.installOrientation': 'Install Orientation',
  'settings.mage.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.mage.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.mage.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.mage.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.mage.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.mage.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.mage.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.mage.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.mage.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.mage.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.mage.visual.field.interfaceFont': 'Interface Font',
  'settings.mage.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.mage.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.mage.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.mage.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.mage.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.mage.visual.field.editorFontSize': 'Editor Font Size',
  'settings.mage.visual.field.codeFont': 'Code Font',
  'settings.mage.visual.field.selectCodeFontAria': 'Select code font',
  'settings.mage.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.mage.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.mage.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.mage.visual.field.spacingDensity': 'Spacing Density',
  'settings.mage.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.mage.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.mage.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.mage.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.mage.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.mage.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.mage.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.mage.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.mage.visual.option.fileEditorKeymap.default': 'Default',
  'settings.mage.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.mage.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.mage.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.mage.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.mage.visual.field.bash': 'Bash',
  'settings.mage.visual.field.editTools': 'Edit tools',
  'settings.mage.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.mage.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.mage.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.mage.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.mage.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.mage.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.mage.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.mage.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.mage.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.mage.visual.goal.sectionTitle': 'Goal',
  'settings.mage.visual.goal.budgetLabel': 'Default token budget',
  'settings.mage.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.mage.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.mage.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.mage.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.mage.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.mage.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.mage.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.mage.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.mage.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.mage.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.mage.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.mage.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.mage.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.mage.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.mage.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.mage.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.mage.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.mage.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.mage.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.mage.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.mage.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.mage.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.mage.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.mage.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.mage.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.mage.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.mage.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.mage.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.mage.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.mage.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.mage.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.mage.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.mage.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.mage.visual.option.themeMode.system': 'System',
  'settings.mage.visual.option.themeMode.light': 'Light',
  'settings.mage.visual.option.themeMode.dark': 'Dark',
  'settings.mage.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.mage.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.mage.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.mage.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.mage.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.mage.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.mage.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.mage.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.mage.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.mage.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.mage.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.mage.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.mage.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.mage.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.mage.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.mage.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.mage.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.mage.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.mage.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.mage.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.mage.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.mage.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.mage.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.mage.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.mage.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.mage.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.mage.visual.option.chatRenderMode.live.label': 'Live',
  'settings.mage.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.mage.visual.option.messageTransport.auto.label': 'Auto',
  'settings.mage.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.mage.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.mage.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.mage.visual.option.messageTransport.sse.label': 'SSE',
  'settings.mage.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.mage.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.mage.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.mage.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.mage.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.mage.visual.option.timeFormat.auto.label': 'Auto',
  'settings.mage.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.mage.visual.option.timeFormat.24h.label': '24-hour',
  'settings.mage.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.mage.visual.option.timeFormat.12h.label': '12-hour',
  'settings.mage.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.mage.visual.option.weekStart.auto.label': 'Auto',
  'settings.mage.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.mage.visual.option.weekStart.monday.label': 'Monday',
  'settings.mage.visual.option.weekStart.sunday.label': 'Sunday',
  ...
  'settings.magicPrompts.page.group.gitPrGenerate.title': 'MR Generation',
  ...
  'settings.magicPrompts.page.group.gitlabMrReview.title': 'MR Review',
  'settings.magicPrompts.page.group.gitlabMrReview.description': 'Prompts used for MR review flow: visible user message + hidden instruction payload.',
  'settings.magicPrompts.page.group.gitlabIssueReview.title': 'Issue Review',
  'settings.magicPrompts.page.group.gitlabIssueReview.description': 'Prompts used for issue review flow: visible user message + hidden instruction payload.',
  'settings.magicPrompts.page.group.gitlabMrFailedChecksReview.title': 'MR Failed Checks Review',
  'settings.magicPrompts.page.group.gitlabMrFailedChecksReview.description': 'Prompts used for MR failed checks analysis.',
  'settings.magicPrompts.page.group.gitlabMrCommentsReview.title': 'MR Comments Review',
  'settings.magicPrompts.page.group.gitlabMrCommentsReview.description': 'Prompts used for MR comments analysis.',
  'settings.magicPrompts.page.group.gitlabSingleMrCommentReview.title': 'Single MR Comment Review',
  'settings.magicPrompts.page.group.gitlabSingleMrCommentReview.description': 'Prompts used for single MR comment analysis.',
