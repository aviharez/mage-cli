...
export async function refreshSkillsAfterMageRestart(options?: { message?: string; delayMs?: number }) {
  try {
  ...
  try {
    await waitForMageConnection(options?.delayMs);
