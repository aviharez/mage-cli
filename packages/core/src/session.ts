...
import { ListAnchor } from "@mybcabisnis/mage-schema/session"
...
import { SessionDurable } from "@mybcabisnis/mage-schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@mage/v2/Session") {}
