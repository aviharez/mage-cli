...
import { Entry, FileSystem, FindInput, Match } from "@mybcabisnis/mage-schema/filesystem"
export { Entry, Match, Submatch } from "@mybcabisnis/mage-schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@mage/v2/FileSystem") {}
