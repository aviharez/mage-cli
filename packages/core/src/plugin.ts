...
import type { Plugin as PluginRuntime } from "@mybcabisnis/mage-plugin/v2/effect"
import { Plugin } from "@mybcabisnis/mage-schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@mage/v2/Plugin") {}
