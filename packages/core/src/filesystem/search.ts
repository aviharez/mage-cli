...
export class Service extends Context.Service<Service, Interface>()("@mage/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.MAGE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
