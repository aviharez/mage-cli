...
import type { EffectDrizzleSqlite } from "@mybcabisnis/mage-effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@mage/ProjectDirectories") {}
