...
import { Event } from "@mybcabisnis/mage-schema/project-directories"
import { ProjectCopy } from "@mybcabisnis/mage-schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@mage/ProjectCopy") {}
