...
import { Credential } from "@mybcabisnis/mage-schema/credential"
import { Integration } from "@mybcabisnis/mage-schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@mage/v2/Credential") {}
