      ...
      draft.source(
        SkillV2.EmbeddedSource.make({
          ...
          skill: SkillV2.Info.make({
            name: "customize-mage",
            description:
              "Use ONLY when the user is editing or creating mage's own configuration: mage.json, mage.jsonc, files under .mage/, or files under ~/.config/mage/. Also use when creating or fixing mage agents, subagents, commands, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring mage itself.",
