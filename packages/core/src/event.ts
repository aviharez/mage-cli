...
import type { Data, Definition, Payload } from "@mybcabisnis/mage-schema/event"
...
import { Durable } from "@mybcabisnis/mage-schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@mybcabisnis/mage-schema/event").ID
export type { Data, Definition, Payload } from "@mybcabisnis/mage-schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@mage/Event") {}
