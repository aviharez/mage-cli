...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@mybcabisnis/mage-llm"
...
export class Service extends Context.Service<Service, Interface>()("@mage/v2/ToolRegistry") {}
