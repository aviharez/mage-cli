import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@mybcabisnis/mage-core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
