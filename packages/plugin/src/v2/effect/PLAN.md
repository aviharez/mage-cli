...
- Effect plugins import `@mage-ai/plugin/v2/effect`, not `@mage-ai/core`.
- Public domain values use generated `@mybcabisnis/mage-sdk` types.
...
- Define `PluginHost` domain capabilities in `@mage-ai/plugin/v2/effect`.
