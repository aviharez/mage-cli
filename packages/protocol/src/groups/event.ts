...
import type { Definition } from "@mybcabisnis/mage-schema/event"
...
export const MageEvent = event.schema
export type MageEvent = typeof MageEvent.Type
export type MageEventEncoded = typeof MageEvent.Encoded
