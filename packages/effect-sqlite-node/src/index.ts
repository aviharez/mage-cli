...
export const TypeId: TypeId = "~@mybcabisnis/mage-effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@mybcabisnis/mage-effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@mybcabisnis/mage-effect-sqlite-node/NodeSqliteClient")
