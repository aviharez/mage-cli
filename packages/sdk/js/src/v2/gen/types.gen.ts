...
/**
 * Server configuration for mage serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: mage.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://mage.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Marketplace configuration for installing skills and MCP servers from a registry
   */
  marketplace?: {
    /**
  ...
  mage?: {
    /**
     * Path or git URL to the team boilerplate
     */
    boilerplate?: string
    /**
     * Active boilerplate profile name
     */
