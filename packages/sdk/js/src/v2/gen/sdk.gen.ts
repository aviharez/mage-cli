...
import type {
  ...
  LspStatusResponses,
  MarketplaceCatalogResponses,
  MarketplaceMcpInstallErrors,
  MarketplaceMcpInstallResponses,
  MarketplaceSkillInstallErrors,
  MarketplaceSkillInstallResponses,
  McpAddErrors,
  McpAddResponses,
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Mage configuration settings and preferences.
   */
   ...
   *
   * Update global Mage configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Mage server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Mage system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Mage instances, releasing all resources.
   */
   ...
   * Upgrade mage
   *
   * Upgrade mage to the specified version or latest if not specified.
   */
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Mage system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Mage system.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Mage state.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Mage.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Mage is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Mage.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Mage configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Mage configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Mage sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Mage session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Mage session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Skill extends HeyApiClient {
   ...
   * Install a skill
   *
   * Download a skill from the marketplace registry into the chosen scope directory.
   */
...
export class Mcp2 extends HeyApiClient {
   ...
   *
   * Add an MCP server from the marketplace to the chosen scope config file and connect it.
   */
  public install<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Marketplace extends HeyApiClient {
   ...
   *
   * Fetch the list of installable skills and MCP servers from the configured registry.
   */
  public catalog<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<MarketplaceCatalogResponses, unknown, ThrowOnError>({
      url: "/marketplace",
      ...options,
      ...params,
    })
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Mage instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Mage system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
