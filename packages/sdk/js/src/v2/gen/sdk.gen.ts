...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new MageClient()" to fix this error.`)
    }
    return instance
  }
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Mage server.
   */
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this Mage process. Idle interruption is a no-op.
   */
...
export class MageClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<MageClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    MageClient.__registry.set(this, args?.key)
  }
