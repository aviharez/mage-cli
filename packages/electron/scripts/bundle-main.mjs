 ...
 * (@mybcabisnis/mage-web-react) and native modules — stays external so it resolves
 ...
 * Leaving @mybcabisnis/mage-web-react external means the conditional
