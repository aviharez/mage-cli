...
import { EventSequenceTable, EventTable } from "@mybcabisnis/mage-core/event/sql"
...
import { WorkspaceEvent } from "@mybcabisnis/mage-schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@mage/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        MAGE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        MAGE_WORKSPACE_ID: config.id,
        MAGE_EXPERIMENTAL_WORKSPACES: "true",
