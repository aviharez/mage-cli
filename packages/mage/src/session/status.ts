...
import { SessionStatusEvent } from "@mybcabisnis/mage-schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@mage/SessionStatus") {}
