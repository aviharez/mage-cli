...
import { Slug } from "@mybcabisnis/mage-core/util/slug"
...
import type { ProviderMetadata, Usage } from "@mybcabisnis/mage-llm"
...
import { locationServiceMapLayer } from "@mybcabisnis/mage-core/location-services"
...
import { PartTable, SessionTable } from "@mybcabisnis/mage-core/session/sql"
...
import { NonNegativeInt, optional } from "@mybcabisnis/mage-core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".mage", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@mage/Session") {}
