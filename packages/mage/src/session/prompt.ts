...
import { MAX_STEPS_PROMPT } from "@mybcabisnis/mage-core/session/runner/max-steps"
...
import { LLMEvent } from "@mybcabisnis/mage-llm"
...
export class Service extends Context.Service<Service, Interface>()("@mage/SessionPrompt") {}
