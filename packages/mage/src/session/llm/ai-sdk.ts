import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@mybcabisnis/mage-llm"
...
// Move this extraction into @mybcabisnis/mage-llm when Copilot is handled by the native runtime.
