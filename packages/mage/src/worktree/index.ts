...
import { path } from "@mybcabisnis/mage-core/effect/app-node-platform"
...
import type { ProjectV2 } from "@mybcabisnis/mage-core/project"
...
import { WorktreeEvent } from "@mybcabisnis/mage-schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@mage/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `mage/${name}`
