...
import { openEditor } from "@mybcabisnis/mage-tui/editor"
import { registerMageKeymap } from "@mybcabisnis/mage-tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerMageKeymap(keymap, renderer, input.tuiConfig)
