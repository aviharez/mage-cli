...
import type { Event, GlobalEvent, MageClient } from "@mybcabisnis/mage-sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@mage/RunStreamTransport") {}
