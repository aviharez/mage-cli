...
import { normalizePromptContent } from "@mybcabisnis/mage-tui/editor"
...
import { MAGE_BASE_MODE, useBindings } from "@mybcabisnis/mage-tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Mage" } satisfies SlashOption,
    ]
