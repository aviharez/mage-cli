 ...
 *   "@mage/ServerAuthConfig",
 *   {
 *     password: Config.string("MAGE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("MAGE_SERVER_USERNAME").pipe(Config.withDefault("mage")),
 *   },
 * ) {}
 *
