...
import { checksum } from "@mybcabisnis/mage-core/util/encode"
...
export function selectWebSearchProvider(sessionID: string, flags = { exa: false, parallel: false }): WebSearchProvider {
  const override = process.env.MAGE_WEBSEARCH_PROVIDER
...
function parallelAuthHeaders() {
  const headers = { "User-Agent": `mage/${InstallationVersion}` }
