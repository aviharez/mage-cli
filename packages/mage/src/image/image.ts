...
export class Service extends Context.Service<Service, Interface>()("@mage/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __MAGE_PHOTON_WASM_PATH?: string }).__MAGE_PHOTON_WASM_PATH =
