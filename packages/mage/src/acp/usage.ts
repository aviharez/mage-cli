...
import type { AssistantMessage as MageAssistantMessage, Message } from "@mybcabisnis/mage-sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@mybcabisnis/mage-core/effect/app-node"
...
export type AssistantTokenCost = Pick<MageAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<MageAssistantMessage, "role"> &
  Partial<Pick<MageAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@mage/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@mage/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@mage/ACPUsage") {}
