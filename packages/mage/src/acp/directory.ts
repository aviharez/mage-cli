...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@mage/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@mage/ACPDirectory") {}
