...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MAGE_CALLER", () => {
    process.env["MAGE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MAGE_CALLER", () => {
    process.env["MAGE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MAGE_CALLER", () => {
    process.env["MAGE_CALLER"] = "unknown"
