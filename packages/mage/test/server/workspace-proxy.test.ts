...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips mage-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-mage-directory"]).toBeUndefined()
      expect(forwarded["x-mage-workspace"]).toBeUndefined()
