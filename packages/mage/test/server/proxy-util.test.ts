...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips mage-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-mage-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-mage-directory")).toBeNull()
      expect(result.get("x-mage-workspace")).toBeNull()
