---
title: ปลั๊กอิน
description: เขียนปลั๊กอินของคุณเองเพื่อขยาย Mage
---

ปลั๊กอินช่วยให้คุณสามารถขยาย Mage ได้โดยเชื่อมโยงกับเหตุการณ์ต่างๆ และปรับแต่งลักษณะการทำงาน คุณสามารถสร้างปลั๊กอินเพื่อเพิ่มคุณสมบัติใหม่ บูรณาการกับบริการภายนอก หรือแก้ไขการทำงานเริ่มต้นของ Mage
...
- `.mage/plugins/` - ​​ปลั๊กอินระดับโครงการ
- `~/.config/mage/plugins/` - ​​ปลั๊กอินทั่วโลก
...
1. การกำหนดค่าส่วนกลาง (`~/.config/mage/mage.json`)
2. การกำหนดค่าโครงการ (`mage.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/mage/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.mage/plugins/`)
...
Mage รัน `bun install` เมื่อเริ่มต้นเพื่อติดตั้งสิ่งเหล่านี้ ปลั๊กอินและเครื่องมือของคุณสามารถนำเข้าได้
...
- `client`: ไคลเอนต์ mage SDK สำหรับการโต้ตอบกับ AI
...
:::note
หากคุณใช้แอปเดสก์ท็อป Mage แอปสามารถส่งการแจ้งเตือนของระบบโดยอัตโนมัติเมื่อมีการตอบกลับพร้อมหรือเมื่อเซสชันเกิดข้อผิดพลาด
:::
...
ป้องกันไม่ให้ mage อ่านไฟล์ `.env`:
...
ตัวช่วย `tool` สร้างเครื่องมือแบบกำหนดเองที่สามารถเรียกใช้ mage ได้ ใช้ฟังก์ชัน Zod schema และส่งกลับคำจำกัดความของเครื่องมือด้วย:
...
เครื่องมือที่คุณกำหนดเองจะพร้อมใช้งานสำหรับ mage ควบคู่ไปกับเครื่องมือในตัว
