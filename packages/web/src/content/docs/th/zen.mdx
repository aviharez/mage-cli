---
title: เซน
description: รายการโมเดลที่คัดสรรโดย Mage
---
...
Mage Zen คือรายการโมเดลที่ผ่านการทดสอบและยืนยันแล้วโดยทีม Mage

Zen ทำงานเหมือน provider อื่น ๆ ใน Mage คุณล็อกอินเข้า Mage Zen แล้วรับ
...
:::tip
เราได้ทดสอบโมเดลและ provider ที่คัดมาแล้วกลุ่มหนึ่งซึ่งทำงานได้ดีกับ Mage
:::
...
Mage Zen คือ AI gateway ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## วิธีการทำงาน

Mage Zen ทำงานเหมือน provider อื่น ๆ ใน Mage

1. คุณลงชื่อเข้าใช้ **<a href={console}>Mage Zen</a>** เพิ่มรายละเอียดการเรียกเก็บเงิน แล้วคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI เลือก Mage Zen แล้ววาง API key ของคุณ
...
[model id](/docs/config/#models) ใน Mage config ของคุณใช้รูปแบบ `opencode/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.5 คุณจะใช้ `opencode/gpt-5.5` ใน config ของคุณ
...
- DeepSeek V4 Flash Free เปิดให้ใช้บน Mage ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- MiMo-V2.5 Free เปิดให้ใช้บน Mage ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Nemotron 3 Super Free เปิดให้ใช้บน Mage ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Big Pickle เป็น stealth model ที่ใช้งานฟรีบน Mage ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
...
4. ทำให้เกิด **no lock-in** โดยให้คุณใช้มันร่วมกับ coding agent อื่น ๆ ได้ และยังเปิดให้คุณใช้ provider อื่น ๆ กับ Mage ได้เสมอ
