...
description: Mage ทำงานร่วมกับเซิร์ฟเวอร์ LSP ของคุณ
---

Mage สามารถทำงานร่วมกับเซิร์ฟเวอร์ Language Server Protocol (LSP) เพื่อใช้ diagnostics เป็น feedback สำหรับ agent

---

## บิวท์อิน

Mage มาพร้อมกับเซิร์ฟเวอร์ LSP ในตัวหลายตัวสำหรับภาษายอดนิยม:
...
:::note
คุณสามารถปิดใช้งานการดาวน์โหลดเซิร์ฟเวอร์ LSP อัตโนมัติได้โดยตั้งค่าตัวแปรสภาพแวดล้อม `MAGE_DISABLE_LSP_DOWNLOAD` เป็น `true`
:::
...
เมื่อเปิดใช้งาน LSP และ mage เปิดไฟล์ มันจะ:
