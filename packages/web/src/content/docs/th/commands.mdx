...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Mage:
...
- ระดับผู้ใช้ (Global): `~/.config/mage/commands/`
- ระดับโปรเจ็กต์: `.mage/commands/`
...
Mage มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
