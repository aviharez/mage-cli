---
title: Zen
description: Liste organisée de modèles fournis par Mage.
---
...
Mage Zen est une liste de modèles testés et vérifiés fournie par l'équipe Mage.

Zen fonctionne comme n'importe quel autre fournisseur dans Mage. Vous vous connectez à Mage Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Mage.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Mage.
:::
...
Mage Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

Mage Zen fonctionne comme n'importe quel autre fournisseur dans Mage.

1. Vous vous connectez à **<a href={console}>Mage Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez Mage Zen et collez votre clé API.
...
Le [model id](/docs/config/#models) dans votre configuration Mage utilise le format `opencode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `opencode/gpt-5.5` dans votre configuration.
...
- DeepSeek V4 Flash Free est disponible sur Mage pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo-V2.5 Free est disponible sur Mage pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur Mage pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur Mage pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec Mage également.
