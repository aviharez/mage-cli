...
Le SDK mage JS/TS fournit un client de type sécurisé pour interagir avec le serveur.
Utilisez-le pour créer des intégrations et contrôler mage par programme.
...
Vous pouvez transmettre un objet de configuration pour personnaliser le comportement. L'instance récupère toujours votre `mage.json`, mais vous pouvez remplacer ou ajouter une configuration en ligne :
