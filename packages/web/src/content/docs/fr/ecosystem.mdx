---
title: Écosystème
description: Projets et intégrations construits avec Mage.
---

Une collection de projets communautaires construits sur Mage.

:::note
Vous souhaitez ajouter votre projet lié à Mage à cette liste ? Soumettez une PR.
:::
...
| Nom                                                                                                | Description                                                                                                                            |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Exécute automatiquement des sessions Mage dans des sandbox Daytona isolées avec synchronisation git et prévisualisations en direct |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Suit l'utilisation d'Mage avec Wakatime                                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifications de bureau et alertes sonores pour les sessions Mage                                                                  |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nommage automatique de session Zellij alimenté par l'IA basé sur le contexte Mage                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permet aux agents Mage le chargement différé de prompts à la demande avec découverte et injection de compétences                   |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Étend mage /commands en un système d'orchestration puissant avec contrôle de flux granulaire                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifications natives de l'OS pour Mage – sachez quand les tâches sont terminées                                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sans friction pour Mage                                                                                              |
...
| Nom                                                                                        | Description                                                                 |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord pour contrôler les sessions Mage, construit sur le SDK      |
...
| [portal](https://github.com/hosenur/portal)                                                | Interface Web mobile-first pour Mage via Tailscale/VPN                  |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Modèle pour créer des plugins Mage                                      |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim pour mage - un agent de codage IA basé sur terminal     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Fournisseur Vercel AI SDK pour utiliser Mage via @mybcabisnis/mage-sdk       |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Application Web / Bureau et extension VS Code pour Mage                 |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian qui intègre Mage dans l'interface d'Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Une alternative open-source à Claude Cowork, propulsée par Mage         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestionnaire d'extensions Mage avec profils portables et isolés.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Application client Bureau, Web, Mobile et Distante pour Mage            |
