---
title: TUI
description: استخدام واجهة المستخدم TUI في Mage.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Mage واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Mage إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Mage في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Mage. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Mage. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `mage.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Mage بعد الضغط على leader key. القيمة الافتراضية `2000`.
