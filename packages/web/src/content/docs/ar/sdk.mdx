...
توفر SDK الخاصة بـ mage لـ JS/TS عميلا آمنا للأنواع للتفاعل مع الخادم.
استخدمها لبناء التكاملات والتحكم في mage برمجيا.
...
يمكنك تمرير كائن إعدادات لتخصيص السلوك. سيستمر المثيل في التقاط `mage.json` لديك، لكن يمكنك تجاوز الإعدادات أو إضافة إعدادات مباشرة:
...
إذا كان لديك مثيل mage يعمل بالفعل، يمكنك إنشاء مثيل عميل للاتصال به:
