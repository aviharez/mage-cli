---
title: Ecosystem
description: Projects and integrations built with Mage.
---

A collection of community projects built on Mage.

:::note
Want to add your Mage related project to this list? Submit a PR.
:::
...
| Name                                                                                               | Description                                                                                        |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run Mage sessions in isolated Daytona sandboxes with git sync and live previews  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Mage usage with Wakatime                                                                 |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Mage sessions                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Mage context                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Mage agents to lazy load prompts on demand with skill discovery and injection            |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend mage /commands into a powerful orchestration system with granular flow control          |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Mage – know when tasks complete                                    |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Mage                                                           |
...
| [opencode-goal-plugin](https://github.com/willytop8/Mage-goal-plugin)                          | Session-scoped `/goal` workflow that keeps objectives in context and auto-continues until complete |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Mage sessions, built on the SDK       |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Mage over Tailscale/VPN              |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Mage plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for mage - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Mage via @mybcabisnis/mage-sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Mage             |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Mage in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Mage |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Mage extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Mage          |
