---
title: Zen
description: Curated list of models provided by Mage.
---
...
Mage Zen is a list of tested and verified models provided by the Mage team.

Zen works like any other provider in Mage. You login to Mage Zen and get
...
:::tip
We tested a select group of models and providers that work well with Mage.
:::
...
Mage Zen is an AI gateway that gives you access to these models.

---

## How it works

Mage Zen works like any other provider in Mage.

1. You sign in to **<a href={console}>Mage Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Mage Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Mage config
...
- DeepSeek V4 Flash Free is available on Mage for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on Mage for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on Mage for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Mage for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Mage as well.
