---
title: Windows (WSL)
description: Uruchamiaj mage na Windows z WSL dla najlepszych efektow.
---

import { Steps } from "@astrojs/starlight/components"

Chociaz mage moze dzialac bezposrednio na Windows, dla najlepszych rezultatow zalecamy [Windows Subsystem for Linux (WSL)](https://learn.microsoft.com/en-us/windows/wsl/install). WSL zapewnia srodowisko Linuksa, ktore bardzo dobrze wspolpracuje z funkcjami opencode.
...
2. **Zainstaluj mage w WSL**

   Po skonfigurowaniu WSL otworz terminal WSL i zainstaluj mage jedna z [metod instalacji](/docs/).

   ```bash
   curl -fsSL https://opencode.ai/install | bash
   ```

3. **Korzystaj z mage przez WSL**
...
:::caution
Przy uzyciu `--hostname 0.0.0.0` ustaw `MAGE_SERVER_PASSWORD`, aby zabezpieczyc serwer.
...
- Uruchamiaj mage w WSL dla projektow zapisanych na dyskach Windows - dostep do plikow jest bezproblemowy
...
- Konfiguracja mage i sesje sa przechowywane w srodowisku WSL pod `~/.local/share/opencode/`
