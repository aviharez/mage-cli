...
Możesz zdefiniować polecenia w `mage.json` lub w plikach w katalogu `commands/`.
...
- Globalnie: `~/.config/mage/commands/`
- Na projekt: `.mage/commands/`
...
mage zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
