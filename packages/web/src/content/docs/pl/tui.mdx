...
mage zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie mage uruchamia TUI dla bieżącego katalogu.
...
Jest to oddzielny plik od `mage.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Mage czeka po naciśnięciu leader key. Domyślnie `2000`.
