...
mage używa `permission`, aby uniknąć, czy dana akcja została wykonana automatycznie, zachowana monit lub została zablokowana.
...
Uprawnienia mage są określane na podstawie nazwy narzędzia i kilku zabezpieczeń:
...
Jeżeli nic nie jest określone, mage zostanie uruchomione od dopuszczalnych rozwiązań diagnostycznych:
...
Gdy mage poprosi o zatwierdzenie, interfejs użytkownika oferujący trzy wyniki:
