---
title: Экосистема
description: Проекты и интеграции, созданные с помощью Mage.
---

Коллекция проектов сообщества, построенных на Mage.

:::note
Хотите добавить свой проект, связанный с Mage, в этот список? Разместите PR.
:::
...
| Имя                                                                                                | Описание                                                                                                                                         |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Автоматически запускайте сеансы Mage в изолированных песочницах Daytona с синхронизацией git и предварительным просмотром в реальном времени |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Отслеживайте использование Mage с помощью Wakatime                                                                                           |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Уведомления на рабочем столе и звуковые оповещения для сеансов Mage                                                                          |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Автоматическое именование сеансов Zellij на основе искусственного интеллекта на основе контекста Mage                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Разрешить агентам Mage отложенную загрузку подсказок по требованию с обнаружением и внедрением навыков                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Встроенные уведомления ОС для Mage – узнайте, когда задачи завершены                                                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Рабочие деревья git с нулевым трением для Mage                                                                                               |
...
| Имя                                                                                        | Описание                                                                                      |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-бот для управления сеансами Mage, созданный на базе SDK                           |
...
| [portal](https://github.com/hosenur/portal)                                                | Мобильный веб-интерфейс для Mage через Tailscale/VPN                                      |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Шаблон для создания плагинов Mage                                                         |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Интерфейс Neovim для Mage - агент кодирования искусственного интеллекта на базе терминала |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Поставщик Vercel AI SDK для использования Mage через @mybcabisnis/mage-sdk                     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Веб-приложение или настольное приложение и расширение VS Code для Mage                    |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Плагин Obsidian, встраивающий Mage в пользовательский интерфейс Obsidian                  |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Альтернатива Claude Cowork с открытым исходным кодом на базе Mage                         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Менеджер расширений Mage с переносимыми изолированными профилями                          |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Настольное, веб-, мобильное и удаленное клиентское приложение для Mage                    |
