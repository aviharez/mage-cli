...
Puoi aggiungere comandi personalizzati tramite la config di Mage o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Mage:
...
- Globale: `~/.config/mage/commands/`
- Per progetto: `.mage/commands/`
...
mage include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
