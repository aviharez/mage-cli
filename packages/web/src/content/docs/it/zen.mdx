---
title: Zen
description: Lista curata di modelli fornita da Mage.
---
...
Mage Zen è un elenco di modelli testati e verificati forniti dal team di Mage.

Zen funziona come qualsiasi altro provider in Mage. Accedi a Mage Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Mage.
:::
...
Mage Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Mage Zen funziona come qualsiasi altro provider in Mage.

1. Accedi a **<a href={console}>Mage Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Mage Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Mage
...
- DeepSeek V4 Flash Free è disponibile su Mage per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Mage per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su Mage per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Mage per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Mage.
