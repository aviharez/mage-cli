---
title: LSP-servere
description: mage integreres med LSP-serverne dine.
---

Mage kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Mage kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `MAGE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og mage åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Mage-konfigurasjonen.
