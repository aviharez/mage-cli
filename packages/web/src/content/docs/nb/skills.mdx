...
Agentferdigheter lar Mage oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går mage opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
mage viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `mage.json`:
