---
title: Zen
description: Utvalgt liste over modeller levert av Mage.
---
...
Mage Zen er en liste over testede og verifiserte modeller levert av Mage-teamet.

Zen fungerer som enhver annen leverandør i Mage. Du logger inn på Mage Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Mage.
:::
...
Mage Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Mage Zen fungerer som enhver annen leverandør i Mage.

1. Du logger inn på **<a href={console}>Mage Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Mage Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Mage-konfigurasjonen din
...
- DeepSeek V4 Flash Free er tilgjengelig på Mage i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Mage i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på Mage i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Mage i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Mage også.
