---
title: Deling
description: Del dine Mage-samtaler.
---

Delingsfunksjonen i Mage lar deg lage offentlige lenker til dine Mage-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Mage støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Mage manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `mage.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av mage i organisasjonen din.
