---
title: Økosystem
description: Prosjekter og integrasjoner bygget med Mage.
---

En samling fellesskapsprosjekter bygget på Mage.

:::note
Vil du legge til ditt Mage-relaterte prosjekt til denne listen? Send inn en PR.
:::
...
| Navn                                                                                               | Beskrivelse                                                                                                   |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kjør Mage-økter automatisk i isolerte Daytona-sandkasser med git-synkronisering og live-forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor Mage-bruk med Wakatime                                                                               |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsvarsler og lydvarsler for Mage-økter                                                           |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sesjonsnavn basert på Mage-kontekst                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillat Mage-agenter å lazy-loade meldinger på forespørsel med ferdighetsoppdagelse og injeksjon           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Utvid Mage /kommandoer til et kraftig orkestreringssystem med granulær flytkontroll                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Innfødte OS-varsler for Mage – vet når oppgaver fullføres                                                 |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nullfriksjon git-arbeidstre for Mage                                                                      |
...
| Navn                                                                                       | Beskrivelse                                                         |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot for å kontrollere Mage-økter, bygget på SDK         |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge Mage-plugins                                    |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-grensesnitt for Mage - en terminalbasert AI-kodingsagent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av Mage via @mybcabisnis/mage-sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/skrivebordsapp og VS Code-utvidelse for Mage               |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-plugin som bygger inn Mage i Obsidians UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av Mage  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Mage utvidelsesbehandler med bærbare, isolerte profiler.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile og Remote Client App for Mage              |
