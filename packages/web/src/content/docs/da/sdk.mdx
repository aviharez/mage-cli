...
Brug den til at bygge integrasjoner og kontrollere mage programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `mage.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
