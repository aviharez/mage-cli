---
title: Økosystem
description: Projekter og integrationer bygget med Mage.
---

En samling af samfundsprojekter bygget på Mage.

:::note
Vil du tilføje dit Mage-relaterede projekt til denne liste? Send en PR.
:::
...
| Navn                                                                                               | Beskrivelse                                                                                                       |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kør automatisk Mage-sessioner i isolerede Daytona-sandkasser med git-synkronisering og live forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor Mage brug med Wakatime                                                                                   |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsmeddelelser og lydadvarsler for Mage-sessioner                                                     |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sessionsnavngivning baseret på Mage-kontekst                                      |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillad Mage-agenter til dovne load-prompter på efterspørgsel med færdighedsopdagelse og -injektion            |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Udvid mage /commands til et kraftfuldt orkestreringssystem med granulær flowkontrol                           |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS-meddelelser for Mage – ved, hvornår opgaver er fuldført                                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nulfriktions git-arbejdstræer for Mage                                                                        |
...
| Navn                                                                                       | Beskrivelse                                                            |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot til at styre Mage-sessioner, bygget på SDK             |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim-plugin til redaktør-bevidste prompter, bygget på API            |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI til Mage over Tailscale/VPN                    |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Skabelon til at bygge Mage plugins                                 |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-frontend til mage - en terminalbaseret AI-kodningsagent     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK udbyder til brug af Mage via @mybcabisnis/mage-sdk        |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App og VS Code udvidelse til Mage                    |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin, der integrerer Mage i Obsidians brugergrænseflade |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et open source-alternativ til Claude Cowork, drevet af Mage        |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Mage udvidelsesmanager med bærbare, isolerede profiler.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, web-, mobil- og fjernklientapp til Mage                  |
