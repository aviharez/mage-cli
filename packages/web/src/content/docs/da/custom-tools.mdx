...
description: Opret værktøjer, som LLM kan kalde mage ind.
---
...
- Lokalt ved at placere dem i biblioteket `.mage/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/mage/tools/`.
