---
title: Zen
description: Udvalgt liste over modeller leveret af Mage.
---
...
Mage Zen er en liste over testede og verificerede modeller leveret af Mage-teamet.

Zen fungerer som enhver anden udbyder i Mage. Du logger ind på Mage Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Mage.
:::
...
Mage Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Mage Zen fungerer som enhver anden udbyder i Mage.

1. Du logger ind på **<a href={console}>Mage Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Mage Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Mage-konfiguration
...
- DeepSeek V4 Flash Free er tilgængelig på Mage i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på Mage i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på Mage i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Mage i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Mage også.
