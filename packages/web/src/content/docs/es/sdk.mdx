...
El SDK mage JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar mage mediante programación.
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `mage.json`, pero puede anular o agregar configuración en línea:
