...
Puede agregar comandos personalizados a través de la configuración Mage o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Mage [config](/docs/config):
...
mage incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
