---
title: Zen
description: Lista seleccionada de modelos proporcionada por Mage.
---
...
Mage Zen es una lista de modelos probados y verificados proporcionada por el equipo de Mage.

Zen funciona como cualquier otro proveedor en Mage. Inicias sesión en Mage Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Mage.
:::
...
Mage Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Mage Zen funciona como cualquier otro proveedor en Mage.

1. Inicias sesión en **<a href={console}>Mage Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Mage Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Mage
...
- DeepSeek V4 Flash Free está disponible en Mage por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en Mage por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en Mage por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Mage por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Mage.
