...
description: Mage se integra con sus servidores LSP.
---

Mage puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

Mage viene con varios servidores LSP integrados para idiomas populares:
...
:::note
Puede deshabilitar las descargas automáticas del servidor LSP configurando la variable de entorno `MAGE_DISABLE_LSP_DOWNLOAD` en `true`.
:::
...
Cuando LSP está habilitado y mage abre un archivo:
