---
title: TUI
description: Usando la interfaz de usuario del terminal Mage.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Mage proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Mage se inicia TUI para el directorio actual.
...
Cuando utilice Mage TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Mage. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `mage.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera Mage después de la leader key. El valor predeterminado es `2000`.
