---
title: エコシステム
description: Mage で構築されたプロジェクトと統合。
---

Mage に基づいて構築されたコミュニティプロジェクトのコレクション。

:::note
Mage 関連プロジェクトをこのリストに追加したいですか? PR を送信してください。
:::
...
| 名前                                                                                               | 説明                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync とライブプレビューを使用して、隔離された Daytona サンドボックスで Mage セッションを自動的に実行します。 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | wakatime で Mage の使用状況を追跡する                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Mage セッションのデスクトップ通知とサウンドアラート                                                              |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 許可、完了、エラーイベントのデスクトップ通知とサウンドアラート                                                       |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Mage コンテキストに基づいた AI による自動 Zellij セッション命名                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Mage エージェントがスキルの検出と挿入を使用してオンデマンドでプロンプトを遅延ロードできるようにする              |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Mage/コマンドをきめ細かいフロー制御を備えた強力なオーケストレーションシステムに拡張                              |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Mage のネイティブ OS 通知 – タスクがいつ完了したかを知る                                                         |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | バンドルされたマルチエージェントオーケストレーションハーネス – 16 コンポーネント、1 回のインストール                 |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Mage 用のゼロフリクション Git ワークツリー                                                                       |
...
| 名前                                                                                       | 説明                                                                             |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK 上に構築された Mage セッションを制御する Discord ボット                  |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API に基づいて構築された、エディター対応プロンプト用の Neovim プラグイン         |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN 上の Mage 向けモバイルファースト Web UI                        |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mage プラグインを構築するためのテンプレート                                  |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim Mage用フロントエンド - ターミナルベースの AI コーディングエージェント |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @mybcabisnis/mage-sdk 経由で Mage を使用するための Vercel AI SDK プロバイダー     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Mage 用の Web/デスクトップアプリと VS Code 拡張機能                          |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian の UI に Mage を埋め込む Obsidian プラグイン                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Mage を利用した、Claude Cowork に代わるオープンソース                        |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | 移植可能な独立したプロファイルを備えた Mage 拡張機能マネージャー。           |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Mage 用のデスクトップ、Web、モバイル、およびリモートクライアントアプリ       |
