---
title: LSP serveri
description: Mage se integriše sa vašim LSP serverima.
---

Mage se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Mage dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `MAGE_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i mage otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj mage konfiguraciji.
