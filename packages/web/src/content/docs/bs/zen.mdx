---
title: Zen
description: Kurirana lista modela koje nudi Mage.
---
...
Mage Zen je lista testiranih i provjerenih modela koje pruža Mage tim.

Zen radi kao i svaki drugi provajder u Mage. Prijavite se na Mage Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili Mage.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Mage.
:::
...
Mage Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

Mage Zen radi kao i svaki drugi provajder u Mage.

1. Prijavite se na **<a href={console}>Mage Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite Mage Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj Mage konfiguraciji koristi format
...
- DeepSeek V4 Flash Free je dostupan na Mage ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na Mage ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Super Free je dostupan na Mage ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na Mage ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u Mage.
