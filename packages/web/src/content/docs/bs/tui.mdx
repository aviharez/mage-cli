---
title: TUI
description: Korištenje korisničkog interfejsa Mage terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Mage pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Mage pokreće TUI za trenutni direktorij.
...
Kada koristite Mage TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Mage. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Mage. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `mage.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Mage čeka nakon leader key. Podrazumijevano je `2000`.
