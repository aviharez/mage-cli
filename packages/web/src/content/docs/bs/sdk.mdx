---
title: SDK
description: Type-safe JS klijent za mage server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

mage JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `mage.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu mage instancu, mozete napraviti klijentsku instancu i povezati se na nju:
