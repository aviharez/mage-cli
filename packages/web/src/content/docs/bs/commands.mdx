...
Možete dodati prilagođene komande kroz Mage konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Mage [config](/docs/config):
...
- Globalno: `~/.config/mage/commands/`
- Po projektu: `.mage/commands/`
...
Mage uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
