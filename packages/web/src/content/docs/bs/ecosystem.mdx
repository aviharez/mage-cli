---
title: Ekosistem
description: Projekti i integracije izgrađeni uz Mage.
---

Kolekcija projekata zajednice izgrađenih na Mage.

:::note
Želite li na ovu listu dodati svoj Mage projekat? Pošaljite PR.
:::
...
| Ime                                                                                                | Opis                                                                                                          |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatski pokrenite Mage sesije u izoliranim Daytona sandboxovima uz git sinhronizaciju i preglede uživo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Pratite upotrebu Mage sa Wakatime                                                                         |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Obavještenja na radnoj površini i zvučna upozorenja za Mage sesije                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatsko imenovanje Zellij sesije na bazi Mage konteksta                                                |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Dozvolite Mage agentima da lijeno učitavaju upite na zahtjev uz otkrivanje vještina i ubrizgavanje        |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Proširite mage /komande u moćan sistem orkestracije sa granularnom kontrolom toka                         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifikacije izvornog OS-a za Mage – znajte kada se zadaci dovrše                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git radna stabla bez trenja za Mage                                                                       |
...
| Ime                                                                                        | Opis                                                                  |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot za kontrolu Mage sesija, izgrađen na SDK              |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim dodatak za upite svjestan uređivača, izgrađen na API           |
| [portal](https://github.com/hosenur/portal)                                                | Mobilni korisnički interfejs za Mage preko Tailscale/VPN          |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Predložak za izgradnju Mage dodataka                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend za mage - terminal baziran AI agent za kodiranje  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK dobavljač za korištenje Mage putem @mybcabisnis/mage-sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App i VS Code Extension za Mage                     |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian dodatak koji ugrađuje Mage u Obsidian-ov UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa otvorenog koda Claudeu Coworku, pokretana pomoću Mage |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Mage menadžer ekstenzija sa prenosivim, izolovanim profilima.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile i Remote Client aplikacija za Mage           |
