...
Você pode adicionar comandos personalizados através da configuração do mage ou criando arquivos markdown no diretório `commands/`.
...
mage inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
