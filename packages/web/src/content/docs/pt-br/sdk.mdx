...
O SDK JS/TS do mage fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o mage programaticamente.
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `mage.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do mage em execução, pode criar uma instância de cliente para se conectar a ela:
