---
title: Ecossistema
description: Projetos e integrações construídos com o Mage.
---

Uma coleção de projetos da comunidade construídos sobre o Mage.

:::note
Quer adicionar seu projeto relacionado ao Mage a esta lista? Envie um PR.
:::
...
| Nome                                                                                               | Descrição                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Execute automaticamente sessões do Mage em sandboxes isoladas do Daytona com sincronização git e pré-visualizações ao vivo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Acompanhe o uso do Mage com Wakatime                                                                                       |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificações de desktop e alertas sonoros para sessões do Mage                                                             |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomeação automática de sessões Zellij com suporte de IA com base no contexto do Mage                                       |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permite que agentes do Mage carreguem prompts sob demanda com descoberta e injeção de habilidades                          |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estenda mage /commands em um poderoso sistema de orquestração com controle de fluxo granular                               |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificações nativas do OS para Mage – saiba quando as tarefas são concluídas                                              |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sem atrito para Mage                                                                                         |
...
| Nome                                                                                       | Descrição                                                                       |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot do Discord para controlar sessões do Mage, construído sobre o SDK       |
...
| [portal](https://github.com/hosenur/portal)                                                | UI web mobile-first para Mage sobre Tailscale/VPN                           |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template para construir plugins do Mage                                     |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim para Mage - um agente de codificação IA baseado em terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provedor Vercel AI SDK para usar Mage via @mybcabisnis/mage-sdk                  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicativo Web / Desktop e Extensão do VS Code para Mage                    |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian que incorpora Mage na UI do Obsidian                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Uma alternativa de código aberto ao Claude Cowork, alimentada pelo Mage     |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gerenciador de extensões Mage com perfis portáteis e isolados.              |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicativo Desktop, Web, Mobile e Cliente Remoto para Mage                  |
