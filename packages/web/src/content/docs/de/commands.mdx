...
Erstellen Sie `.mage/commands/test.md`:

```md title=".mage/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Mage-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Mage [config](/docs/config):

```json title="mage.jsonc" {4-12}
{
...
- Global: `~/.config/mage/commands/`
- Pro Projekt: `.mage/commands/`

```markdown title="~/.config/mage/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".mage/commands/component.md"
---
...
```md title=".mage/commands/create-file.md"
---
...
```md title=".mage/commands/analyze-coverage.md"
---
...
```md title=".mage/commands/review-changes.md"
---
...
```md title=".mage/commands/review-component.md"
---
...
Mage enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
