...
Das mage JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und mage programmatisch steuern.
...
`mage.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn mage bereits laeuft, kannst du nur einen Client erstellen und verbinden:
