---
title: Teilen
description: Teile Mage-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Mage-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Mage Folgendes:
...
Mage hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Mage den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`mage.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du mage in deiner Organisation einsetzt.
