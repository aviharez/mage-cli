---
title: SDK
description: mage sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

mage JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `mage.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir mage örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
