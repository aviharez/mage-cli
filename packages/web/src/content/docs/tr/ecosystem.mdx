---
title: Ekosistem
description: Mage ile geliştirilen projeler ve entegrasyonlar.
---

Mage üzerine inşa edilmiş topluluk projeleri koleksiyonu.

:::note
Mage ile ilgili projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::
...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Mage oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile Mage kullanımını takip edin                                                                                  |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Mage oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Mage bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Mage aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | mage /commands komutlarını, ayrıntılı akış kontrolü ile güçlü bir orkestrasyon sistemine genişletin                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Mage için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Mage için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, Mage oturumlarını kontrol eden Discord botu       |
...
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden Mage için mobil öncelikli web arayüzü               |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mage eklentileri oluşturmak için şablon                                     |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | mage için Neovim ön yüzü - terminal tabanlı bir yapay zeka kodlama aracısı  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @mybcabisnis/mage-sdk aracılığıyla Mage kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Mage için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [Mage-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Mage'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Mage tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip Mage eklenti yöneticisi                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Mage için Masaüstü, Web, Mobil ve Uzak İstemci Uygulaması                   |
