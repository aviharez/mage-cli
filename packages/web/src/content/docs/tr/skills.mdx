...
mage su konumlari tarar:

- Proje konfigurasyonu: `.mage/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/mage/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.mage/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/mage/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.mage/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`mage.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`mage.json` icinde):
