---
title: Zen
description: mage tarafından sağlanan seçilmiş modeller listesi.
---
...
Mage Zen, Mage ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Mage'daki diğer sağlayıcılar gibi çalışır. Mage Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Mage kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Mage ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Mage Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Mage Zen, Mage'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Mage Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Mage Zen'i seçin ve API anahtarınızı yapıştırın.
...
Mage yapılandırmanızdaki [model id](/docs/config/#models) `opencode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `opencode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Mage'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Mage'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için Mage'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Mage'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Mage Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Mage ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
