...
description: mage dile özgü biçimlendiriciler kullanır.
---
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, mage bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

mage bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri mage yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
