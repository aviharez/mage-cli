---
title: Paylasim
description: mage konusmalarini genel baglantilarla paylasin.
---
...
Varsayilan olarak mage manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `mage.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda mage kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
