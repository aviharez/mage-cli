import { AppIcon } from "@mybcabisnis/mage-ui/app-icon"
...
import { Keybind } from "@mybcabisnis/mage-ui/keybind"
import { Spinner } from "@mybcabisnis/mage-ui/spinner"
import { showToast } from "@mybcabisnis/mage-ui/toast"
import { Tooltip, TooltipKeybind } from "@mybcabisnis/mage-ui/tooltip"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_MAGE_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("mage-titlebar-center"))
    setRightMount(document.getElementById("mage-titlebar-right"))
  })
