import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@mybcabisnis/mage-sdk/v2/client"
...
import { List, type ListRef } from "@mybcabisnis/mage-ui/list"
  ...
  return (
    ...
    >
      <div class="flex flex-col gap-6 px-2.5 pb-3">
        ...
        <Show when={provider()?.source === "config"}>
          <div class="px-2.5 pb-10 flex flex-col gap-4">
            <div class="flex items-center gap-x-2 text-14-regular text-text-base">
              ...
              <span>{provider().name} is configured and ready to use.</span>
            </div>
