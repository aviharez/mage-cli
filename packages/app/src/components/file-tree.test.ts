...
beforeAll(async () => {
  ...
  mock.module("@mybcabisnis/mage-ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@mybcabisnis/mage-ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@mybcabisnis/mage-ui/icon", () => ({ Icon: () => null }))
  mock.module("@mybcabisnis/mage-ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
