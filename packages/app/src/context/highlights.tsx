...
// Changelog is disabled — the upstream opencode.ai domain may be unreachable in corporate networks.
// Set VITE_CHANGELOG_URL in packages/app/.env.local to re-enable with an internal mirror.
const CHANGELOG_URL = import.meta.env.VITE_CHANGELOG_URL ?? ""
