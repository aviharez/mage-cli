export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Mage",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Mage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Mage.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Mage.",
  ...
  "dialog.plugins.empty": "Plugins configured in mage.json",
  ...
  "dialog.server.description": "Switch which Mage server this app connects to.",
  ...
  "toast.update.description": "A new version of Mage ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to SQI RnD MBB",
  ...
  "error.chain.checkConfig": "Check your config (mage.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Mage does not support MCP authentication yet.',
  ...
  "dialog.boilerplate.empty": "No active boilerplate",
  ...
  "sidebar.gettingStarted.line1": "Mage includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Mage server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Mage",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Mage looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Mage follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Mage is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Mage launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Mage.",
