...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "MAGE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/mage/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/mage (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/mage/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/mage/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const MAGE_DB|MAGE_DB|MAGE_DEV|Global\\.Path\\.data|data =" in packages/mage/src (115 matches)',
  },
] as const
