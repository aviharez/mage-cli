...
const extractSessionStatusUpdate = (payload) => {
  ...
  // Canonical Mage schema uses properties.status.type. Keep legacy info.type fallback for compatibility.
...
export const createSessionRuntime = ({ writeSseEvent, getNotificationClients, broadcastEvent }) => {
  ...
  const processMageSsePayload = (payload) => {
