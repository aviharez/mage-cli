...
## Purpose
This module contains tunnel provider orchestration for Mage, including provider registry/service wiring, managed remote token config lifecycle, and tunnel HTTP route registration.
