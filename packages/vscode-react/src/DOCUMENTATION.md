...
- `bridge-config-runtime.ts`
  ...
  - Includes Mage resolution diagnostics parity handler used by shared UI (`/api/config/mage-resolution`).

- `bridge-settings-runtime.ts`
  - Settings read/write and Mage skills discovery via API for bridge consumers.
