...
const main = Effect.gen(function* () {
  ...
  const onboardingTestRoot = ((): string | undefined => {
    ...
    const root = join(tmpdir(), `mage-onboarding-${randomUUID()}`)
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "Mage Dev")
  ...
  app.setAsDefaultProtocolClient("mage")
  registerRendererProtocol()
  setDockIcon()
  setupAutoUpdater()
  ...
  const needsMigration = ((): boolean => {
    ...
    return !existsSync(join(base, "mage", "mage.db"))
  })()
