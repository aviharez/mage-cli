...
import "./styles.css"
import { useTheme } from "@mybcabisnis/mage-ui/theme"
    ...
    integrations: (integrations) => {
      return integrations.filter(
        (i) =>
          i.name !== "Breadcrumbs" &&
          !(
            import.meta.env.MAGE_CHANNEL === "prod" &&
...
const deepLinkEvent = "mage:deep-link"
...
render(() => {
  ...
  const loadLocale = async () => {
    const current = await platform.storage?.("mage.global.dat").getItem("language")
