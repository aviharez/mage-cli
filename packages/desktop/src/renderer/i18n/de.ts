export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Mage",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Mage wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
