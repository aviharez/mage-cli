...
import { IconMage } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "mage/session/message-v2"
import type { Message } from "mage/session/message"
import type { Session } from "mage/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.mage_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.mage_name}>
                    <IconMage width={16} height={16} />
                  </div>
